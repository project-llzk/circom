...
// CHECK-NEXT:        %[[VAL_4:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_0 : !array.type<1 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_0 : !array.type<1 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_0 : !array.type<1 x !felt.type<"bn128">>
