...
// CHECK-NEXT:      %[[V_4:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[V_E1:[0-9a-zA-Z_\.]+]] = %[[V_E0]], %[[V_R1:[0-9a-zA-Z_\.]+]] = %[[V_R0]]) : (i1, !felt.type<"bn128">) -> (i1, !felt.type<"bn128">) {
...
// CHECK-NEXT:        scf.condition(%[[V_10]]) %[[V_E1]], %[[V_R1]] : i1, !felt.type<"bn128">
// CHECK-NEXT:      } do {
// CHECK-NEXT:      ^bb0(%[[V_E2:[0-9a-zA-Z_\.]+]]: i1, %[[V_R2:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
// CHECK-NEXT:        %[[V_E3:[0-9a-zA-Z_\.]+]] = arith.constant true
// CHECK-NEXT:        scf.yield %[[V_E3]], %[[V_0]] : i1, !felt.type<"bn128">
// CHECK-NEXT:      }
// CHECK-NEXT:      %[[V_12:[0-9a-zA-Z_\.]+]] = scf.if %[[V_4]]#0 -> (!felt.type<"bn128">) {
// CHECK-NEXT:        scf.yield %[[V_4]]#1 : !felt.type<"bn128">
// CHECK-NEXT:      } else {
// CHECK-NEXT:        %[[V_13:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:        %[[V_14:[0-9a-zA-Z_\.]+]] = felt.neg %[[V_13]] : !felt.type<"bn128">
// CHECK-NEXT:        scf.yield %[[V_14]] : !felt.type<"bn128">
// CHECK-NEXT:      }
// CHECK-NEXT:      function.return %[[V_12]] : !felt.type<"bn128">
// CHECK-NEXT:    }
...
// CHECK-NEXT:        function.def @compute(%[[VAL_17:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">) -> !struct.type<@EarlyReturn::@EarlyReturn<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = struct.new : <@EarlyReturn::@EarlyReturn<[]>>
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = function.call @earlyReturnFn(%[[VAL_17]]) : (!felt.type<"bn128">) -> !felt.type<"bn128">
