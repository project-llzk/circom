...
// CHECK-NEXT:      function.def @compute(%[[VAL_13:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@EarlyReturn<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:        struct.writem %[[VAL_14]][@outp] = %[[VAL_15]] : <@EarlyReturn<[]>>, !felt.type
...
// CHECK-DAG:         %[[VAL_19:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_16]][@outp] : <@EarlyReturn<[]>>, !felt.type
