...
// CHECK-NEXT:      poly.param @T_return : !poly.tvar<@T_return>
// CHECK-NEXT:      function.def @short_div(%[[VAL_6:[0-9a-zA-Z_\.]+]]: !poly.tvar<@T_arg0> {function.arg_name = "k"}) -> !poly.tvar<@T_return> attributes {function.allow_non_native_field_ops} {
...
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_6]] : (!poly.tvar<@T_arg0>) -> !felt.type<"bn128">
...
// CHECK-NEXT:        }
// CHECK-NEXT:        %[[VAL_14:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_10]] : (!felt.type<"bn128">) -> !poly.tvar<@T_return>
