...
// CHECK-NEXT:          %[[VAL_1:[0-9a-zA-Z_\.]+]] = array.new  : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>
...
// CHECK-NEXT:          %[[VAL_9:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_6]] : (!pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[0]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
// CHECK-NEXT:          array.write %[[VAL_1]]{{\[}}%[[VAL_8]]] = %[[VAL_9]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_1]]{{\[}}%[[VAL_17]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_22:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_18]][@count] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, index
// CHECK-NEXT:          %[[VAL_23:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_22]], %[[VAL_23]] : index
// CHECK-NEXT:          pod.write %[[VAL_18]][@count] = %[[VAL_24]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, index
...
// CHECK-NEXT:            %[[VAL_27:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_18]][@params] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, !pod.type<[@A: !felt.type<"bn128">]>
...
// CHECK-NEXT:            %[[VAL_31:[0-9a-zA-Z_\.]+]] = function.call @GetWeight::@GetWeight::@compute(%[[VAL_28]]) {(%[[VAL_30]])} : (!felt.type<"bn128">) -> !struct.type<@GetWeight::@GetWeight<[#map]>>
// CHECK-NEXT:            pod.write %[[VAL_18]][@comp] = %[[VAL_31]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, !struct.type<@GetWeight::@GetWeight<[#map]>>
// CHECK-NEXT:            %[[VAL_32:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:            %[[VAL_33:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_32]] : !felt.type<"bn128">
// CHECK-NEXT:            array.write %[[VAL_1]]{{\[}}%[[VAL_33]]] = %[[VAL_18]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
// CHECK-NEXT:          }
...
// CHECK-NEXT:          %[[VAL_40:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_37]] : (!pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[1]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
// CHECK-NEXT:          array.write %[[VAL_1]]{{\[}}%[[VAL_39]]] = %[[VAL_40]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_49:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_1]]{{\[}}%[[VAL_48]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_53:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_49]][@count] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, index
// CHECK-NEXT:          %[[VAL_54:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_55:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_53]], %[[VAL_54]] : index
// CHECK-NEXT:          pod.write %[[VAL_49]][@count] = %[[VAL_55]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, index
...
// CHECK-NEXT:            %[[VAL_58:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_49]][@params] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, !pod.type<[@A: !felt.type<"bn128">]>
...
// CHECK-NEXT:            %[[VAL_62:[0-9a-zA-Z_\.]+]] = function.call @GetWeight::@GetWeight::@compute(%[[VAL_59]]) {(%[[VAL_61]])} : (!felt.type<"bn128">) -> !struct.type<@GetWeight::@GetWeight<[#map]>>
// CHECK-NEXT:            pod.write %[[VAL_49]][@comp] = %[[VAL_62]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, !struct.type<@GetWeight::@GetWeight<[#map]>>
// CHECK-NEXT:            %[[VAL_63:[0-9a-zA-Z_\.]+]] = felt.const  1 : <"bn128">
// CHECK-NEXT:            %[[VAL_64:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_63]] : !felt.type<"bn128">
// CHECK-NEXT:            array.write %[[VAL_1]]{{\[}}%[[VAL_64]]] = %[[VAL_49]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
// CHECK-NEXT:          }
...
// CHECK-NEXT:          %[[VAL_65:[0-9a-zA-Z_\.]+]] = array.new  : <2 x !struct.type<@GetWeight::@GetWeight<[#map]>>>
...
// CHECK-NEXT:            %[[VAL_70:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_1]]{{\[}}%[[VAL_69]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>
// CHECK-NEXT:            %[[VAL_71:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_70]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map]>>, @params: !pod.type<[@A: !felt.type<"bn128">]>]>, !struct.type<@GetWeight::@GetWeight<[#map]>>
// CHECK-NEXT:            array.write %[[VAL_65]]{{\[}}%[[VAL_69]]] = %[[VAL_71]] : <2 x !struct.type<@GetWeight::@GetWeight<[#map]>>>, !struct.type<@GetWeight::@GetWeight<[#map]>>
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@getWeights] = %[[VAL_65]] : <@ComputeValue::@ComputeValue<[]>>, !array.type<2 x !struct.type<@GetWeight::@GetWeight<[#map]>>>
...
// CHECK-NEXT:          %[[VAL_73:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_72]][@getWeights] : <@ComputeValue::@ComputeValue<[]>>, !array.type<2 x !struct.type<@GetWeight::@GetWeight<[#map]>>>
...
// CHECK-NEXT:            %[[VAL_85:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_73]]{{\[}}%[[VAL_84]]] : <2 x !struct.type<@GetWeight::@GetWeight<[#map]>>>, !struct.type<@GetWeight::@GetWeight<[#map]>>
...
// CHECK-NEXT:            function.call @GetWeight::@GetWeight::@constrain(%[[VAL_85]], %[[VAL_87]]) : (!struct.type<@GetWeight::@GetWeight<[#map]>>, !felt.type<"bn128">) -> ()
// CHECK-NEXT:          }
...
// CHECK-NEXT:        function.def @compute(%[[VAL_88:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128"> {function.arg_name = "inp"}) -> !struct.type<@GetWeight::@GetWeight<[@A]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_91:[0-9a-zA-Z_\.]+]]: !struct.type<@GetWeight::@GetWeight<[@A]>>, %[[VAL_92:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128"> {function.arg_name = "inp"}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
