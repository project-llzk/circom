...
// CHECK-NEXT:          %[[VAL_48:[0-9a-zA-Z_\.]+]] = array.new  : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>
...
// CHECK-NEXT:            %[[VAL_65:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_61]] : (!pod.type<[@count: index, @comp: !struct.type<@A::@A<[@n]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
// CHECK-NEXT:            array.write %[[VAL_48]]{{\[}}%[[VAL_63]], %[[VAL_64]]] = %[[VAL_65]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_69:[0-9a-zA-Z_\.]+]]:3 = scf.while (%[[VAL_70:[0-9a-zA-Z_\.]+]] = %[[VAL_49]], %[[VAL_71:[0-9a-zA-Z_\.]+]] = %[[VAL_68]], %[[VAL_72:[0-9a-zA-Z_\.]+]] = %[[VAL_53]]) : (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">) -> (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">) {
// CHECK-NEXT:            %[[VAL_73:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_71]], %[[VAL_45]]) : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:            scf.condition(%[[VAL_73]]) %[[VAL_70]], %[[VAL_71]], %[[VAL_72]] : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_74:[0-9a-zA-Z_\.]+]]: !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, %[[VAL_75:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">, %[[VAL_76:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
// CHECK-NEXT:            %[[VAL_77:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:            %[[VAL_78:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_79:[0-9a-zA-Z_\.]+]] = %[[VAL_74]], %[[VAL_80:[0-9a-zA-Z_\.]+]] = %[[VAL_77]]) : (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">) -> (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">) {
// CHECK-NEXT:              %[[VAL_81:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_80]], %[[VAL_41]]) : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:              scf.condition(%[[VAL_81]]) %[[VAL_79]], %[[VAL_80]] : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">
// CHECK-NEXT:            } do {
// CHECK-NEXT:            ^bb0(%[[VAL_82:[0-9a-zA-Z_\.]+]]: !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, %[[VAL_83:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
...
// CHECK-NEXT:              %[[VAL_90:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_82]]{{\[}}%[[VAL_88]], %[[VAL_89]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              %[[VAL_91:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_90]][@a] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
// CHECK-NEXT:              %[[VAL_92:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_75]] : !felt.type<"bn128">
// CHECK-NEXT:              array.write %[[VAL_91]]{{\[}}%[[VAL_92]]] = %[[VAL_86]] : <#map x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:              %[[VAL_96:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_82]]{{\[}}%[[VAL_94]], %[[VAL_95]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              pod.write %[[VAL_96]][@a] = %[[VAL_91]] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
...
// CHECK-NEXT:              array.write %[[VAL_82]]{{\[}}%[[VAL_98]], %[[VAL_99]]] = %[[VAL_96]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
...
// CHECK-NEXT:              %[[VAL_103:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_48]]{{\[}}%[[VAL_101]], %[[VAL_102]]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:              %[[VAL_107:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_82]]{{\[}}%[[VAL_105]], %[[VAL_106]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              %[[VAL_108:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_103]][@count] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, index
// CHECK-NEXT:              %[[VAL_109:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:              %[[VAL_110:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_108]], %[[VAL_109]] : index
// CHECK-NEXT:              pod.write %[[VAL_103]][@count] = %[[VAL_110]] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, index
...
// CHECK-NEXT:                %[[VAL_113:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_103]][@params] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, !pod.type<[@n: !felt.type<"bn128">]>
// CHECK-NEXT:                %[[VAL_114:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_107]][@a] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
...
// CHECK-NEXT:                %[[VAL_117:[0-9a-zA-Z_\.]+]] = function.call @A::@A::@compute(%[[VAL_114]]) {(%[[VAL_116]])} : (!array.type<#map x !felt.type<"bn128">>) -> !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:                pod.write %[[VAL_103]][@comp] = %[[VAL_117]] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map]>>
...
// CHECK-NEXT:                array.write %[[VAL_48]]{{\[}}%[[VAL_119]], %[[VAL_120]]] = %[[VAL_103]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
// CHECK-NEXT:              }
...
// CHECK-NEXT:              scf.yield %[[VAL_82]], %[[VAL_122]] : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">
// CHECK-NEXT:            }
...
// CHECK-NEXT:            scf.yield %[[VAL_78]]#0, %[[VAL_124]], %[[VAL_78]]#1 : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:          }
...
// CHECK-NEXT:            %[[VAL_138:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_134]] : (!pod.type<[@count: index, @comp: !struct.type<@A::@A<[@m]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
// CHECK-NEXT:            array.write %[[VAL_48]]{{\[}}%[[VAL_136]], %[[VAL_137]]] = %[[VAL_138]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_142:[0-9a-zA-Z_\.]+]]:3 = scf.while (%[[VAL_143:[0-9a-zA-Z_\.]+]] = %[[VAL_69]]#0, %[[VAL_144:[0-9a-zA-Z_\.]+]] = %[[VAL_141]], %[[VAL_145:[0-9a-zA-Z_\.]+]] = %[[VAL_126]]) : (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">) -> (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">) {
// CHECK-NEXT:            %[[VAL_146:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_144]], %[[VAL_43]]) : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:            scf.condition(%[[VAL_146]]) %[[VAL_143]], %[[VAL_144]], %[[VAL_145]] : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_147:[0-9a-zA-Z_\.]+]]: !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, %[[VAL_148:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">, %[[VAL_149:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
// CHECK-NEXT:            %[[VAL_150:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:            %[[VAL_151:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_152:[0-9a-zA-Z_\.]+]] = %[[VAL_147]], %[[VAL_153:[0-9a-zA-Z_\.]+]] = %[[VAL_150]]) : (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">) -> (!array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">) {
// CHECK-NEXT:              %[[VAL_154:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_153]], %[[VAL_41]]) : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:              scf.condition(%[[VAL_154]]) %[[VAL_152]], %[[VAL_153]] : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">
// CHECK-NEXT:            } do {
// CHECK-NEXT:            ^bb0(%[[VAL_155:[0-9a-zA-Z_\.]+]]: !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, %[[VAL_156:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
...
// CHECK-NEXT:              %[[VAL_163:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_155]]{{\[}}%[[VAL_161]], %[[VAL_162]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              %[[VAL_164:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_163]][@a] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
// CHECK-NEXT:              %[[VAL_165:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_148]] : !felt.type<"bn128">
// CHECK-NEXT:              array.write %[[VAL_164]]{{\[}}%[[VAL_165]]] = %[[VAL_159]] : <#map x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:              %[[VAL_169:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_155]]{{\[}}%[[VAL_167]], %[[VAL_168]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              pod.write %[[VAL_169]][@a] = %[[VAL_164]] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
...
// CHECK-NEXT:              array.write %[[VAL_155]]{{\[}}%[[VAL_171]], %[[VAL_172]]] = %[[VAL_169]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
...
// CHECK-NEXT:              %[[VAL_176:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_48]]{{\[}}%[[VAL_174]], %[[VAL_175]]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:              %[[VAL_180:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_155]]{{\[}}%[[VAL_178]], %[[VAL_179]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              %[[VAL_181:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_176]][@count] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, index
// CHECK-NEXT:              %[[VAL_182:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:              %[[VAL_183:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_181]], %[[VAL_182]] : index
// CHECK-NEXT:              pod.write %[[VAL_176]][@count] = %[[VAL_183]] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, index
...
// CHECK-NEXT:                %[[VAL_186:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_176]][@params] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, !pod.type<[@n: !felt.type<"bn128">]>
// CHECK-NEXT:                %[[VAL_187:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_180]][@a] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
...
// CHECK-NEXT:                %[[VAL_190:[0-9a-zA-Z_\.]+]] = function.call @A::@A::@compute(%[[VAL_187]]) {(%[[VAL_189]])} : (!array.type<#map x !felt.type<"bn128">>) -> !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:                pod.write %[[VAL_176]][@comp] = %[[VAL_190]] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map]>>
...
// CHECK-NEXT:                array.write %[[VAL_48]]{{\[}}%[[VAL_192]], %[[VAL_193]]] = %[[VAL_176]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
// CHECK-NEXT:              }
...
// CHECK-NEXT:              scf.yield %[[VAL_155]], %[[VAL_195]] : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">
// CHECK-NEXT:            }
...
// CHECK-NEXT:            scf.yield %[[VAL_151]]#0, %[[VAL_197]], %[[VAL_151]]#1 : !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_198:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_199:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_200:[0-9a-zA-Z_\.]+]] = %[[VAL_198]], %[[VAL_201:[0-9a-zA-Z_\.]+]] = %[[VAL_142]]#2) : (!felt.type<"bn128">, !felt.type<"bn128">) -> (!felt.type<"bn128">, !felt.type<"bn128">) {
...
// CHECK-NEXT:              %[[VAL_213:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_48]]{{\[}}%[[VAL_211]], %[[VAL_212]]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
// CHECK-NEXT:              %[[VAL_214:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_213]][@comp] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:              %[[VAL_215:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_214]][@c] : <@A::@A<[#map]>>, !array.type<? x !felt.type<"bn128">>
...
// CHECK-NEXT:              %[[VAL_239:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_48]]{{\[}}%[[VAL_237]], %[[VAL_238]]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
// CHECK-NEXT:              %[[VAL_240:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_239]][@comp] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:              %[[VAL_241:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_240]][@c] : <@A::@A<[#map]>>, !array.type<? x !felt.type<"bn128">>
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_39]][@as$inputs] = %[[VAL_142]]#0 : <@B::@B<[@n, @m, @j]>>, !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>
// CHECK-NEXT:          %[[VAL_250:[0-9a-zA-Z_\.]+]] = array.new  : <2,@j x !struct.type<@A::@A<[#map]>>>
...
// CHECK-NEXT:              %[[VAL_257:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_48]]{{\[}}%[[VAL_255]], %[[VAL_256]]] : <2,@j x !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>
// CHECK-NEXT:              %[[VAL_258:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_257]][@comp] : <[@count: index, @comp: !struct.type<@A::@A<[#map]>>, @params: !pod.type<[@n: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:              array.write %[[VAL_250]]{{\[}}%[[VAL_255]], %[[VAL_256]]] = %[[VAL_258]] : <2,@j x !struct.type<@A::@A<[#map]>>>, !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:            }
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_39]][@as] = %[[VAL_250]] : <@B::@B<[@n, @m, @j]>>, !array.type<2,@j x !struct.type<@A::@A<[#map]>>>
...
// CHECK-NEXT:          %[[VAL_270:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_259]][@as] : <@B::@B<[@n, @m, @j]>>, !array.type<2,@j x !struct.type<@A::@A<[#map]>>>
// CHECK-NEXT:          %[[VAL_271:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_259]][@as$inputs] : <@B::@B<[@n, @m, @j]>>, !array.type<2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>
...
// CHECK-NEXT:              %[[VAL_303:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_271]]{{\[}}%[[VAL_301]], %[[VAL_302]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              %[[VAL_304:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_303]][@a] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
// CHECK-NEXT:              %[[VAL_305:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_290]] : !felt.type<"bn128">
// CHECK-NEXT:              %[[VAL_306:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_304]]{{\[}}%[[VAL_305]]] : <#map x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:              %[[VAL_340:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_271]]{{\[}}%[[VAL_338]], %[[VAL_339]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              %[[VAL_341:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_340]][@a] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
// CHECK-NEXT:              %[[VAL_342:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_327]] : !felt.type<"bn128">
// CHECK-NEXT:              %[[VAL_343:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_341]]{{\[}}%[[VAL_342]]] : <#map x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:              %[[VAL_363:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_270]]{{\[}}%[[VAL_361]], %[[VAL_362]]] : <2,@j x !struct.type<@A::@A<[#map]>>>, !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:              %[[VAL_364:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_363]][@c] : <@A::@A<[#map]>>, !array.type<? x !felt.type<"bn128">>
...
// CHECK-NEXT:              %[[VAL_389:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_270]]{{\[}}%[[VAL_387]], %[[VAL_388]]] : <2,@j x !struct.type<@A::@A<[#map]>>>, !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:              %[[VAL_390:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_389]][@c] : <@A::@A<[#map]>>, !array.type<? x !felt.type<"bn128">>
...
// CHECK-NEXT:              %[[VAL_406:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_270]]{{\[}}%[[VAL_404]], %[[VAL_405]]] : <2,@j x !struct.type<@A::@A<[#map]>>>, !struct.type<@A::@A<[#map]>>
// CHECK-NEXT:              %[[VAL_407:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_271]]{{\[}}%[[VAL_404]], %[[VAL_405]]] : <2,@j x !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>>, !pod.type<[@a: !array.type<#map x !felt.type<"bn128">>]>
// CHECK-NEXT:              %[[VAL_408:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_407]][@a] : <[@a: !array.type<#map x !felt.type<"bn128">>]>, !array.type<#map x !felt.type<"bn128">>
// CHECK-NEXT:              function.call @A::@A::@constrain(%[[VAL_406]], %[[VAL_408]]) : (!struct.type<@A::@A<[#map]>>, !array.type<#map x !felt.type<"bn128">>) -> ()
// CHECK-NEXT:            }
// CHECK-NEXT:          }
// CHECK-NEXT:          function.return
// CHECK-NEXT:        }
