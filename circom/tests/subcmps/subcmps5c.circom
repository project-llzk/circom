...
// CHECK-NEXT:        struct.writef %[[VAL_1]][@o] = %[[VAL_0]] : <@Nop<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_4:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_2]][@o] : <@Nop<[]>>, !felt.type
...
// CHECK-NEXT:      struct.field @o : !felt.type {llzk.pub}
// CHECK-NEXT:      struct.field @n : !struct.type<@Nop<[]>>
...
// CHECK-NEXT:        %[[VAL_18:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_17]][@o] : <@Nop<[]>>, !felt.type
// CHECK-NEXT:        struct.writef %[[VAL_6]][@o] = %[[VAL_18]] : <@SubCmp<[]>>, !felt.type
// CHECK-NEXT:        struct.writef %[[VAL_6]][@n$inputs] = %[[VAL_9]] : <@SubCmp<[]>>, !pod.type<[@i: !felt.type]>
// CHECK-NEXT:        %[[VAL_19:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_8]][@comp] : <[@count: index, @comp: !struct.type<@Nop<[]>>, @params: !pod.type<[]>]>, !struct.type<@Nop<[]>>
// CHECK-NEXT:        struct.writef %[[VAL_6]][@n] = %[[VAL_19]] : <@SubCmp<[]>>, !struct.type<@Nop<[]>>
...
// CHECK-NEXT:        %[[VAL_22:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_20]][@o] : <@SubCmp<[]>>, !felt.type
// CHECK-NEXT:        %[[VAL_23:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_20]][@n] : <@SubCmp<[]>>, !struct.type<@Nop<[]>>
// CHECK-NEXT:        %[[VAL_24:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_20]][@n$inputs] : <@SubCmp<[]>>, !pod.type<[@i: !felt.type]>
...
// CHECK-NEXT:        %[[VAL_26:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_23]][@o] : <@Nop<[]>>, !felt.type
...
// CHECK-NEXT:        function.call @Nop::@constrain(%[[VAL_23]], %[[VAL_27]]) : (!struct.type<@Nop<[]>>, !felt.type) -> ()
// CHECK-NEXT:        function.return
// CHECK-NEXT:      }
// CHECK-NEXT:    }
// CHECK-NEXT:  }
