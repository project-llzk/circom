...
// CHECK-SAME:      ) -> !struct.type<@Nop<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-DAG:        %[[VAL_3:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_0]][@o] : <@Nop<[]>>, !felt.type
