...
// CHECK-NEXT:        %[[VAL_14:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_12]][@out] : <@IsZero<[]>>, !felt.type
// CHECK-NEXT:        %[[VAL_15:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_12]][@inv] : <@IsZero<[]>>, !felt.type
...
// CHECK-NEXT:      }
// CHECK-NEXT:    }
// CHECK-NEXT:    struct.def @SubCmps1<[@n]> {
...
// CHECK-NEXT:      function.def @compute(%[[VAL_22:[0-9a-zA-Z_\.]+]]: !array.type<@n x !felt.type>) -> !struct.type<@SubCmps1<[@n]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:        %[[VAL_23:[0-9a-zA-Z_\.]+]] = struct.new : <@SubCmps1<[@n]>>
...
// CHECK-NEXT:        %[[VAL_26:[0-9a-zA-Z_\.]+]] = array.new  : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>
...
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_26]]{{\[}}%[[VAL_30]]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          pod.write %[[VAL_31]][@count] = %[[VAL_32]] : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>, index
// CHECK-NEXT:          array.write %[[VAL_26]]{{\[}}%[[VAL_30]]] = %[[VAL_31]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:        }
...
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_37]], %[[VAL_24]])
...
// CHECK-NEXT:          %[[VAL_43:[0-9a-zA-Z_\.]+]] = pod.new { @count = %[[VAL_42]] }  : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
// CHECK-NEXT:          array.write %[[VAL_26]]{{\[}}%[[VAL_44]]] = %[[VAL_43]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_45:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
// CHECK-NEXT:          %[[VAL_46:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_22]]{{\[}}%[[VAL_45]]] : <@n x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_47:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
...
// CHECK-NEXT:          %[[VAL_49:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
// CHECK-NEXT:          array.write %[[VAL_41]]{{\[}}%[[VAL_49]]] = %[[VAL_48]] : <@n x !pod.type<[@in: !felt.type]>>, !pod.type<[@in: !felt.type]>
// CHECK-NEXT:          %[[VAL_50:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
// CHECK-NEXT:          %[[VAL_51:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_26]]{{\[}}%[[VAL_50]]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_52:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_51]][@count] : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>, index
// CHECK-NEXT:          %[[VAL_53:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_54:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_52]], %[[VAL_53]] : index
// CHECK-NEXT:          pod.write %[[VAL_51]][@count] = %[[VAL_54]] : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>, index
...
// CHECK-NEXT:            %[[VAL_58:[0-9a-zA-Z_\.]+]] = function.call @IsZero::@compute(%[[VAL_57]]) : (!felt.type) -> !struct.type<@IsZero<[]>>
// CHECK-NEXT:            pod.write %[[VAL_51]][@comp] = %[[VAL_58]] : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>, !struct.type<@IsZero<[]>>
// CHECK-NEXT:            %[[VAL_59:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
// CHECK-NEXT:            array.write %[[VAL_26]]{{\[}}%[[VAL_59]]] = %[[VAL_51]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          } else {
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_60:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
// CHECK-NEXT:          %[[VAL_61:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_26]]{{\[}}%[[VAL_60]]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_62:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_61]][@comp] : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>, !struct.type<@IsZero<[]>>
// CHECK-NEXT:          %[[VAL_63:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_62]][@out] : <@IsZero<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_64:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_40]]
...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_23]][@zeros$inputs] = %[[VAL_36]]#1 : <@SubCmps1<[@n]>>, !array.type<@n x !pod.type<[@in: !felt.type]>>
// CHECK-NEXT:        %[[VAL_67:[0-9a-zA-Z_\.]+]] = array.new  : <@n x !struct.type<@IsZero<[]>>>
...
// CHECK-NEXT:          %[[VAL_72:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_26]]{{\[}}%[[VAL_71]]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_73:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_72]][@comp] : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>, !struct.type<@IsZero<[]>>
// CHECK-NEXT:          array.write %[[VAL_67]]{{\[}}%[[VAL_71]]] = %[[VAL_73]] : <@n x !struct.type<@IsZero<[]>>>, !struct.type<@IsZero<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_23]][@zeros] = %[[VAL_67]] : <@SubCmps1<[@n]>>, !array.type<@n x !struct.type<@IsZero<[]>>>
// CHECK-NEXT:        struct.writem %[[VAL_23]][@outs] = %[[VAL_25]] : <@SubCmps1<[@n]>>, !array.type<@n x !felt.type>
// CHECK-NEXT:        function.return %[[VAL_23]] : !struct.type<@SubCmps1<[@n]>>
// CHECK-NEXT:      }
// CHECK-NEXT:      function.def @constrain(%[[VAL_74:[0-9a-zA-Z_\.]+]]: !struct.type<@SubCmps1<[@n]>>, %[[VAL_75:[0-9a-zA-Z_\.]+]]: !array.type<@n x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:        %[[VAL_76:[0-9a-zA-Z_\.]+]] = poly.read_const @n : !felt.type
// CHECK-NEXT:        %[[VAL_77:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_74]][@outs] : <@SubCmps1<[@n]>>, !array.type<@n x !felt.type>
// CHECK-NEXT:        %[[VAL_78:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_74]][@zeros] : <@SubCmps1<[@n]>>, !array.type<@n x !struct.type<@IsZero<[]>>>
// CHECK-NEXT:        %[[VAL_79:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_74]][@zeros$inputs] : <@SubCmps1<[@n]>>, !array.type<@n x !pod.type<[@in: !felt.type]>>
...
// CHECK-NEXT:          %[[VAL_84:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_83]], %[[VAL_76]])
...
// CHECK-NEXT:          %[[VAL_87:[0-9a-zA-Z_\.]+]] = pod.new { @count = %[[VAL_86]] }  : <[@count: index, @comp: !struct.type<@IsZero<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_88:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_85]]
// CHECK-NEXT:          %[[VAL_89:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_75]]{{\[}}%[[VAL_88]]] : <@n x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_90:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_85]]
...
// CHECK-NEXT:          %[[VAL_93:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_85]]
// CHECK-NEXT:          %[[VAL_94:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_78]]{{\[}}%[[VAL_93]]] : <@n x !struct.type<@IsZero<[]>>>, !struct.type<@IsZero<[]>>
// CHECK-NEXT:          %[[VAL_95:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_94]][@out] : <@IsZero<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_96:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_85]]
...
// CHECK-NEXT:          %[[VAL_104:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_78]]{{\[}}%[[VAL_103]]] : <@n x !struct.type<@IsZero<[]>>>, !struct.type<@IsZero<[]>>
...
// CHECK-NEXT:          function.call @IsZero::@constrain(%[[VAL_104]], %[[VAL_106]]) : (!struct.type<@IsZero<[]>>, !felt.type) -> ()
// CHECK-NEXT:        }
// CHECK-NEXT:        function.return
// CHECK-NEXT:      }
// CHECK-NEXT:    }
