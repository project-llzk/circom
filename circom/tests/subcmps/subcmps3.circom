...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !array.type<4 x !felt.type>) -> !struct.type<@SubCmps3::@SubCmps3<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_12:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_8]], %[[VAL_11]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_16:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_13]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_26:[0-9a-zA-Z_\.]+]] = function.call @Sum::@Sum::@compute(%[[VAL_25]]) : (!array.type<4 x !felt.type>) -> !struct.type<@Sum::@Sum<[4]>>
...
// CHECK-NEXT:            %[[VAL_28:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_13]], %[[VAL_27]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_30]][@outp] : <@Sum::@Sum<[4]>>, !felt.type
// CHECK-NEXT:              struct.writem %[[VAL_1]][@outp] = %[[VAL_31]] : <@SubCmps3::@SubCmps3<[]>>, !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_1]][@s$inputs] = %[[VAL_7]]#2 : <@SubCmps3::@SubCmps3<[]>>, !pod.type<[@inp: !array.type<4 x !felt.type>]>
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_35:[0-9a-zA-Z_\.]+]]: !struct.type<@SubCmps3::@SubCmps3<[]>>, %[[VAL_36:[0-9a-zA-Z_\.]+]]: !array.type<4 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_37:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_35]][@outp] : <@SubCmps3::@SubCmps3<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_38:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_35]][@s] : <@SubCmps3::@SubCmps3<[]>>, !struct.type<@Sum::@Sum<[4]>>
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_35]][@s$inputs] : <@SubCmps3::@SubCmps3<[]>>, !pod.type<[@inp: !array.type<4 x !felt.type>]>
...
// CHECK-NEXT:            %[[VAL_44:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_42]], %[[VAL_43]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_49:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_45]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_52:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_45]], %[[VAL_51]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.if %[[VAL_52]] {
// CHECK-NEXT:              %[[VAL_53:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_38]][@outp] : <@Sum::@Sum<[4]>>, !felt.type
...
// CHECK-NEXT:          function.call @Sum::@Sum::@constrain(%[[VAL_38]], %[[VAL_56]]) : (!struct.type<@Sum::@Sum<[4]>>, !array.type<4 x !felt.type>) -> ()
...
// CHECK-NEXT:        struct.member @outp : !felt.type {llzk.pub}
// CHECK-NEXT:        function.def @compute(%[[VAL_57:[0-9a-zA-Z_\.]+]]: !array.type<@n x !felt.type>) -> !struct.type<@Sum::@Sum<[@n]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_65:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_63]], %[[VAL_59]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_68:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_66]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_58]][@outp] = %[[VAL_62]]#1 : <@Sum::@Sum<[@n]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_58]] : !struct.type<@Sum::@Sum<[@n]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_73:[0-9a-zA-Z_\.]+]]: !struct.type<@Sum::@Sum<[@n]>>, %[[VAL_74:[0-9a-zA-Z_\.]+]]: !array.type<@n x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_75:[0-9a-zA-Z_\.]+]] = poly.read_const @n : !felt.type
// CHECK-NEXT:          %[[VAL_76:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_73]][@outp] : <@Sum::@Sum<[@n]>>, !felt.type
...
// CHECK-NEXT:            %[[VAL_82:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_80]], %[[VAL_75]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_85:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_83]] : !felt.type
