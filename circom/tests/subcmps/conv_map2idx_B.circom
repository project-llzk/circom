...
// CHECK-NEXT:          %[[VAL_2:[0-9a-zA-Z_\.]+]] = array.new  : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>
...
// CHECK-NEXT:          %[[VAL_12:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_9]] : (!pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[999, 0]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          array.write %[[VAL_2]]{{\[}}%[[VAL_11]]] = %[[VAL_12]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_21:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_18]] : (!pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[888, 1]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          array.write %[[VAL_2]]{{\[}}%[[VAL_20]]] = %[[VAL_21]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          %[[VAL_22:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_23:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_22]] : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_2]]{{\[}}%[[VAL_23]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_24]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>, !struct.type<@GetWeight::@GetWeight<[#map, #map]>>
...
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_2]]{{\[}}%[[VAL_30]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_31]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>, !struct.type<@GetWeight::@GetWeight<[#map, #map]>>
...
// CHECK-NEXT:            %[[VAL_41:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_2]]{{\[}}%[[VAL_40]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:            %[[VAL_42:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_41]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#map, #map]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>, !struct.type<@GetWeight::@GetWeight<[#map, #map]>>
