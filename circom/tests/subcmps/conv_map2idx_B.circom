...
// CHECK-NEXT:          %[[VAL_1:[0-9a-zA-Z_\.]+]] = array.new  : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>
// CHECK-NEXT:          %[[VAL_2:[0-9a-zA-Z_\.]+]] = array.new  : <2 x !pod.type<[]>>
// CHECK-NEXT:          %[[VAL_3:[0-9a-zA-Z_\.]+]] = felt.const  999 : <"bn128">
// CHECK-NEXT:          %[[VAL_4:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_5:[0-9a-zA-Z_\.]+]] = pod.new { @A = %[[VAL_3]], @B = %[[VAL_4]] }  : <[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>
// CHECK-NEXT:          %[[VAL_6:[0-9a-zA-Z_\.]+]] = pod.new : <[]>
// CHECK-NEXT:          %[[VAL_7:[0-9a-zA-Z_\.]+]] = function.call @GetWeight::@GetWeight::@compute() : () -> !struct.type<@GetWeight::@GetWeight<[999, 0]>>
// CHECK-NEXT:          %[[VAL_8:[0-9a-zA-Z_\.]+]] = pod.new { @comp = %[[VAL_7]] }  : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[999, 0]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          %[[VAL_9:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_10:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_9]] : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_8]] : (!pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[999, 0]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          array.write %[[VAL_1]]{{\[}}%[[VAL_10]]] = %[[VAL_11]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          %[[VAL_12:[0-9a-zA-Z_\.]+]] = felt.const  888 : <"bn128">
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = felt.const  1 : <"bn128">
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = pod.new { @A = %[[VAL_12]], @B = %[[VAL_13]] }  : <[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>
// CHECK-NEXT:          %[[VAL_15:[0-9a-zA-Z_\.]+]] = pod.new : <[]>
// CHECK-NEXT:          %[[VAL_16:[0-9a-zA-Z_\.]+]] = function.call @GetWeight::@GetWeight::@compute() : () -> !struct.type<@GetWeight::@GetWeight<[888, 1]>>
// CHECK-NEXT:          %[[VAL_17:[0-9a-zA-Z_\.]+]] = pod.new { @comp = %[[VAL_16]] }  : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[888, 1]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = felt.const  1 : <"bn128">
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_18]] : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_17]] : (!pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[888, 1]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          array.write %[[VAL_1]]{{\[}}%[[VAL_19]]] = %[[VAL_20]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
// CHECK-NEXT:          %[[VAL_21:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_22:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_23:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_22]] : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_1]]{{\[}}%[[VAL_23]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          array.write %[[VAL_21]]{{\[}}%[[VAL_28]]] = %[[VAL_26]] : <2 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_29:[0-9a-zA-Z_\.]+]] = felt.const  1 : <"bn128">
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_29]] : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_1]]{{\[}}%[[VAL_30]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          array.write %[[VAL_21]]{{\[}}%[[VAL_35]]] = %[[VAL_33]] : <2 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:          struct.writem %[[VAL_0]][@ws$inputs] = %[[VAL_2]] : <@ComputeValue::@ComputeValue<[]>>, !array.type<2 x !pod.type<[]>>
...
// CHECK-NEXT:            %[[VAL_41:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_1]]{{\[}}%[[VAL_40]]] : <2 x !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[#[[$ATTR_0]], #[[$ATTR_0]]]>>, @params: !pod.type<[@A: !felt.type<"bn128">, @B: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@ret] = %[[VAL_21]] : <@ComputeValue::@ComputeValue<[]>>, !array.type<2 x !felt.type<"bn128">>
