...
// CHECK-LABEL: module attributes {llzk.main = !struct.type<@BitwiseOr<[]>>, veridise.lang = "llzk"} {
...
// CHECK-SAME:      (%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@BitwiseOr<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:        struct.writem %[[VAL_1]][@type] = %[[VAL_3]] : <@BitwiseOr<[]>>, !felt.type
// CHECK-NEXT:        %[[VAL_4:[0-9a-zA-Z_\.]+]] = felt.const  32
// CHECK-NEXT:        %[[VAL_5:[0-9a-zA-Z_\.]+]] = felt.mul %[[VAL_3]], %[[VAL_4]] : !felt.type, !felt.type
// CHECK-NEXT:        struct.writem %[[VAL_1]][@check_v] = %[[VAL_5]] : <@BitwiseOr<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_8:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_6]][@type] : <@BitwiseOr<[]>>, !felt.type
// CHECK-NEXT:        %[[VAL_11:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_6]][@check_v] : <@BitwiseOr<[]>>, !felt.type
