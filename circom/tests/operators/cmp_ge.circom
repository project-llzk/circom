...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writef %[[VAL_1]][@b] = %[[VAL_3]] : <@CmpGE<[@n]>>, !array.type<@n x !felt.type>
...
// CHECK-NEXT:        %[[VAL_21:[0-9a-zA-Z_\.]+]] = felt.sub %[[VAL_18]], %[[VAL_20]] : !felt.type, !felt.type
// CHECK-NEXT:        %[[VAL_22:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_23:[0-9a-zA-Z_\.]+]] = %[[VAL_19]], %[[VAL_24:[0-9a-zA-Z_\.]+]] = %[[VAL_21]]) : (!array.type<@n x !felt.type>, !felt.type) -> (!array.type<@n x !felt.type>, !felt.type) {
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = bool.cmp ge(%[[VAL_24]], %[[VAL_25]])
...
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_16]][@b] : <@CmpGE<[@n]>>, !array.type<@n x !felt.type>
