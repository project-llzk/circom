...
// CHECK-LABEL: module attributes {llzk.main = !struct.type<@BoolNot<[]>>, veridise.lang = "llzk"} {
...
// CHECK-NEXT:       struct.writem %[[VAL_2]][@out] = %[[VAL_5]] : <@BoolNot<[]>>, !felt.type
...
// CHECK-NEXT:       %[[VAL_9:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_6]][@out] : <@BoolNot<[]>>, !felt.type
