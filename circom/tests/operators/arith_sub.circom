...
// CHECK-LABEL: module attributes {llzk.main = !struct.type<@ArithSubtract<[]>>, veridise.lang = "llzk"} {
...
// CHECK-NEXT:        struct.writem %[[VAL_3]][@x] = %[[VAL_6]] : <@ArithSubtract<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_14:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_7]][@x] : <@ArithSubtract<[]>>, !felt.type
