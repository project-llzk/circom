...
// CHECK-LABEL: module attributes {llzk.main = !struct.type<@CmpEQ<[5]>>, veridise.lang = "llzk"} {
...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_1]][@b] = %[[VAL_3]] : <@CmpEQ<[@n]>>, !array.type<@n x !felt.type>
...
// CHECK-NEXT:        %[[VAL_24:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_16]][@b] : <@CmpEQ<[@n]>>, !array.type<@n x !felt.type>
