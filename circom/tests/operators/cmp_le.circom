...
// CHECK-NEXT:    struct.def @CmpLE<[@n]> {
// CHECK-NEXT:      struct.field @b : !array.type<@n x !felt.type> {llzk.pub}
// CHECK-NEXT:      function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !array.type<@n x !felt.type>) -> !struct.type<@CmpLE<[@n]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:        %[[VAL_1:[0-9a-zA-Z_\.]+]] = struct.new : <@CmpLE<[@n]>>
...
// CHECK-NEXT:          %[[VAL_9:[0-9a-zA-Z_\.]+]] = bool.cmp le(%[[VAL_6]], %[[VAL_8]])
...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writef %[[VAL_1]][@b] = %[[VAL_3]] : <@CmpLE<[@n]>>, !array.type<@n x !felt.type>
// CHECK-NEXT:        function.return %[[VAL_1]] : !struct.type<@CmpLE<[@n]>>
// CHECK-NEXT:      }
...
// CHECK-NEXT:        %[[VAL_19:[0-9a-zA-Z_\.]+]] = undef.undef : !array.type<@n x !felt.type>
// CHECK-NEXT:        %[[VAL_20:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_21:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_22:[0-9a-zA-Z_\.]+]] = %[[VAL_19]], %[[VAL_23:[0-9a-zA-Z_\.]+]] = %[[VAL_20]]) : (!array.type<@n x !felt.type>, !felt.type) -> (!array.type<@n x !felt.type>, !felt.type) {
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = felt.sub %[[VAL_18]], %[[VAL_24]] : !felt.type, !felt.type
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = bool.cmp le(%[[VAL_23]], %[[VAL_25]])
// CHECK-NEXT:          scf.condition(%[[VAL_26]]) %[[VAL_22]], %[[VAL_23]] : !array.type<@n x !felt.type>, !felt.type
// CHECK-NEXT:        } do {
// CHECK-NEXT:        ^bb0(%[[VAL_27:[0-9a-zA-Z_\.]+]]: !array.type<@n x !felt.type>, %[[VAL_28:[0-9a-zA-Z_\.]+]]: !felt.type):
...
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_16]][@b] : <@CmpLE<[@n]>>, !array.type<@n x !felt.type>
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_28]]
// CHECK-NEXT:          %[[VAL_33:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_31]]{{\[}}%[[VAL_32]]] : <@n x !felt.type>, !felt.type
...
// CHECK-NEXT:          scf.yield %[[VAL_31]], %[[VAL_35]] : !array.type<@n x !felt.type>, !felt.type
// CHECK-NEXT:        }
