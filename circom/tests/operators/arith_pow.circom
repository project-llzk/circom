...
// CHECK-NEXT:     function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@ArithPower<[]>> attributes {function.allow_witness} {
...
// CHECK-NEXT:     }
// CHECK-NEXT:     function.def @constrain(%[[VAL_4:[0-9a-zA-Z_\.]+]]: !struct.type<@ArithPower<[]>>, %[[VAL_5:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint} {
