...
// CHECK-NEXT:        function.def @compute(%[[VAL_6:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@CallInlineSwitch::@CallInlineSwitch<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:          %[[VAL_7:[0-9a-zA-Z_\.]+]] = struct.new : <@CallInlineSwitch::@CallInlineSwitch<[]>>
// CHECK-NEXT:          %[[VAL_8:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_9:[0-9a-zA-Z_\.]+]] = bool.cmp ne(%[[VAL_6]], %[[VAL_8]]) : !felt.type, !felt.type
// CHECK-NEXT:          %[[VAL_10:[0-9a-zA-Z_\.]+]] = cast.tofelt %[[VAL_9]] : i1, !felt.type
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_12:[0-9a-zA-Z_\.]+]] = felt.div %[[VAL_11]], %[[VAL_6]] : !felt.type, !felt.type
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = function.call @InlineSwitch(%[[VAL_10]], %[[VAL_12]], %[[VAL_13]]) : (!felt.type, !felt.type, !felt.type) -> !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_7]][@out] = %[[VAL_14]] : <@CallInlineSwitch::@CallInlineSwitch<[]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_7]] : !struct.type<@CallInlineSwitch::@CallInlineSwitch<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_15:[0-9a-zA-Z_\.]+]]: !struct.type<@CallInlineSwitch::@CallInlineSwitch<[]>>, %[[VAL_16:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_17:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_15]][@out] : <@CallInlineSwitch::@CallInlineSwitch<[]>>, !felt.type
