...
// CHECK-NEXT:            %[[VAL_26:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_4]]{{\[}}%[[VAL_25]]] : <@"Sub_s@[[OFFSET0]]" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:          %[[VAL_36:[0-9a-zA-Z_\.]+]] = array.new  : <@"Sub_s@[[OFFSET1]]" x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_37:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:          %[[VAL_38:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_36]], %[[VAL_37]] : <@"Sub_s@[[OFFSET1]]" x !felt.type<"bn128">>
...
// CHECK-NEXT:            array.write %[[VAL_36]]{{\[}}%[[VAL_41]]] = %[[VAL_35]] : <@"Sub_s@[[OFFSET1]]" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_42:[0-9a-zA-Z_\.]+]] = poly.read_const @"Sub_s@[[OFFSET0]]" : index
// CHECK-NEXT:          %[[VAL_43:[0-9a-zA-Z_\.]+]] = poly.read_const @"Sub_s@[[OFFSET1]]" : index
...
// CHECK-NEXT:            %[[VAL_49:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_28]]{{\[}}%[[VAL_48]]] : <@"Sub_s@[[OFFSET0]]" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            array.write %[[VAL_36]]{{\[}}%[[VAL_48]]] = %[[VAL_49]] : <@"Sub_s@[[OFFSET1]]" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:          }
