...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_1]][@out] = %[[VAL_0]] : <@A::@A<[@s]>>, !array.type<@s x !felt.type>
...
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_10]][@out] : <@A::@A<[@s]>>, !array.type<@s x !felt.type>
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_15:[0-9a-zA-Z_\.]+]] = array.new  : <@s x !felt.type>
// CHECK-NEXT:          %[[VAL_16:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:          %[[VAL_17:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_15]], %[[VAL_16]] : <@s x !felt.type>
...
// CHECK-NEXT:            array.write %[[VAL_15]]{{\[}}%[[VAL_20]]] = %[[VAL_14]] : <@s x !felt.type>, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          constrain.eq %[[VAL_13]], %[[VAL_11]] : !array.type<@s x !felt.type>, !array.type<@s x !felt.type>
