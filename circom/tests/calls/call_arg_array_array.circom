...
// CHECK-NEXT:        function.def @compute(%[[VAL_38:[0-9a-zA-Z_\.]+]]: !array.type<4 x !felt.type<"bn128">>, %[[VAL_39:[0-9a-zA-Z_\.]+]]: !array.type<2 x !felt.type<"bn128">>) -> !struct.type<@CallArgTest::@CallArgTest<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_42:[0-9a-zA-Z_\.]+]]: !struct.type<@CallArgTest::@CallArgTest<[]>>, %[[VAL_43:[0-9a-zA-Z_\.]+]]: !array.type<4 x !felt.type<"bn128">>, %[[VAL_44:[0-9a-zA-Z_\.]+]]: !array.type<2 x !felt.type<"bn128">>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
