...
// CHECK-NEXT:        function.def @compute(%[[VAL_8:[0-9a-zA-Z_\.]+]]: !array.type<10,5,5 x !felt.type<"bn128">>, %[[VAL_9:[0-9a-zA-Z_\.]+]]: !array.type<10,5 x !felt.type<"bn128">>) -> !struct.type<@CallDiffTypeTest::@CallDiffTypeTest<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_13:[0-9a-zA-Z_\.]+]]: !struct.type<@CallDiffTypeTest::@CallDiffTypeTest<[]>>, %[[VAL_14:[0-9a-zA-Z_\.]+]]: !array.type<10,5,5 x !felt.type<"bn128">>, %[[VAL_15:[0-9a-zA-Z_\.]+]]: !array.type<10,5 x !felt.type<"bn128">>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
