...
// CHECK-NEXT:        %[[VAL_6:[0-9a-zA-Z_\.]+]] = bool.cmp le(%[[VAL_5]], %[[VAL_0]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_29:[0-9a-zA-Z_\.]+]] = bool.cmp le(%[[VAL_26]], %[[VAL_28]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          struct.writem %[[VAL_12]][@out] = %[[VAL_13]] : <@KnownFunctionArgs::@KnownFunctionArgs<[]>>, !array.type<3 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_38:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_37]][@out] : <@KnownFunctionArgs::@KnownFunctionArgs<[]>>, !array.type<3 x !felt.type>
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_40:[0-9a-zA-Z_\.]+]] = felt.const  2
// CHECK-NEXT:          %[[VAL_41:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_42:[0-9a-zA-Z_\.]+]] = %[[VAL_39]], %[[VAL_43:[0-9a-zA-Z_\.]+]] = %[[VAL_40]]) : (!felt.type, !felt.type) -> (!felt.type, !felt.type) {
// CHECK-NEXT:            %[[VAL_44:[0-9a-zA-Z_\.]+]] = felt.const  3
// CHECK-NEXT:            %[[VAL_45:[0-9a-zA-Z_\.]+]] = function.call @funWithLoop(%[[VAL_44]]) : (!felt.type) -> !felt.type
// CHECK-NEXT:            %[[VAL_46:[0-9a-zA-Z_\.]+]] = bool.cmp le(%[[VAL_43]], %[[VAL_45]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_46]]) %[[VAL_42]], %[[VAL_43]] : !felt.type, !felt.type
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_47:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_48:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:            %[[VAL_49:[0-9a-zA-Z_\.]+]] = felt.mul %[[VAL_47]], %[[VAL_48]] : !felt.type, !felt.type
