...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_1]][@out] = %[[VAL_3]] : <@VariantIndex<[@n]>>, !array.type<@n x !felt.type>
...
// CHECK-NEXT:        %{{[0-9a-zA-Z_\.]+}} = struct.readm %[[VAL_13]][@out] : <@VariantIndex<[@n]>>, !array.type<@n x !felt.type>
