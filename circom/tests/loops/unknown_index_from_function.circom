...
// CHECK-NEXT:          %[[VAL_9:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_8]], %[[VAL_4]])
...
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_10]]
...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_3]][@c] = %[[VAL_5]] : <@Example<[@n]>>, !array.type<@n x !felt.type>
...
// CHECK-NEXT:        %{{[0-9a-zA-Z_\.]+}} = struct.readm %[[VAL_17]][@c] : <@Example<[@n]>>, !array.type<@n x !felt.type>
...
// CHECK-NEXT:          scf.condition(%[[VAL_24]]) %[[VAL_23]] : !felt.type
// CHECK-NEXT:        } do {
