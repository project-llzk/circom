...
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_10]], %[[VAL_2]])
...
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_14]]
...
// CHECK-NEXT:            %[[VAL_23:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_22]], %[[VAL_2]])
...
// CHECK-NEXT:        %[[VAL_40:[0-9a-zA-Z_\.]+]]:3 = scf.while (%[[VAL_41:[0-9a-zA-Z_\.]+]] = %[[VAL_37]], %[[VAL_42:[0-9a-zA-Z_\.]+]] = %[[VAL_38]], %[[VAL_43:[0-9a-zA-Z_\.]+]] = %[[VAL_39]]) : (!felt.type, !felt.type, !felt.type) -> (!felt.type, !felt.type, !felt.type) {
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_43]], %[[VAL_36]])
// CHECK-NEXT:          scf.condition(%[[VAL_44]]) %[[VAL_41]], %[[VAL_42]], %[[VAL_43]] : !felt.type, !felt.type, !felt.type
// CHECK-NEXT:        } do {
// CHECK-NEXT:        ^bb0(%[[VAL_45:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_46:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_47:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:          %[[VAL_48:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_49:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_50:[0-9a-zA-Z_\.]+]] = %[[VAL_45]], %[[VAL_51:[0-9a-zA-Z_\.]+]] = %[[VAL_48]]) : (!felt.type, !felt.type) -> (!felt.type, !felt.type) {
// CHECK-NEXT:            %[[VAL_52:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_51]], %[[VAL_36]])
// CHECK-NEXT:            scf.condition(%[[VAL_52]]) %[[VAL_50]], %[[VAL_51]] : !felt.type, !felt.type
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_53:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_54:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:            %[[VAL_55:[0-9a-zA-Z_\.]+]] = felt.const  99
// CHECK-NEXT:            %[[VAL_56:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_53]], %[[VAL_55]] : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_57:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_58:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_54]], %[[VAL_57]] : !felt.type, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_56]], %[[VAL_58]] : !felt.type, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_59:[0-9a-zA-Z_\.]+]] = felt.const  5
// CHECK-NEXT:          %[[VAL_60:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_46]], %[[VAL_59]] : !felt.type, !felt.type
