...
// CHECK-NEXT:        function.def @compute(%[[V_IN:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@InnerConditional3::@InnerConditional3<[@N]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[SELF]][@out] = %[[V_5]]#0 : <@InnerConditional3::@InnerConditional3<[@N]>>, !felt.type
// CHECK-NEXT:          function.return %[[SELF]] : !struct.type<@InnerConditional3::@InnerConditional3<[@N]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[SELF:[0-9a-zA-Z_\.]+]]: !struct.type<@InnerConditional3::@InnerConditional3<[@N]>>, %[[V_IN:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[V_N:[0-9a-zA-Z_\.]+]] = poly.read_const @N : !felt.type
// CHECK-NEXT:          %[[V_36:[0-9a-zA-Z_\.]+]] = struct.readm %[[SELF]][@out] : <@InnerConditional3::@InnerConditional3<[@N]>>, !felt.type
// CHECK-NEXT:          %[[V_A0:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[V_I0:[0-9a-zA-Z_\.]+]] = felt.const  1
