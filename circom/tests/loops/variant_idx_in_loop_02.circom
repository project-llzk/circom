...
// CHECK-NEXT:            %[[VAL_14:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_12]], %[[VAL_2]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_18:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_15]] : !felt.type
...
// CHECK-NEXT:          struct.writem %[[VAL_1]][@out] = %[[VAL_27]] : <@VariantIndex::@VariantIndex<[@n]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_1]] : !struct.type<@VariantIndex::@VariantIndex<[@n]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_28:[0-9a-zA-Z_\.]+]]: !struct.type<@VariantIndex::@VariantIndex<[@n]>>, %[[VAL_29:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = poly.read_const @n : !felt.type
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_28]][@out] : <@VariantIndex::@VariantIndex<[@n]>>, !felt.type
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_33:[0-9a-zA-Z_\.]+]] = array.new  : <@n x !felt.type>
// CHECK-NEXT:          %[[VAL_34:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:          %[[VAL_35:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_33]], %[[VAL_34]] : <@n x !felt.type>
...
// CHECK-NEXT:            array.write %[[VAL_33]]{{\[}}%[[VAL_38]]] = %[[VAL_32]] : <@n x !felt.type>, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_40:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_41:[0-9a-zA-Z_\.]+]] = %[[VAL_39]], %[[VAL_42:[0-9a-zA-Z_\.]+]] = %[[VAL_33]]) : (!felt.type, !array.type<@n x !felt.type>) -> (!felt.type, !array.type<@n x !felt.type>) {
// CHECK-NEXT:            %[[VAL_43:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_41]], %[[VAL_30]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_43]]) %[[VAL_41]], %[[VAL_42]] : !felt.type, !array.type<@n x !felt.type>
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_44:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_45:[0-9a-zA-Z_\.]+]]: !array.type<@n x !felt.type>):
// CHECK-NEXT:            %[[VAL_46:[0-9a-zA-Z_\.]+]] = felt.shr %[[VAL_29]], %[[VAL_44]] : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_47:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_44]] : !felt.type
// CHECK-NEXT:            array.write %[[VAL_45]]{{\[}}%[[VAL_47]]] = %[[VAL_46]] : <@n x !felt.type>, !felt.type
// CHECK-NEXT:            %[[VAL_48:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_49:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_44]], %[[VAL_48]] : !felt.type, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_49]], %[[VAL_45]] : !felt.type, !array.type<@n x !felt.type>
// CHECK-NEXT:          }
