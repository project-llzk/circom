...
// CHECK-NEXT:                %[[VAL_38:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_37]], %[[VAL_2]]) : !felt.type<"bn128">, !felt.type<"bn128">
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_56]] : <@InnerConditional9::@InnerConditional9<[@N]>>, !felt.type<"bn128">
// CHECK-NEXT:          function.return %[[VAL_0]] : !struct.type<@InnerConditional9::@InnerConditional9<[@N]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_57:[0-9a-zA-Z_\.]+]]: !struct.type<@InnerConditional9::@InnerConditional9<[@N]>>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
...
// CHECK-NEXT:          %[[VAL_60:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_57]][@out] : <@InnerConditional9::@InnerConditional9<[@N]>>, !felt.type<"bn128">
...
// CHECK-NEXT:                %[[VAL_96:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_95]], %[[VAL_59]]) : !felt.type<"bn128">, !felt.type<"bn128">
