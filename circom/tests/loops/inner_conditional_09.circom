...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@InnerConditional9::@InnerConditional9<[4]>>} {
...
// CHECK-NEXT:                %[[VAL_37:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_36]], %[[VAL_1]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_55]] : <@InnerConditional9::@InnerConditional9<[@N]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_58:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_56]][@out] : <@InnerConditional9::@InnerConditional9<[@N]>>, !felt.type
...
// CHECK-NEXT:                %[[VAL_94:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_93]], %[[VAL_57]]) : !felt.type, !felt.type
