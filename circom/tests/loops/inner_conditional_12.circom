...
// CHECK-NEXT:                %[[VAL_37:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_36]], %[[VAL_15]]) : !felt.type<"bn128">, !felt.type<"bn128">
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_55]] : <@InnerConditional12::@InnerConditional12<[@N]>>, !felt.type<"bn128">
...
// CHECK-NEXT:          %[[VAL_58:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_56]][@out] : <@InnerConditional12::@InnerConditional12<[@N]>>, !felt.type<"bn128">
...
// CHECK-NEXT:                %[[VAL_94:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_93]], %[[VAL_72]]) : !felt.type<"bn128">, !felt.type<"bn128">
