...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@InnerConditional12<[4]>>} {
...
// CHECK-NEXT:            %[[VAL_13:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_12]], %[[VAL_1]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_17:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_15]], %[[VAL_16]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_23:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_22]], %[[VAL_1]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_26:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_15]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_30:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_15]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_37:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_36]], %[[VAL_15]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_40:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_15]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_44:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_15]] : !felt.type
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_55]] : <@InnerConditional12::@InnerConditional12<[@N]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_0]] : !struct.type<@InnerConditional12::@InnerConditional12<[@N]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_56:[0-9a-zA-Z_\.]+]]: !struct.type<@InnerConditional12::@InnerConditional12<[@N]>>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_57:[0-9a-zA-Z_\.]+]] = poly.read_const @N : !felt.type
// CHECK-NEXT:          %[[VAL_58:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_56]][@out] : <@InnerConditional12::@InnerConditional12<[@N]>>, !felt.type
// CHECK-NEXT:          %[[VAL_59:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_60:[0-9a-zA-Z_\.]+]] = array.new  : <@N x !felt.type>
// CHECK-NEXT:          %[[VAL_61:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:          %[[VAL_62:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_60]], %[[VAL_61]] : <@N x !felt.type>
...
// CHECK-NEXT:            array.write %[[VAL_60]]{{\[}}%[[VAL_65]]] = %[[VAL_59]] : <@N x !felt.type>, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_66:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_67:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_68:[0-9a-zA-Z_\.]+]] = %[[VAL_60]], %[[VAL_69:[0-9a-zA-Z_\.]+]] = %[[VAL_66]]) : (!array.type<@N x !felt.type>, !felt.type) -> (!array.type<@N x !felt.type>, !felt.type) {
// CHECK-NEXT:            %[[VAL_70:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_69]], %[[VAL_57]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_70]]) %[[VAL_68]], %[[VAL_69]] : !array.type<@N x !felt.type>, !felt.type
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_71:[0-9a-zA-Z_\.]+]]: !array.type<@N x !felt.type>, %[[VAL_72:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:            %[[VAL_73:[0-9a-zA-Z_\.]+]] = felt.const  2
// CHECK-NEXT:            %[[VAL_74:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_72]], %[[VAL_73]]) : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_75:[0-9a-zA-Z_\.]+]] = scf.if %[[VAL_74]] -> (!array.type<@N x !felt.type>) {
// CHECK-NEXT:              %[[VAL_76:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:              %[[VAL_77:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_78:[0-9a-zA-Z_\.]+]] = %[[VAL_71]], %[[VAL_79:[0-9a-zA-Z_\.]+]] = %[[VAL_76]]) : (!array.type<@N x !felt.type>, !felt.type) -> (!array.type<@N x !felt.type>, !felt.type) {
// CHECK-NEXT:                %[[VAL_80:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_79]], %[[VAL_57]]) : !felt.type, !felt.type
// CHECK-NEXT:                scf.condition(%[[VAL_80]]) %[[VAL_78]], %[[VAL_79]] : !array.type<@N x !felt.type>, !felt.type
// CHECK-NEXT:              } do {
// CHECK-NEXT:              ^bb0(%[[VAL_81:[0-9a-zA-Z_\.]+]]: !array.type<@N x !felt.type>, %[[VAL_82:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:                %[[VAL_83:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_72]] : !felt.type
// CHECK-NEXT:                %[[VAL_84:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_81]]{{\[}}%[[VAL_83]]] : <@N x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_85:[0-9a-zA-Z_\.]+]] = felt.const  999
// CHECK-NEXT:                %[[VAL_86:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_84]], %[[VAL_85]] : !felt.type, !felt.type
// CHECK-NEXT:                %[[VAL_87:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_72]] : !felt.type
// CHECK-NEXT:                array.write %[[VAL_81]]{{\[}}%[[VAL_87]]] = %[[VAL_86]] : <@N x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_88:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:                %[[VAL_89:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_82]], %[[VAL_88]] : !felt.type, !felt.type
// CHECK-NEXT:                scf.yield %[[VAL_81]], %[[VAL_89]] : !array.type<@N x !felt.type>, !felt.type
// CHECK-NEXT:              }
// CHECK-NEXT:              scf.yield %[[VAL_77]]#0 : !array.type<@N x !felt.type>
// CHECK-NEXT:            } else {
// CHECK-NEXT:              %[[VAL_90:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:              %[[VAL_91:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_92:[0-9a-zA-Z_\.]+]] = %[[VAL_71]], %[[VAL_93:[0-9a-zA-Z_\.]+]] = %[[VAL_90]]) : (!array.type<@N x !felt.type>, !felt.type) -> (!array.type<@N x !felt.type>, !felt.type) {
// CHECK-NEXT:                %[[VAL_94:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_93]], %[[VAL_72]]) : !felt.type, !felt.type
// CHECK-NEXT:                scf.condition(%[[VAL_94]]) %[[VAL_92]], %[[VAL_93]] : !array.type<@N x !felt.type>, !felt.type
// CHECK-NEXT:              } do {
// CHECK-NEXT:              ^bb0(%[[VAL_95:[0-9a-zA-Z_\.]+]]: !array.type<@N x !felt.type>, %[[VAL_96:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:                %[[VAL_97:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_72]] : !felt.type
// CHECK-NEXT:                %[[VAL_98:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_95]]{{\[}}%[[VAL_97]]] : <@N x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_99:[0-9a-zA-Z_\.]+]] = felt.const  888
// CHECK-NEXT:                %[[VAL_100:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_98]], %[[VAL_99]] : !felt.type, !felt.type
// CHECK-NEXT:                %[[VAL_101:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_72]] : !felt.type
// CHECK-NEXT:                array.write %[[VAL_95]]{{\[}}%[[VAL_101]]] = %[[VAL_100]] : <@N x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_102:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:                %[[VAL_103:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_96]], %[[VAL_102]] : !felt.type, !felt.type
// CHECK-NEXT:                scf.yield %[[VAL_95]], %[[VAL_103]] : !array.type<@N x !felt.type>, !felt.type
// CHECK-NEXT:              }
// CHECK-NEXT:              scf.yield %[[VAL_91]]#0 : !array.type<@N x !felt.type>
// CHECK-NEXT:            }
// CHECK-NEXT:            %[[VAL_104:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_105:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_72]], %[[VAL_104]] : !felt.type, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_75]], %[[VAL_105]] : !array.type<@N x !felt.type>, !felt.type
// CHECK-NEXT:          }
