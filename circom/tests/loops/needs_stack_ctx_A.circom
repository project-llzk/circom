...
// CHECK-NEXT:        function.def @compute(%[[VAL_19:[0-9a-zA-Z_\.]+]]: !array.type<@max x !felt.type<"bn128">>) -> !struct.type<@NeedsStackContext::@NeedsStackContext<[@max]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_32:[0-9a-zA-Z_\.]+]]: !struct.type<@NeedsStackContext::@NeedsStackContext<[@max]>>, %[[VAL_33:[0-9a-zA-Z_\.]+]]: !array.type<@max x !felt.type<"bn128">>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
