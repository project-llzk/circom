...
// CHECK-NEXT:            struct.writem %[[SELF]][@out] = %[[V_22]] : <@FibonacciTmpl::@FibonacciTmpl<[@N]>>, !felt.type
...
// CHECK-NEXT:              struct.writem %[[SELF]][@out] = %[[V_26]] : <@FibonacciTmpl::@FibonacciTmpl<[@N]>>, !felt.type
// CHECK-NEXT:              scf.yield %[[V_26]] : !felt.type
// CHECK-NEXT:            } else {
// CHECK-NEXT:              %[[V_27:[0-9a-zA-Z_\.]+]] = felt.add %[[V_5]]#0, %[[V_5]]#1 : !felt.type, !felt.type
// CHECK-NEXT:              struct.writem %[[SELF]][@out] = %[[V_27]] : <@FibonacciTmpl::@FibonacciTmpl<[@N]>>, !felt.type
...
// CHECK-NEXT:          %[[V_N:[0-9a-zA-Z_\.]+]] = poly.read_const @N : !felt.type
// CHECK-NEXT:          %{{[0-9a-zA-Z_\.]+}} = struct.readm %[[SELF]][@out] : <@FibonacciTmpl::@FibonacciTmpl<[@N]>>, !felt.type
// CHECK-NEXT:          %[[V_A0:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[V_B0:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[V_X0:[0-9a-zA-Z_\.]+]] = felt.const  0
