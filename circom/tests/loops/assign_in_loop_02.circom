...
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = array.new  : <@n x !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>>
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = array.new  : <@n x !pod.type<[@in: !felt.type<"bn128">]>>
// CHECK-NEXT:          %[[VAL_15:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_16:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_17:[0-9a-zA-Z_\.]+]] = %[[VAL_14]], %[[VAL_18:[0-9a-zA-Z_\.]+]] = %[[VAL_15]]) : (!array.type<@n x !pod.type<[@in: !felt.type<"bn128">]>>, !felt.type<"bn128">) -> (!array.type<@n x !pod.type<[@in: !felt.type<"bn128">]>>, !felt.type<"bn128">) {
// CHECK-NEXT:            %[[VAL_19:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_18]], %[[VAL_11]]) : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:            scf.condition(%[[VAL_19]]) %[[VAL_17]], %[[VAL_18]] : !array.type<@n x !pod.type<[@in: !felt.type<"bn128">]>>, !felt.type<"bn128">
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_20:[0-9a-zA-Z_\.]+]]: !array.type<@n x !pod.type<[@in: !felt.type<"bn128">]>>, %[[VAL_21:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
...
// CHECK-NEXT:            %[[VAL_25:[0-9a-zA-Z_\.]+]] = pod.new { @count = %[[VAL_24]], @params = %[[VAL_23]] } (%[[VAL_22]]) : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>
// CHECK-NEXT:            %[[VAL_26:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_21]] : !felt.type<"bn128">
// CHECK-NEXT:            array.write %[[VAL_13]]{{\[}}%[[VAL_26]]] = %[[VAL_25]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:            %[[VAL_31:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_13]]{{\[}}%[[VAL_30]]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:            %[[VAL_34:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_31]][@count] : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>, index
// CHECK-NEXT:            %[[VAL_35:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:            %[[VAL_36:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_34]], %[[VAL_35]] : index
// CHECK-NEXT:            pod.write %[[VAL_31]][@count] = %[[VAL_36]] : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>, index
...
// CHECK-NEXT:              %[[VAL_39:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_31]][@params] : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>, !pod.type<[@i: !felt.type<"bn128">]>
...
// CHECK-NEXT:              %[[VAL_43:[0-9a-zA-Z_\.]+]] = function.call @Inner::@Inner::@compute(%[[VAL_40]]) {(%[[VAL_42]])} : (!felt.type<"bn128">) -> !struct.type<@Inner::@Inner<[#map]>>
// CHECK-NEXT:              pod.write %[[VAL_31]][@comp] = %[[VAL_43]] : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>, !struct.type<@Inner::@Inner<[#map]>>
// CHECK-NEXT:              %[[VAL_44:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_21]] : !felt.type<"bn128">
// CHECK-NEXT:              array.write %[[VAL_13]]{{\[}}%[[VAL_44]]] = %[[VAL_31]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>
// CHECK-NEXT:            }
// CHECK-NEXT:            %[[VAL_45:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_21]] : !felt.type<"bn128">
// CHECK-NEXT:            %[[VAL_46:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_13]]{{\[}}%[[VAL_45]]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>
// CHECK-NEXT:            %[[VAL_47:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_46]][@comp] : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>, !struct.type<@Inner::@Inner<[#map]>>
// CHECK-NEXT:            %[[VAL_48:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_47]][@out] : <@Inner::@Inner<[#map]>>, !felt.type<"bn128">
...
// CHECK-NEXT:            scf.yield %[[VAL_20]], %[[VAL_51]] : !array.type<@n x !pod.type<[@in: !felt.type<"bn128">]>>, !felt.type<"bn128">
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_9]][@c$inputs] = %[[VAL_16]]#0 : <@Num2Bits::@Num2Bits<[@n]>>, !array.type<@n x !pod.type<[@in: !felt.type<"bn128">]>>
// CHECK-NEXT:          %[[VAL_52:[0-9a-zA-Z_\.]+]] = array.new  : <@n x !struct.type<@Inner::@Inner<[#map]>>>
...
// CHECK-NEXT:            %[[VAL_57:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_13]]{{\[}}%[[VAL_56]]] : <@n x !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>
// CHECK-NEXT:            %[[VAL_58:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_57]][@comp] : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>, !struct.type<@Inner::@Inner<[#map]>>
// CHECK-NEXT:            array.write %[[VAL_52]]{{\[}}%[[VAL_56]]] = %[[VAL_58]] : <@n x !struct.type<@Inner::@Inner<[#map]>>>, !struct.type<@Inner::@Inner<[#map]>>
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_9]][@c] = %[[VAL_52]] : <@Num2Bits::@Num2Bits<[@n]>>, !array.type<@n x !struct.type<@Inner::@Inner<[#map]>>>
...
// CHECK-NEXT:          %[[VAL_64:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_59]][@c] : <@Num2Bits::@Num2Bits<[@n]>>, !array.type<@n x !struct.type<@Inner::@Inner<[#map]>>>
...
// CHECK-NEXT:            %[[VAL_73:[0-9a-zA-Z_\.]+]] = pod.new(%[[VAL_71]]) : <[@count: index, @comp: !struct.type<@Inner::@Inner<[#map]>>, @params: !pod.type<[@i: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:            %[[VAL_80:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_64]]{{\[}}%[[VAL_79]]] : <@n x !struct.type<@Inner::@Inner<[#map]>>>, !struct.type<@Inner::@Inner<[#map]>>
...
// CHECK-NEXT:            function.call @Inner::@Inner::@constrain(%[[VAL_80]], %[[VAL_82]]) : (!struct.type<@Inner::@Inner<[#map]>>, !felt.type<"bn128">) -> ()
// CHECK-NEXT:          }
// CHECK-NEXT:          function.return
// CHECK-NEXT:        }
// CHECK-NEXT:      }
