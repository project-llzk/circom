...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_0]][@out] = %[[VAL_1]] : <@FixIdxNested<[]>>, !array.type<9 x !felt.type>
...
// CHECK-NEXT:        %{{[0-9a-zA-Z_\.]+}} = struct.readm %[[VAL_27]][@out] : <@FixIdxNested<[]>>, !array.type<9 x !felt.type>
...
// CHECK-NEXT:        %[[VAL_31:[0-9a-zA-Z_\.]+]] = felt.const  7
...
// CHECK-NEXT:        %[[VAL_39:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_30]], %[[VAL_31]], %[[VAL_32]], %[[VAL_33]], %[[VAL_34]], %[[VAL_35]], %[[VAL_36]], %[[VAL_37]], %[[VAL_38]] : <9 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_47:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_45]], %[[VAL_46]] : !felt.type, !felt.type
