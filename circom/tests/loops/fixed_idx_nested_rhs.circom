...
// CHECK-NEXT:          %[[VAL_5:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_0 : !array.type<16 x !felt.type<"bn128">>
...
// CHECK-NEXT:            %[[VAL_9:[0-9a-zA-Z_\.]+]] = felt.const  16 : <"bn128">
...
// CHECK-NEXT:            %[[VAL_13:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_5]]{{\[}}%[[VAL_12]]] : <16 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            %[[VAL_14:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_13]] : !felt.type<"bn128">
// CHECK-NEXT:            %[[VAL_15:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_0]]{{\[}}%[[VAL_14]]] : <16 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            %[[VAL_16:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_11]] : !felt.type<"bn128">
// CHECK-NEXT:            array.write %[[VAL_2]]{{\[}}%[[VAL_16]]] = %[[VAL_15]] : <16 x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_19:[0-9a-zA-Z_\.]+]]: !struct.type<@FixIdxNested::@FixIdxNested<[]>>, %[[VAL_20:[0-9a-zA-Z_\.]+]]: !array.type<16 x !felt.type<"bn128">> {function.arg_name = "in"}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_21:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_19]][@out] : <@FixIdxNested::@FixIdxNested<[]>>, !array.type<16 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_22:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_23:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]], %[[VAL_22]] : <16 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_0 : !array.type<16 x !felt.type<"bn128">>
...
// CHECK-NEXT:            %[[VAL_28:[0-9a-zA-Z_\.]+]] = felt.const  16 : <"bn128">
...
// CHECK-NEXT:            %[[VAL_32:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_24]]{{\[}}%[[VAL_31]]] : <16 x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:            %[[VAL_36:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_21]]{{\[}}%[[VAL_35]]] : <16 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            constrain.eq %[[VAL_36]], %[[VAL_34]] : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:            %[[VAL_37:[0-9a-zA-Z_\.]+]] = felt.const  1 : <"bn128">
// CHECK-NEXT:            %[[VAL_38:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_30]], %[[VAL_37]] : !felt.type<"bn128">, !felt.type<"bn128">
...
// CHECK-NEXT:      global.def const @array_const_0 : !array.type<16 x !felt.type<"bn128">> = [ 0 : <"bn128">,  5 : <"bn128">,  10 : <"bn128">,  15 : <"bn128">,  4 : <"bn128">,  9 : <"bn128">,  14 : <"bn128">,  3 : <"bn128">,  8 : <"bn128">,  13 : <"bn128">,  2 : <"bn128">,  7 : <"bn128">,  12 : <"bn128">,  1 : <"bn128">,  6 : <"bn128">,  11 : <"bn128">]
// CHECK-NEXT:    }
// CHECK-NEXT:  }
