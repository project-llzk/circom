...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@NonZeroInit<[]>>} {
...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !array.type<9 x !felt.type>) -> !struct.type<@NonZeroInit::@NonZeroInit<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_7:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_5]], %[[VAL_6]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_29:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_27]], %[[VAL_28]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_33:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_30]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_1]][@b] = %[[VAL_2]] : <@NonZeroInit::@NonZeroInit<[]>>, !array.type<9 x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_1]] : !struct.type<@NonZeroInit::@NonZeroInit<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_36:[0-9a-zA-Z_\.]+]]: !struct.type<@NonZeroInit::@NonZeroInit<[]>>, %[[VAL_37:[0-9a-zA-Z_\.]+]]: !array.type<9 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_38:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_36]][@b] : <@NonZeroInit::@NonZeroInit<[]>>, !array.type<9 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_46:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_44]], %[[VAL_45]] : !felt.type, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_46]] : !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_47:[0-9a-zA-Z_\.]+]] = felt.const  7
// CHECK-NEXT:          %[[VAL_48:[0-9a-zA-Z_\.]+]] = scf.while (%[[VAL_49:[0-9a-zA-Z_\.]+]] = %[[VAL_47]]) : (!felt.type) -> !felt.type {
// CHECK-NEXT:            %[[VAL_50:[0-9a-zA-Z_\.]+]] = felt.const  9
// CHECK-NEXT:            %[[VAL_51:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_49]], %[[VAL_50]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_51]]) %[[VAL_49]] : !felt.type
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_52:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:            %[[VAL_53:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_54:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_52]], %[[VAL_53]] : !felt.type, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_54]] : !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_55:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_56:[0-9a-zA-Z_\.]+]] = scf.while (%[[VAL_57:[0-9a-zA-Z_\.]+]] = %[[VAL_55]]) : (!felt.type) -> !felt.type {
// CHECK-NEXT:            %[[VAL_58:[0-9a-zA-Z_\.]+]] = felt.const  4
// CHECK-NEXT:            %[[VAL_59:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_57]], %[[VAL_58]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_59]]) %[[VAL_57]] : !felt.type
// CHECK-NEXT:          } do {
...
// CHECK-NEXT:            scf.yield %[[VAL_62]] : !felt.type
// CHECK-NEXT:          }
