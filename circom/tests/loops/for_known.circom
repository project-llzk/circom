...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_4]]#0 : <@ForKnown::@ForKnown<[@N]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_15:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_13]][@out] : <@ForKnown::@ForKnown<[@N]>>, !felt.type
