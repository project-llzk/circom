...
// CHECK-NEXT:            array.write %[[VAL_8]]{{\[}}%[[VAL_19]]] = %[[VAL_18]] : <@"n_Mul_n@[[OFFSET0]]" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_4]][@out] = %[[VAL_8]] : <@VariantIndex::@VariantIndex<[@n]>>, !array.type<@"n_Mul_n@[[OFFSET0]]" x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = poly.read_const @"n_Mul_n@[[OFFSET0]]" : index
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = cast.tofelt %[[VAL_25]] : index, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_27:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_22]][@out] : <@VariantIndex::@VariantIndex<[@n]>>, !array.type<@"n_Mul_n@[[OFFSET0]]" x !felt.type<"bn128">>
