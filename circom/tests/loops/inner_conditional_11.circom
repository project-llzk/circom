...
// CHECK-NEXT:              %[[VAL_26:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_25]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_39:[0-9a-zA-Z_\.]+]] = function.call @Sigma::@Sigma::@compute(%[[VAL_38]]) : (!felt.type) -> !struct.type<@Sigma::@Sigma<[]>>
...
// CHECK-NEXT:              %[[VAL_43:[0-9a-zA-Z_\.]+]] = bool.cmp ge(%[[VAL_16]], %[[VAL_42]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_48:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_47]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_55:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_54]] : !felt.type
...
// CHECK-NEXT:                  %[[VAL_63:[0-9a-zA-Z_\.]+]] = function.call @Sigma::@Sigma::@compute(%[[VAL_62]]) : (!felt.type) -> !struct.type<@Sigma::@Sigma<[]>>
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_75:[0-9a-zA-Z_\.]+]]: !struct.type<@Poseidon::@Poseidon<[]>>, %[[VAL_76:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_77:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_75]][@sigmaF] : <@Poseidon::@Poseidon<[]>>, !array.type<2 x !struct.type<@Sigma::@Sigma<[]>>>
// CHECK-NEXT:          %[[VAL_78:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_75]][@sigmaF$inputs] : <@Poseidon::@Poseidon<[]>>, !array.type<2 x !pod.type<[@inp: !felt.type]>>
...
// CHECK-NEXT:            %[[VAL_83:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_81]], %[[VAL_82]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_86:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_84]], %[[VAL_85]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_94:[0-9a-zA-Z_\.]+]] = bool.cmp ge(%[[VAL_84]], %[[VAL_93]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_98:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_97]] : !felt.type
...
// CHECK-NEXT:            function.call @Sigma::@Sigma::@constrain(%[[VAL_107]], %[[VAL_109]]) : (!struct.type<@Sigma::@Sigma<[]>>, !felt.type) -> ()
// CHECK-NEXT:          }
...
// CHECK-NEXT:        function.def @compute(%[[VAL_110:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@Sigma::@Sigma<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:          %[[VAL_111:[0-9a-zA-Z_\.]+]] = struct.new : <@Sigma::@Sigma<[]>>
// CHECK-NEXT:          function.return %[[VAL_111]] : !struct.type<@Sigma::@Sigma<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_112:[0-9a-zA-Z_\.]+]]: !struct.type<@Sigma::@Sigma<[]>>, %[[VAL_113:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_114:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_112]][@out] : <@Sigma::@Sigma<[]>>, !felt.type
// CHECK-NEXT:          function.return
// CHECK-NEXT:        }
// CHECK-NEXT:      }
// CHECK-NEXT:    }
