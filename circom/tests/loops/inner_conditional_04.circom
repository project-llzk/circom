...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@InnerConditional4<[6]>>} {
...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@InnerConditional4::@InnerConditional4<[@N]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:              %[[VAL_12:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_8]] : !felt.type
// CHECK-NEXT:              array.write %[[VAL_3]]{{\[}}%[[VAL_12]]] = %[[VAL_11]] : <@N x !felt.type>, !felt.type
// CHECK-NEXT:            } else {
// CHECK-NEXT:              %[[VAL_13:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_8]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_1]][@out] = %[[VAL_3]] : <@InnerConditional4::@InnerConditional4<[@N]>>, !array.type<@N x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_1]] : !struct.type<@InnerConditional4::@InnerConditional4<[@N]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_16:[0-9a-zA-Z_\.]+]]: !struct.type<@InnerConditional4::@InnerConditional4<[@N]>>, %[[VAL_17:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = poly.read_const @N : !felt.type
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_16]][@out] : <@InnerConditional4::@InnerConditional4<[@N]>>, !array.type<@N x !felt.type>
...
// CHECK-NEXT:            %[[VAL_23:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_22]], %[[VAL_18]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_28:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_24]], %[[VAL_27]] : !felt.type, !felt.type
