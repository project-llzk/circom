...
// CHECK-NEXT:            %[[VAL_11:[0-9a-zA-Z_\.]+]] = function.call @accumulate::@accumulate::@compute(%[[VAL_10]]) : (!felt.type) -> !struct.type<@accumulate::@accumulate<[]>>
...
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_12]][@o] : <@accumulate::@accumulate<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_0]][@y] = %[[VAL_13]] : <@KnownLoopViaSignal::@KnownLoopViaSignal<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_0]][@a$inputs] = %[[VAL_3]] : <@KnownLoopViaSignal::@KnownLoopViaSignal<[]>>, !pod.type<[@i: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_16:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_15]][@y] : <@KnownLoopViaSignal::@KnownLoopViaSignal<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_15]][@a$inputs] : <@KnownLoopViaSignal::@KnownLoopViaSignal<[]>>, !pod.type<[@i: !felt.type]>
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_18]][@i] : <[@i: !felt.type]>, !felt.type
// CHECK-NEXT:          function.call @accumulate::@accumulate::@constrain(%[[VAL_17]], %[[VAL_19]]) : (!struct.type<@accumulate::@accumulate<[]>>, !felt.type) -> ()
...
// CHECK-NEXT:        function.def @compute(%[[VAL_20:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@accumulate::@accumulate<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_25:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_24]], %[[VAL_20]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_21]][@o] = %[[VAL_23]] : <@accumulate::@accumulate<[]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_21]] : !struct.type<@accumulate::@accumulate<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_29:[0-9a-zA-Z_\.]+]]: !struct.type<@accumulate::@accumulate<[]>>, %[[VAL_30:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_29]][@o] : <@accumulate::@accumulate<[]>>, !felt.type
...
// CHECK-NEXT:            %[[VAL_35:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_34]], %[[VAL_30]]) : !felt.type, !felt.type
