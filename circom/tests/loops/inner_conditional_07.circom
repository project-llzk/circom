...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@InnerConditional7::@InnerConditional7<[3]>>} {
...
// CHECK-NEXT:          struct.writem %[[V_0]][@out] = %[[V_46]] : <@InnerConditional7::@InnerConditional7<[@N]>>, !felt.type
...
// CHECK-NEXT:          %[[V_N:[0-9a-zA-Z_\.]+]] = poly.read_const @N : !felt.type
// CHECK-NEXT:          %[[V_87:[0-9a-zA-Z_\.]+]] = struct.readm %[[V_47]][@out] : <@InnerConditional7::@InnerConditional7<[@N]>>, !felt.type
