...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@Good<[2]>>} {
// CHECK-NEXT:    struct.def @Good<[@N]> {
// CHECK-NEXT:      struct.member @c : !array.type<@N x !struct.type<@Mult<[]>>>
// CHECK-NEXT:      struct.member @c$inputs : !array.type<@N x !pod.type<[@in: !array.type<2 x !felt.type>]>>
// CHECK-NEXT:      function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !array.type<@N,2 x !felt.type>) -> !struct.type<@Good<[@N]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:        %[[VAL_1:[0-9a-zA-Z_\.]+]] = struct.new : <@Good<[@N]>>
// CHECK-NEXT:        %[[VAL_2:[0-9a-zA-Z_\.]+]] = poly.read_const @N : !felt.type
// CHECK-NEXT:        %[[VAL_3:[0-9a-zA-Z_\.]+]] = array.new  : <@N x !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>>
...
// CHECK-NEXT:          %[[VAL_8:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_3]]{{\[}}%[[VAL_7]]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_9:[0-9a-zA-Z_\.]+]] = arith.constant 2 : index
// CHECK-NEXT:          pod.write %[[VAL_8]][@count] = %[[VAL_9]] : <[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>, index
// CHECK-NEXT:          array.write %[[VAL_3]]{{\[}}%[[VAL_7]]] = %[[VAL_8]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:        }
...
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = pod.new { @count = %[[VAL_18]] }  : <[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_17]]
// CHECK-NEXT:          array.write %[[VAL_3]]{{\[}}%[[VAL_20]]] = %[[VAL_19]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
...
// CHECK-NEXT:            %[[VAL_30:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_28]]
// CHECK-NEXT:            %[[VAL_31:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_0]]{{\[}}%[[VAL_29]], %[[VAL_30]]] : <@N,2 x !felt.type>, !felt.type
// CHECK-NEXT:            %[[VAL_32:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_17]]
...
// CHECK-NEXT:            %[[VAL_35:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_28]]
// CHECK-NEXT:            array.write %[[VAL_34]]{{\[}}%[[VAL_35]]] = %[[VAL_31]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:            %[[VAL_36:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_17]]
...
// CHECK-NEXT:            %[[VAL_39:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_17]]
// CHECK-NEXT:            %[[VAL_40:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_3]]{{\[}}%[[VAL_39]]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:            %[[VAL_41:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_40]][@count] : <[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>, index
// CHECK-NEXT:            %[[VAL_42:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:            %[[VAL_43:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_41]], %[[VAL_42]] : index
// CHECK-NEXT:            pod.write %[[VAL_40]][@count] = %[[VAL_43]] : <[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>, index
...
// CHECK-NEXT:              %[[VAL_47:[0-9a-zA-Z_\.]+]] = function.call @Mult::@compute(%[[VAL_46]]) : (!array.type<2 x !felt.type>) -> !struct.type<@Mult<[]>>
// CHECK-NEXT:              pod.write %[[VAL_40]][@comp] = %[[VAL_47]] : <[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>, !struct.type<@Mult<[]>>
// CHECK-NEXT:              %[[VAL_48:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_17]]
// CHECK-NEXT:              array.write %[[VAL_3]]{{\[}}%[[VAL_48]]] = %[[VAL_40]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:            } else {
// CHECK-NEXT:            }
...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_1]][@c$inputs] = %[[VAL_12]]#0 : <@Good<[@N]>>, !array.type<@N x !pod.type<[@in: !array.type<2 x !felt.type>]>>
// CHECK-NEXT:        %[[VAL_53:[0-9a-zA-Z_\.]+]] = array.new  : <@N x !struct.type<@Mult<[]>>>
...
// CHECK-NEXT:          %[[VAL_58:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_3]]{{\[}}%[[VAL_57]]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:          %[[VAL_59:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_58]][@comp] : <[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>, !struct.type<@Mult<[]>>
// CHECK-NEXT:          array.write %[[VAL_53]]{{\[}}%[[VAL_57]]] = %[[VAL_59]] : <@N x !struct.type<@Mult<[]>>>, !struct.type<@Mult<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_1]][@c] = %[[VAL_53]] : <@Good<[@N]>>, !array.type<@N x !struct.type<@Mult<[]>>>
// CHECK-NEXT:        function.return %[[VAL_1]] : !struct.type<@Good<[@N]>>
// CHECK-NEXT:      }
// CHECK-NEXT:      function.def @constrain(%[[VAL_60:[0-9a-zA-Z_\.]+]]: !struct.type<@Good<[@N]>>, %[[VAL_61:[0-9a-zA-Z_\.]+]]: !array.type<@N,2 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:        %[[VAL_62:[0-9a-zA-Z_\.]+]] = poly.read_const @N : !felt.type
// CHECK-NEXT:        %[[VAL_63:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_60]][@c] : <@Good<[@N]>>, !array.type<@N x !struct.type<@Mult<[]>>>
// CHECK-NEXT:        %[[VAL_64:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_60]][@c$inputs] : <@Good<[@N]>>, !array.type<@N x !pod.type<[@in: !array.type<2 x !felt.type>]>>
...
// CHECK-NEXT:          %[[VAL_68:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_67]], %[[VAL_62]])
...
// CHECK-NEXT:          %[[VAL_71:[0-9a-zA-Z_\.]+]] = pod.new { @count = %[[VAL_70]] }  : <[@count: index, @comp: !struct.type<@Mult<[]>>, @params: !pod.type<[]>]>
...
// CHECK-NEXT:            %[[VAL_76:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_74]], %[[VAL_75]])
...
// CHECK-NEXT:            %[[VAL_79:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_77]]
// CHECK-NEXT:            %[[VAL_80:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_61]]{{\[}}%[[VAL_78]], %[[VAL_79]]] : <@N,2 x !felt.type>, !felt.type
// CHECK-NEXT:            %[[VAL_81:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_69]]
...
// CHECK-NEXT:            %[[VAL_84:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_77]]
...
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_88:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_69]]
// CHECK-NEXT:          %[[VAL_89:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_63]]{{\[}}%[[VAL_88]]] : <@N x !struct.type<@Mult<[]>>>, !struct.type<@Mult<[]>>
// CHECK-NEXT:          %[[VAL_90:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_89]][@out] : <@Mult<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_98:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_63]]{{\[}}%[[VAL_97]]] : <@N x !struct.type<@Mult<[]>>>, !struct.type<@Mult<[]>>
...
// CHECK-NEXT:          function.call @Mult::@constrain(%[[VAL_98]], %[[VAL_100]]) : (!struct.type<@Mult<[]>>, !array.type<2 x !felt.type>) -> ()
// CHECK-NEXT:        }
...
// CHECK-NEXT:      function.def @compute(%[[VAL_101:[0-9a-zA-Z_\.]+]]: !array.type<2 x !felt.type>) -> !struct.type<@Mult<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:        %[[VAL_102:[0-9a-zA-Z_\.]+]] = struct.new : <@Mult<[]>>
// CHECK-NEXT:        function.return %[[VAL_102]] : !struct.type<@Mult<[]>>
// CHECK-NEXT:      }
// CHECK-NEXT:      function.def @constrain(%[[VAL_103:[0-9a-zA-Z_\.]+]]: !struct.type<@Mult<[]>>, %[[VAL_104:[0-9a-zA-Z_\.]+]]: !array.type<2 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:        %[[VAL_105:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_103]][@out] : <@Mult<[]>>, !felt.type
// CHECK-NEXT:        function.return
// CHECK-NEXT:      }
// CHECK-NEXT:    }
// CHECK-NEXT:  }
