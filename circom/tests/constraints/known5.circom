...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@valA] = %[[VAL_1]] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_2:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_3:[0-9a-zA-Z_\.]+]] = felt.mul %[[VAL_1]], %[[VAL_2]] : !felt.type, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_0]][@valB] = %[[VAL_3]] : <@A::@A<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_5:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_4]][@valA] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_6:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_4]][@valB] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_7:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_8:[0-9a-zA-Z_\.]+]] = felt.mul %[[VAL_5]], %[[VAL_7]] : !felt.type, !felt.type
