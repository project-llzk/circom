...
// CHECK-NEXT:      %[[VAL_6:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_0]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_8]][@feeOut] = %[[VAL_9]] : <@ComputeFee::@ComputeFee<[]>>, !array.type<2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_21:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_20]][@feeOut] : <@ComputeFee::@ComputeFee<[]>>, !array.type<2 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_28:[0-9a-zA-Z_\.]+]] = function.call @feeShiftTable(%[[VAL_27]]) : (!felt.type) -> !felt.type
// CHECK-NEXT:            %[[VAL_29:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_27]] : !felt.type
// CHECK-NEXT:            %[[VAL_30:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_21]]{{\[}}%[[VAL_29]]] : <2 x !felt.type>, !felt.type
