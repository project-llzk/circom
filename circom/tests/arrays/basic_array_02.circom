...
// CHECK-NEXT:          %[[VAL_21:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_20]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_31:[0-9a-zA-Z_\.]+]] = function.call @B::@B::@compute(%[[VAL_30]]) : (!felt.type) -> !struct.type<@B::@B<[]>>
...
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_38]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_42:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_41]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_43]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_52:[0-9a-zA-Z_\.]+]] = function.call @B::@B::@compute(%[[VAL_51]]) : (!felt.type) -> !struct.type<@B::@B<[]>>
...
// CHECK-NEXT:          %[[VAL_63:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_62]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_65:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_64]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_73:[0-9a-zA-Z_\.]+]] = function.call @B::@B::@compute(%[[VAL_72]]) : (!felt.type) -> !struct.type<@B::@B<[]>>
...
// CHECK-NEXT:            %[[VAL_82:[0-9a-zA-Z_\.]+]] = function.call @C::@C::@compute(%[[VAL_81]]) : (!felt.type) -> !struct.type<@C::@C<[]>>
...
// CHECK-NEXT:          %[[VAL_84:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_83]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_87:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_86]][@y] : <@B::@B<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_88:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_89:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_88]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_92:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_91]][@y] : <@B::@B<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_98:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_97]][@y] : <@B::@B<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_101:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_100]][@y] : <@C::@C<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_102:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_99]], %[[VAL_101]] : !felt.type, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_1]][@y] = %[[VAL_102]] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_1]][@bs$inputs] = %[[VAL_9]] : <@A::@A<[]>>, !array.type<3 x !pod.type<[@x: !felt.type]>>
...
// CHECK-NEXT:          struct.writem %[[VAL_1]][@c$inputs] = %[[VAL_12]] : <@A::@A<[]>>, !pod.type<[@x: !felt.type]>
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_111:[0-9a-zA-Z_\.]+]]: !struct.type<@A::@A<[]>>, %[[VAL_112:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_113:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_111]][@y] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_114:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_111]][@bs] : <@A::@A<[]>>, !array.type<3 x !struct.type<@B::@B<[]>>>
// CHECK-NEXT:          %[[VAL_115:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_111]][@bs$inputs] : <@A::@A<[]>>, !array.type<3 x !pod.type<[@x: !felt.type]>>
// CHECK-NEXT:          %[[VAL_116:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_111]][@c] : <@A::@A<[]>>, !struct.type<@C::@C<[]>>
// CHECK-NEXT:          %[[VAL_117:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_111]][@c$inputs] : <@A::@A<[]>>, !pod.type<[@x: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_121:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_120]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_127:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_126]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_133:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_132]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_138:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_137]] : !felt.type
// CHECK-NEXT:          %[[VAL_139:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_114]]{{\[}}%[[VAL_138]]] : <3 x !struct.type<@B::@B<[]>>>, !struct.type<@B::@B<[]>>
// CHECK-NEXT:          %[[VAL_140:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_139]][@y] : <@B::@B<[]>>, !felt.type
...
// CHECK-NEXT:            function.call @B::@B::@constrain(%[[VAL_157]], %[[VAL_159]]) : (!struct.type<@B::@B<[]>>, !felt.type) -> ()
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_160:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_117]][@x] : <[@x: !felt.type]>, !felt.type
// CHECK-NEXT:          function.call @C::@C::@constrain(%[[VAL_116]], %[[VAL_160]]) : (!struct.type<@C::@C<[]>>, !felt.type) -> ()
...
// CHECK-NEXT:        struct.member @y : !felt.type {llzk.pub}
// CHECK-NEXT:        function.def @compute(%[[VAL_161:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@B::@B<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:          %[[VAL_162:[0-9a-zA-Z_\.]+]] = struct.new : <@B::@B<[]>>
// CHECK-NEXT:          %[[VAL_163:[0-9a-zA-Z_\.]+]] = felt.mul %[[VAL_161]], %[[VAL_161]] : !felt.type, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_162]][@y] = %[[VAL_163]] : <@B::@B<[]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_162]] : !struct.type<@B::@B<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_164:[0-9a-zA-Z_\.]+]]: !struct.type<@B::@B<[]>>, %[[VAL_165:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_166:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_164]][@y] : <@B::@B<[]>>, !felt.type
...
// CHECK-NEXT:        struct.member @y : !felt.type {llzk.pub}
// CHECK-NEXT:        function.def @compute(%[[VAL_168:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@C::@C<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:          %[[VAL_169:[0-9a-zA-Z_\.]+]] = struct.new : <@C::@C<[]>>
// CHECK-NEXT:          %[[VAL_170:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_168]], %[[VAL_168]] : !felt.type, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_169]][@y] = %[[VAL_170]] : <@C::@C<[]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_169]] : !struct.type<@C::@C<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_171:[0-9a-zA-Z_\.]+]]: !struct.type<@C::@C<[]>>, %[[VAL_172:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_173:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_171]][@y] : <@C::@C<[]>>, !felt.type
