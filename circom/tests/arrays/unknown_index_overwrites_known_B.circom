...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@UnknownIndexOverwriteKnown::@UnknownIndexOverwriteKnown<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          %[[VAL_43:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_0]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_59:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_57]], %[[VAL_58]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_64:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_62]], %[[VAL_63]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_69:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_67]], %[[VAL_68]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_74:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_72]], %[[VAL_73]]) : !felt.type, !felt.type
// CHECK-NEXT:          bool.assert %[[VAL_74]], "assertion failed"
// CHECK-NEXT:          %[[VAL_75:[0-9a-zA-Z_\.]+]] = felt.const  46
// CHECK-NEXT:          %[[VAL_76:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_44]], %[[VAL_75]]) : !felt.type, !felt.type
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_77:[0-9a-zA-Z_\.]+]]: !struct.type<@UnknownIndexOverwriteKnown::@UnknownIndexOverwriteKnown<[]>>, %[[VAL_78:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_79:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_77]][@out] : <@UnknownIndexOverwriteKnown::@UnknownIndexOverwriteKnown<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_80:[0-9a-zA-Z_\.]+]] = felt.const  45
// CHECK-NEXT:          %[[VAL_81:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_82:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_81]], %[[VAL_81]], %[[VAL_81]], %[[VAL_81]], %[[VAL_81]], %[[VAL_81]], %[[VAL_81]], %[[VAL_81]], %[[VAL_81]], %[[VAL_81]] : <10 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_93:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_83]], %[[VAL_84]], %[[VAL_85]], %[[VAL_86]], %[[VAL_87]], %[[VAL_88]], %[[VAL_89]], %[[VAL_90]], %[[VAL_91]], %[[VAL_92]] : <10 x !felt.type>
// CHECK-NEXT:          %[[VAL_94:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_95:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_94]], %[[VAL_94]], %[[VAL_94]], %[[VAL_94]], %[[VAL_94]], %[[VAL_94]], %[[VAL_94]], %[[VAL_94]], %[[VAL_94]], %[[VAL_94]] : <10 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_106:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_96]], %[[VAL_97]], %[[VAL_98]], %[[VAL_99]], %[[VAL_100]], %[[VAL_101]], %[[VAL_102]], %[[VAL_103]], %[[VAL_104]], %[[VAL_105]] : <10 x !felt.type>
// CHECK-NEXT:          %[[VAL_107:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_108:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_107]], %[[VAL_107]], %[[VAL_107]], %[[VAL_107]], %[[VAL_107]], %[[VAL_107]], %[[VAL_107]], %[[VAL_107]], %[[VAL_107]], %[[VAL_107]] : <10 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_119:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_109]], %[[VAL_110]], %[[VAL_111]], %[[VAL_112]], %[[VAL_113]], %[[VAL_114]], %[[VAL_115]], %[[VAL_116]], %[[VAL_117]], %[[VAL_118]] : <10 x !felt.type>
// CHECK-NEXT:          %[[VAL_120:[0-9a-zA-Z_\.]+]] = felt.const  99
// CHECK-NEXT:          %[[VAL_121:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_78]] : !felt.type
// CHECK-NEXT:          array.write %[[VAL_106]]{{\[}}%[[VAL_121]]] = %[[VAL_120]] : <10 x !felt.type>, !felt.type
...
// CHECK-NEXT:          %[[VAL_125:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_106]]{{\[}}%[[VAL_124]]] : <10 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_126:[0-9a-zA-Z_\.]+]] = felt.const  19
// CHECK-NEXT:          %[[VAL_127:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_125]], %[[VAL_126]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_130:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_106]]{{\[}}%[[VAL_129]]] : <10 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_131:[0-9a-zA-Z_\.]+]] = felt.const  99
// CHECK-NEXT:          %[[VAL_132:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_130]], %[[VAL_131]]) : !felt.type, !felt.type
// CHECK-NEXT:          bool.assert %[[VAL_132]], "assertion failed"
// CHECK-NEXT:          %[[VAL_133:[0-9a-zA-Z_\.]+]] = felt.const  9
// CHECK-NEXT:          %[[VAL_134:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_133]] : !felt.type
// CHECK-NEXT:          %[[VAL_135:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_93]]{{\[}}%[[VAL_134]]] : <10 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_136:[0-9a-zA-Z_\.]+]] = felt.const  9
// CHECK-NEXT:          %[[VAL_137:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_135]], %[[VAL_136]]) : !felt.type, !felt.type
// CHECK-NEXT:          bool.assert %[[VAL_137]], "assertion failed"
// CHECK-NEXT:          %[[VAL_138:[0-9a-zA-Z_\.]+]] = felt.const  4
// CHECK-NEXT:          %[[VAL_139:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_138]] : !felt.type
// CHECK-NEXT:          %[[VAL_140:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_93]]{{\[}}%[[VAL_139]]] : <10 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_141:[0-9a-zA-Z_\.]+]] = felt.const  4
// CHECK-NEXT:          %[[VAL_142:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_140]], %[[VAL_141]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_145:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_119]]{{\[}}%[[VAL_144]]] : <10 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_146:[0-9a-zA-Z_\.]+]] = felt.const  20
// CHECK-NEXT:          %[[VAL_147:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_145]], %[[VAL_146]]) : !felt.type, !felt.type
// CHECK-NEXT:          bool.assert %[[VAL_147]], "assertion failed"
// CHECK-NEXT:          %[[VAL_148:[0-9a-zA-Z_\.]+]] = felt.const  7
// CHECK-NEXT:          %[[VAL_149:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_148]] : !felt.type
// CHECK-NEXT:          %[[VAL_150:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_119]]{{\[}}%[[VAL_149]]] : <10 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_151:[0-9a-zA-Z_\.]+]] = felt.const  27
// CHECK-NEXT:          %[[VAL_152:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_150]], %[[VAL_151]]) : !felt.type, !felt.type
// CHECK-NEXT:          bool.assert %[[VAL_152]], "assertion failed"
// CHECK-NEXT:          %[[VAL_153:[0-9a-zA-Z_\.]+]] = felt.const  46
// CHECK-NEXT:          %[[VAL_154:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_122]], %[[VAL_153]]) : !felt.type, !felt.type
