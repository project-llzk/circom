...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@UnknownIndexLoadStore::@UnknownIndexLoadStore<[]>>} {
...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@UnknownIndexLoadStore::@UnknownIndexLoadStore<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          %[[VAL_42:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_0]] : !felt.type
// CHECK-NEXT:          %[[VAL_43:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_27]]{{\[}}%[[VAL_42]]] : <10 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_0]] : !felt.type
// CHECK-NEXT:          array.write %[[VAL_2]]{{\[}}%[[VAL_44]]] = %[[VAL_43]] : <8 x !felt.type>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_1]][@out] = %[[VAL_2]] : <@UnknownIndexLoadStore::@UnknownIndexLoadStore<[]>>, !array.type<8 x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_1]] : !struct.type<@UnknownIndexLoadStore::@UnknownIndexLoadStore<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_45:[0-9a-zA-Z_\.]+]]: !struct.type<@UnknownIndexLoadStore::@UnknownIndexLoadStore<[]>>, %[[VAL_46:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_47:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_45]][@out] : <@UnknownIndexLoadStore::@UnknownIndexLoadStore<[]>>, !array.type<8 x !felt.type>
// CHECK-NEXT:          %[[VAL_48:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_49:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_48]], %[[VAL_48]], %[[VAL_48]], %[[VAL_48]], %[[VAL_48]], %[[VAL_48]], %[[VAL_48]], %[[VAL_48]], %[[VAL_48]] : <9 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_59:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_50]], %[[VAL_51]], %[[VAL_52]], %[[VAL_53]], %[[VAL_54]], %[[VAL_55]], %[[VAL_56]], %[[VAL_57]], %[[VAL_58]] : <9 x !felt.type>
// CHECK-NEXT:          %[[VAL_60:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_61:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_60]], %[[VAL_60]], %[[VAL_60]], %[[VAL_60]], %[[VAL_60]], %[[VAL_60]], %[[VAL_60]], %[[VAL_60]], %[[VAL_60]], %[[VAL_60]] : <10 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_72:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_62]], %[[VAL_63]], %[[VAL_64]], %[[VAL_65]], %[[VAL_66]], %[[VAL_67]], %[[VAL_68]], %[[VAL_69]], %[[VAL_70]], %[[VAL_71]] : <10 x !felt.type>
// CHECK-NEXT:          %[[VAL_73:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_74:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]], %[[VAL_73]] : <11 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_86:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_75]], %[[VAL_76]], %[[VAL_77]], %[[VAL_78]], %[[VAL_79]], %[[VAL_80]], %[[VAL_81]], %[[VAL_82]], %[[VAL_83]], %[[VAL_84]], %[[VAL_85]] : <11 x !felt.type>
