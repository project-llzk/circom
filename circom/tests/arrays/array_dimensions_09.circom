...
// CHECK-NEXT:          %[[VAL_5:[0-9a-zA-Z_\.]+]] = poly.read_const @"D@292" : index
...
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = array.new  : <@"D@292" x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_12:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_11]], %[[VAL_12]] : <@"D@292" x !felt.type<"bn128">>
...
// CHECK-NEXT:            array.write %[[VAL_11]]{{\[}}%[[VAL_16]]] = %[[VAL_10]] : <@"D@292" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:          }
...
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = poly.read_const @"D@292" : index
...
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = array.new  : <@"D@292" x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_24]], %[[VAL_25]] : <@"D@292" x !felt.type<"bn128">>
...
// CHECK-NEXT:            array.write %[[VAL_24]]{{\[}}%[[VAL_29]]] = %[[VAL_23]] : <@"D@292" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:          }
