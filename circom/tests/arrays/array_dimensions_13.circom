...
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = poly.read_const @"D@333" : index
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = cast.tofelt %[[VAL_19]] : index, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_21:[0-9a-zA-Z_\.]+]] = poly.read_const @"D@438" : index
...
// CHECK-NEXT:            %[[VAL_31:[0-9a-zA-Z_\.]+]] = array.new  : <@"D@333" x !felt.type<"bn128">>
// CHECK-NEXT:            %[[VAL_32:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:            %[[VAL_33:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_31]], %[[VAL_32]] : <@"D@333" x !felt.type<"bn128">>
...
// CHECK-NEXT:              array.write %[[VAL_31]]{{\[}}%[[VAL_36]]] = %[[VAL_30]] : <@"D@333" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            }
...
// CHECK-NEXT:            array.write %[[VAL_31]]{{\[}}%[[VAL_40]]] = %[[VAL_37]] : <@"D@333" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:            %[[VAL_44:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_31]]{{\[}}%[[VAL_43]]] : <@"D@333" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:            %[[VAL_49:[0-9a-zA-Z_\.]+]] = array.new  : <@"D@438" x !felt.type<"bn128">>
// CHECK-NEXT:            %[[VAL_50:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:            %[[VAL_51:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_49]], %[[VAL_50]] : <@"D@438" x !felt.type<"bn128">>
...
// CHECK-NEXT:              array.write %[[VAL_49]]{{\[}}%[[VAL_54]]] = %[[VAL_48]] : <@"D@438" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            }
...
// CHECK-NEXT:            array.write %[[VAL_49]]{{\[}}%[[VAL_58]]] = %[[VAL_55]] : <@"D@438" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:            %[[VAL_62:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_49]]{{\[}}%[[VAL_61]]] : <@"D@438" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:          %[[VAL_64:[0-9a-zA-Z_\.]+]] = poly.read_const @"D@333" : index
// CHECK-NEXT:          %[[VAL_65:[0-9a-zA-Z_\.]+]] = cast.tofelt %[[VAL_64]] : index, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_66:[0-9a-zA-Z_\.]+]] = poly.read_const @"D@438" : index
...
// CHECK-NEXT:            %[[VAL_76:[0-9a-zA-Z_\.]+]] = array.new  : <@"D@333" x !felt.type<"bn128">>
// CHECK-NEXT:            %[[VAL_77:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:            %[[VAL_78:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_76]], %[[VAL_77]] : <@"D@333" x !felt.type<"bn128">>
...
// CHECK-NEXT:              array.write %[[VAL_76]]{{\[}}%[[VAL_81]]] = %[[VAL_75]] : <@"D@333" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            }
...
// CHECK-NEXT:            array.write %[[VAL_76]]{{\[}}%[[VAL_85]]] = %[[VAL_82]] : <@"D@333" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:            %[[VAL_89:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_76]]{{\[}}%[[VAL_88]]] : <@"D@333" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:            %[[VAL_94:[0-9a-zA-Z_\.]+]] = array.new  : <@"D@438" x !felt.type<"bn128">>
// CHECK-NEXT:            %[[VAL_95:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:            %[[VAL_96:[0-9a-zA-Z_\.]+]] = array.len %[[VAL_94]], %[[VAL_95]] : <@"D@438" x !felt.type<"bn128">>
...
// CHECK-NEXT:              array.write %[[VAL_94]]{{\[}}%[[VAL_99]]] = %[[VAL_93]] : <@"D@438" x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            }
...
// CHECK-NEXT:            array.write %[[VAL_94]]{{\[}}%[[VAL_103]]] = %[[VAL_100]] : <@"D@438" x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:            %[[VAL_107:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_94]]{{\[}}%[[VAL_106]]] : <@"D@438" x !felt.type<"bn128">>, !felt.type<"bn128">
