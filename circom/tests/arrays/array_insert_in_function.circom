...
// CHECK-NEXT:    function.def @lookup() -> !felt.type<"bn128"> attributes {function.allow_non_native_field_ops} {
...
// CHECK-NEXT:        function.def @compute(%[[VAL_20:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">) -> !struct.type<@Caller::@Caller<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
// CHECK-NEXT:          %[[VAL_21:[0-9a-zA-Z_\.]+]] = struct.new : <@Caller::@Caller<[]>>
// CHECK-NEXT:          %[[VAL_22:[0-9a-zA-Z_\.]+]] = function.call @lookup() : () -> !felt.type<"bn128">
// CHECK-NEXT:          struct.writem %[[VAL_21]][@out] = %[[VAL_22]] : <@Caller::@Caller<[]>>, !felt.type<"bn128">
// CHECK-NEXT:          function.return %[[VAL_21]] : !struct.type<@Caller::@Caller<[]>>
// CHECK-NEXT:        }
...
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = function.call @lookup() : () -> !felt.type<"bn128">
