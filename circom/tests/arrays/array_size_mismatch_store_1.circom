...
// CHECK-NEXT:            %[[VAL_28:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_14]]{{\[}}%[[VAL_26]], %[[VAL_27]]] : <1,3 x !felt.type>, !felt.type
// CHECK-NEXT:            array.write %[[VAL_3]]{{\[}}%[[VAL_26]], %[[VAL_27]]] = %[[VAL_28]] : <2,2 x !felt.type>, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:        }
...
// CHECK-NEXT:      }
// CHECK-NEXT:      function.def @constrain(%[[VAL_29:[0-9a-zA-Z_\.]+]]: !struct.type<@ArrayShenanigans<[]>>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:        %[[VAL_30:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_29]][@outp] : <@ArrayShenanigans<[]>>, !array.type<2,2 x !felt.type>
// CHECK-NEXT:        %[[VAL_31:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_32:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_31]], %[[VAL_31]] : <2 x !felt.type>
// CHECK-NEXT:        %[[VAL_33:[0-9a-zA-Z_\.]+]] = array.new  : <2,2 x !felt.type>
// CHECK-NEXT:        %[[VAL_34:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:        array.insert %[[VAL_33]]{{\[}}%[[VAL_34]]] = %[[VAL_32]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:        %[[VAL_35:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:        array.insert %[[VAL_33]]{{\[}}%[[VAL_35]]] = %[[VAL_32]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:        %[[VAL_36:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_37:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_36]], %[[VAL_36]], %[[VAL_36]] : <3 x !felt.type>
// CHECK-NEXT:        %[[VAL_38:[0-9a-zA-Z_\.]+]] = array.new  : <1,3 x !felt.type>
// CHECK-NEXT:        %[[VAL_39:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:        array.insert %[[VAL_38]]{{\[}}%[[VAL_39]]] = %[[VAL_37]] : <1,3 x !felt.type>, <3 x !felt.type>
...
// CHECK-NEXT:        %[[VAL_43:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_40]], %[[VAL_41]], %[[VAL_42]] : <3 x !felt.type>
// CHECK-NEXT:        %[[VAL_44:[0-9a-zA-Z_\.]+]] = array.new  : <1,3 x !felt.type>
// CHECK-NEXT:        %[[VAL_45:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:        array.insert %[[VAL_44]]{{\[}}%[[VAL_45]]] = %[[VAL_43]] : <1,3 x !felt.type>, <3 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_58:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_44]]{{\[}}%[[VAL_56]], %[[VAL_57]]] : <1,3 x !felt.type>, !felt.type
// CHECK-NEXT:            array.write %[[VAL_33]]{{\[}}%[[VAL_56]], %[[VAL_57]]] = %[[VAL_58]] : <2,2 x !felt.type>, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:        }
// CHECK-NEXT:        constrain.eq %[[VAL_30]], %[[VAL_33]] : !array.type<2,2 x !felt.type>, !array.type<2,2 x !felt.type>
