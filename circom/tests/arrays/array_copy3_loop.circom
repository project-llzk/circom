...
// CHECK-NEXT:              %[[VAL_12:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_11]], %[[VAL_2]]) : !felt.type<"bn128">, !felt.type<"bn128">
...
// CHECK-NEXT:              %[[VAL_16:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_15]]] : <@n,@n x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:              array.write %[[VAL_3]]{{\[}}%[[VAL_17]], %[[VAL_18]]] = %[[VAL_16]] : <@n,@n x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:              %[[VAL_19:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:              %[[VAL_20:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_13]], %[[VAL_19]] : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:              scf.yield %[[VAL_20]] : !felt.type<"bn128">
// CHECK-NEXT:            }
// CHECK-NEXT:            %[[VAL_21:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_22:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_8]], %[[VAL_21]] : !felt.type<"bn128">, !felt.type<"bn128">
...
// CHECK-NEXT:              %[[VAL_35:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_34]], %[[VAL_25]]) : !felt.type<"bn128">, !felt.type<"bn128">
...
// CHECK-NEXT:              %[[VAL_39:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_24]]{{\[}}%[[VAL_37]], %[[VAL_38]]] : <@n,@n x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:              %[[VAL_40:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_31]] : !felt.type<"bn128">
// CHECK-NEXT:              %[[VAL_41:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_36]] : !felt.type<"bn128">
// CHECK-NEXT:              %[[VAL_42:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_26]]{{\[}}%[[VAL_40]], %[[VAL_41]]] : <@n,@n x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:              constrain.eq %[[VAL_42]], %[[VAL_39]] : !felt.type<"bn128">, !felt.type<"bn128">
