...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@Array3<[5]>>} {
...
// CHECK-NEXT:          %[[VAL_3:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<@n,@n x !felt.type>
...
// CHECK-NEXT:              %[[VAL_12:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_11]], %[[VAL_2]]) : !felt.type, !felt.type
// CHECK-NEXT:              scf.condition(%[[VAL_12]]) %[[VAL_11]] : !felt.type
// CHECK-NEXT:            } do {
// CHECK-NEXT:            ^bb0(%[[VAL_13:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:              %[[VAL_14:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_8]] : !felt.type
// CHECK-NEXT:              %[[VAL_15:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_13]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_1]][@out] = %[[VAL_3]] : <@Array3::@Array3<[@n]>>, !array.type<@n,@n x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_1]] : !struct.type<@Array3::@Array3<[@n]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_23:[0-9a-zA-Z_\.]+]]: !struct.type<@Array3::@Array3<[@n]>>, %[[VAL_24:[0-9a-zA-Z_\.]+]]: !array.type<@n,@n x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = poly.read_const @n : !felt.type
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_23]][@out] : <@Array3::@Array3<[@n]>>, !array.type<@n,@n x !felt.type>
...
// CHECK-NEXT:              %[[VAL_35:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_34]], %[[VAL_25]]) : !felt.type, !felt.type
// CHECK-NEXT:              scf.condition(%[[VAL_35]]) %[[VAL_34]] : !felt.type
// CHECK-NEXT:            } do {
// CHECK-NEXT:            ^bb0(%[[VAL_36:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:              %[[VAL_37:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_31]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_40:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_31]] : !felt.type
// CHECK-NEXT:              %[[VAL_41:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_36]] : !felt.type
