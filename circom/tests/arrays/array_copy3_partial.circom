...
// CHECK-NEXT:        %[[VAL_17:[0-9a-zA-Z_\.]+]] = undef.undef : !array.type<@n,@n x !felt.type>
// CHECK-NEXT:        %[[VAL_18:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_19:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_20:[0-9a-zA-Z_\.]+]] = %[[VAL_18]], %[[VAL_21:[0-9a-zA-Z_\.]+]] = %[[VAL_17]]) : (!felt.type, !array.type<@n,@n x !felt.type>) -> (!felt.type, !array.type<@n,@n x !felt.type>) {
// CHECK-NEXT:          %[[VAL_22:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_20]], %[[VAL_16]])
// CHECK-NEXT:          scf.condition(%[[VAL_22]]) %[[VAL_20]], %[[VAL_21]] : !felt.type, !array.type<@n,@n x !felt.type>
// CHECK-NEXT:        } do {
// CHECK-NEXT:        ^bb0(%[[VAL_23:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_24:[0-9a-zA-Z_\.]+]]: !array.type<@n,@n x !felt.type>):
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_23]]
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = array.extract %[[VAL_15]]{{\[}}%[[VAL_25]]] : <@n,@n x !felt.type>
// CHECK-NEXT:          %[[VAL_27:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_14]][@out] : <@Array3<[@n]>>, !array.type<@n,@n x !felt.type>
// CHECK-NEXT:          %[[VAL_28:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_23]]
// CHECK-NEXT:          %[[VAL_29:[0-9a-zA-Z_\.]+]] = array.extract %[[VAL_27]]{{\[}}%[[VAL_28]]] : <@n,@n x !felt.type>
// CHECK-NEXT:          constrain.eq %[[VAL_29]], %[[VAL_26]] : !array.type<@n x !felt.type>, !array.type<@n x !felt.type>
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_23]], %[[VAL_30]] : !felt.type, !felt.type
// CHECK-NEXT:          scf.yield %[[VAL_31]], %[[VAL_27]] : !felt.type, !array.type<@n,@n x !felt.type>
// CHECK-NEXT:        }
