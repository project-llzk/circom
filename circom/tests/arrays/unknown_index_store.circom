...
// CHECK-NEXT:        struct.writem %[[VAL_1]][@out] = %[[VAL_2]] : <@UnknownIndexStore<[]>>, !array.type<8 x !felt.type>
...
// CHECK-NEXT:        %{{[0-9a-zA-Z_\.]+}} = struct.readm %[[VAL_5]][@out] : <@UnknownIndexStore<[]>>, !array.type<8 x !felt.type>
