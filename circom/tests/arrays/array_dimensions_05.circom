...
// CHECK-NEXT:      poly.expr @"M@[[OFFSET0:[0-9]+]]" {
...
// CHECK-NEXT:        struct.member @outp : !array.type<@"M@[[OFFSET0]]" x !felt.type<"bn128">> {llzk.pub, signal}
...
// CHECK-NEXT:          %[[VAL_5:[0-9a-zA-Z_\.]+]] = poly.read_const @"M@[[OFFSET0]]" : index
...
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = poly.read_const @"M@[[OFFSET0]]" : index
...
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_10]][@outp] : <@ArrayDims::@ArrayDims<[@N]>>, !array.type<@"M@[[OFFSET0]]" x !felt.type<"bn128">>
