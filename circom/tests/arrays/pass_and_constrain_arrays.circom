...
// CHECK-NEXT:        %[[VAL_253:[0-9a-zA-Z_\.]+]] = undef.undef : !array.type<16,2 x !felt.type>
// CHECK-NEXT:        %[[VAL_254:[0-9a-zA-Z_\.]+]] = undef.undef : !array.type<2 x !felt.type>
// CHECK-NEXT:        %[[VAL_255:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_256:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_257:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_256]]
...
// CHECK-NEXT:        %[[VAL_260:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_259]]
...
// CHECK-NEXT:        %[[VAL_263:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_262]]
...
// CHECK-NEXT:        %[[VAL_266:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_265]]
// CHECK-NEXT:        array.write %[[VAL_254]]{{\[}}%[[VAL_266]]] = %[[VAL_264]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:        %[[VAL_267:[0-9a-zA-Z_\.]+]] = undef.undef : !array.type<16,2 x !felt.type>
// CHECK-NEXT:        %[[VAL_268:[0-9a-zA-Z_\.]+]] = undef.undef : !array.type<2 x !felt.type>
// CHECK-NEXT:        %[[VAL_269:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_270:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:        %[[VAL_271:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_270]]
...
// CHECK-NEXT:        %[[VAL_296:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_295]]
...
// CHECK-NEXT:        %[[VAL_298:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_297]]
...
// CHECK-NEXT:        %[[VAL_302:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_301]]
...
// CHECK-NEXT:        %[[VAL_304:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_303]]
...
// CHECK-NEXT:        %[[VAL_306:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_305]]
...
// CHECK-NEXT:        %[[VAL_310:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_311:[0-9a-zA-Z_\.]+]] = %[[VAL_309]], %[[VAL_312:[0-9a-zA-Z_\.]+]] = %[[VAL_253]]) : (!felt.type, !array.type<16,2 x !felt.type>) -> (!felt.type, !array.type<16,2 x !felt.type>) {
// CHECK-NEXT:          %[[VAL_313:[0-9a-zA-Z_\.]+]] = felt.const  16
// CHECK-NEXT:          %[[VAL_314:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_311]], %[[VAL_313]])
// CHECK-NEXT:          scf.condition(%[[VAL_314]]) %[[VAL_311]], %[[VAL_312]] : !felt.type, !array.type<16,2 x !felt.type>
// CHECK-NEXT:        } do {
// CHECK-NEXT:        ^bb0(%[[VAL_315:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_316:[0-9a-zA-Z_\.]+]]: !array.type<16,2 x !felt.type>):
// CHECK-NEXT:          %[[VAL_317:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_315]]
// CHECK-NEXT:          %[[VAL_318:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_319:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_318]]
// CHECK-NEXT:          %[[VAL_320:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_308]]{{\[}}%[[VAL_317]], %[[VAL_319]]] : <16,2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_321:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_252]][@out] : <@Main<[]>>, !array.type<16,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_322:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_315]]
// CHECK-NEXT:          %[[VAL_323:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_324:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_323]]
// CHECK-NEXT:          %[[VAL_325:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_321]]{{\[}}%[[VAL_322]], %[[VAL_324]]] : <16,2 x !felt.type>, !felt.type
// CHECK-NEXT:          constrain.eq %[[VAL_325]], %[[VAL_320]] : !felt.type, !felt.type
// CHECK-NEXT:          %[[VAL_326:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_315]]
// CHECK-NEXT:          %[[VAL_327:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_328:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_327]]
// CHECK-NEXT:          %[[VAL_329:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_308]]{{\[}}%[[VAL_326]], %[[VAL_328]]] : <16,2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_330:[0-9a-zA-Z_\.]+]] = struct.readf %[[VAL_252]][@out] : <@Main<[]>>, !array.type<16,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_331:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_315]]
// CHECK-NEXT:          %[[VAL_332:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_333:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_332]]
// CHECK-NEXT:          %[[VAL_334:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_330]]{{\[}}%[[VAL_331]], %[[VAL_333]]] : <16,2 x !felt.type>, !felt.type
// CHECK-NEXT:          constrain.eq %[[VAL_334]], %[[VAL_329]] : !felt.type, !felt.type
// CHECK-NEXT:          %[[VAL_335:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_336:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_315]], %[[VAL_335]] : !felt.type, !felt.type
// CHECK-NEXT:          scf.yield %[[VAL_336]], %[[VAL_330]] : !felt.type, !array.type<16,2 x !felt.type>
// CHECK-NEXT:        }
