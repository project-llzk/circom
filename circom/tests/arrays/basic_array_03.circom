...
// CHECK-NEXT:        %[[VAL_23:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_22]] : (!array.type<5 x !felt.type<"bn128">>) -> !poly.tvar<@T_return>
...
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = struct.new : <@ArrayReturnTemplate::@ArrayReturnTemplate<[@n]>>
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = poly.read_const @n : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_27:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_26]], %[[VAL_26]], %[[VAL_26]], %[[VAL_26]], %[[VAL_26]] : <5 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_28:[0-9a-zA-Z_\.]+]] = felt.const  13 : <"bn128">
// CHECK-NEXT:          %[[VAL_29:[0-9a-zA-Z_\.]+]] = function.call @return_array_B::@return_array_B(%[[VAL_25]], %[[VAL_28]]) : (!felt.type<"bn128">, !felt.type<"bn128">) -> !array.type<5 x !felt.type<"bn128">>
// CHECK-NEXT:          function.return %[[VAL_24]] : !struct.type<@ArrayReturnTemplate::@ArrayReturnTemplate<[@n]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_30:[0-9a-zA-Z_\.]+]]: !struct.type<@ArrayReturnTemplate::@ArrayReturnTemplate<[@n]>>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = poly.read_const @n : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = felt.const  0 : <"bn128">
// CHECK-NEXT:          %[[VAL_33:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_32]], %[[VAL_32]], %[[VAL_32]], %[[VAL_32]], %[[VAL_32]] : <5 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_34:[0-9a-zA-Z_\.]+]] = felt.const  13 : <"bn128">
// CHECK-NEXT:          %[[VAL_35:[0-9a-zA-Z_\.]+]] = function.call @return_array_B::@return_array_B(%[[VAL_31]], %[[VAL_34]]) : (!felt.type<"bn128">, !felt.type<"bn128">) -> !array.type<5 x !felt.type<"bn128">>
