...
// CHECK-NEXT:          %[[VAL_91:[0-9a-zA-Z_\.]+]] = function.call @arr_0() : () -> !array.type<1,1,1 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_129:[0-9a-zA-Z_\.]+]] = function.call @arr_0() : () -> !array.type<1,1,1 x !felt.type<"bn128">>
