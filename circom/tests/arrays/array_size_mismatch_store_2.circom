...
// CHECK-NEXT:        %[[VAL_73:[0-9a-zA-Z_\.]+]] = struct.new : <@ArrayShenanigans_0<[]>>
...
// CHECK-NEXT:        %[[VAL_81:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_80]]
...
// CHECK-NEXT:        %[[VAL_86:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_85]]
...
// CHECK-NEXT:          }
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_73]][@outp] = %[[VAL_74]] : <@ArrayShenanigans_0<[]>>, !array.type<2,2,2 x !felt.type>
// CHECK-NEXT:        function.return %[[VAL_73]] : !struct.type<@ArrayShenanigans_0<[]>>
// CHECK-NEXT:      }
// CHECK-NEXT:      function.def @constrain(%[[VAL_110:[0-9a-zA-Z_\.]+]]: !struct.type<@ArrayShenanigans_0<[]>>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:        %[[VAL_111:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_110]][@outp] : <@ArrayShenanigans_0<[]>>, !array.type<2,2,2 x !felt.type>
...
// CHECK-NEXT:        %[[VAL_116:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_115]]
...
// CHECK-NEXT:        %[[VAL_119:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_118]]
