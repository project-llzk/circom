...
// CHECK-NEXT:      %[[VAL_10:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_9]] : !felt.type
...
// CHECK-NEXT:      %[[VAL_31:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_30]] : !felt.type
...
// CHECK-NEXT:      %[[VAL_34:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_33]] : !felt.type
...
// CHECK-NEXT:      %[[VAL_49:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_48]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_72:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_0]]{{\[}}%[[VAL_69]], %[[VAL_70]], %[[VAL_71]]] : <1,2,3 x !felt.type>, !felt.type
// CHECK-NEXT:            array.write %[[VAL_45]]{{\[}}%[[VAL_69]], %[[VAL_70]], %[[VAL_71]]] = %[[VAL_72]] : <1,1,1 x !felt.type>, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:        }
// CHECK-NEXT:      }
...
// CHECK-NEXT:          %[[VAL_74:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2,2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_75:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
...
// CHECK-NEXT:          array.write %[[VAL_75]]{{\[}}%[[VAL_78]]] = %[[VAL_76]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_79:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_80:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_81:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_80]] : !felt.type
// CHECK-NEXT:          array.write %[[VAL_75]]{{\[}}%[[VAL_81]]] = %[[VAL_79]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_82:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_83:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_84:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_83]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_82]]{{\[}}%[[VAL_84]]] = %[[VAL_75]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_85:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_86:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_85]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_82]]{{\[}}%[[VAL_86]]] = %[[VAL_75]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_87:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_88:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_87]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_74]]{{\[}}%[[VAL_88]]] = %[[VAL_82]] : <2,2,2 x !felt.type>, <2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_89:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_90:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_89]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_74]]{{\[}}%[[VAL_90]]] = %[[VAL_82]] : <2,2,2 x !felt.type>, <2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_91:[0-9a-zA-Z_\.]+]] = function.call @arr_0() : () -> !array.type<1,1,1 x !felt.type>
...
// CHECK-NEXT:                %[[VAL_109:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_91]]{{\[}}%[[VAL_106]], %[[VAL_107]], %[[VAL_108]]] : <1,1,1 x !felt.type>, !felt.type
// CHECK-NEXT:                array.write %[[VAL_74]]{{\[}}%[[VAL_106]], %[[VAL_107]], %[[VAL_108]]] = %[[VAL_109]] : <2,2,2 x !felt.type>, !felt.type
// CHECK-NEXT:              }
// CHECK-NEXT:            }
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_73]][@outp] = %[[VAL_74]] : <@ArrayShenanigans_0::@ArrayShenanigans_0<[]>>, !array.type<2,2,2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_111:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_110]][@outp] : <@ArrayShenanigans_0::@ArrayShenanigans_0<[]>>, !array.type<2,2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_112:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2,2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_113:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
// CHECK-NEXT:          %[[VAL_114:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_115:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_116:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_115]] : !felt.type
// CHECK-NEXT:          array.write %[[VAL_113]]{{\[}}%[[VAL_116]]] = %[[VAL_114]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_117:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_118:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_119:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_118]] : !felt.type
// CHECK-NEXT:          array.write %[[VAL_113]]{{\[}}%[[VAL_119]]] = %[[VAL_117]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_120:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_121:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_122:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_121]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_120]]{{\[}}%[[VAL_122]]] = %[[VAL_113]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_123:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_124:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_123]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_120]]{{\[}}%[[VAL_124]]] = %[[VAL_113]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_125:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_126:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_125]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_112]]{{\[}}%[[VAL_126]]] = %[[VAL_120]] : <2,2,2 x !felt.type>, <2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_127:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_128:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_127]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_112]]{{\[}}%[[VAL_128]]] = %[[VAL_120]] : <2,2,2 x !felt.type>, <2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_129:[0-9a-zA-Z_\.]+]] = function.call @arr_0() : () -> !array.type<1,1,1 x !felt.type>
...
// CHECK-NEXT:                %[[VAL_147:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_129]]{{\[}}%[[VAL_144]], %[[VAL_145]], %[[VAL_146]]] : <1,1,1 x !felt.type>, !felt.type
// CHECK-NEXT:                array.write %[[VAL_112]]{{\[}}%[[VAL_144]], %[[VAL_145]], %[[VAL_146]]] = %[[VAL_147]] : <2,2,2 x !felt.type>, !felt.type
// CHECK-NEXT:              }
// CHECK-NEXT:            }
// CHECK-NEXT:          }
// CHECK-NEXT:          constrain.eq %[[VAL_111]], %[[VAL_112]] : !array.type<2,2,2 x !felt.type>, !array.type<2,2,2 x !felt.type>
