...
// CHECK-NEXT:        struct.member @out : !array.type<5,1 x !felt.type> {llzk.pub}
...
// CHECK-NEXT:          %[[VAL_1:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<5,1 x !felt.type>
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_1]] : <@Array1::@Array1<[]>>, !array.type<5,1 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_13]][@out] : <@Array1::@Array1<[]>>, !array.type<5,1 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_19:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_17]], %[[VAL_18]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_19]]) %[[VAL_17]] : !felt.type
// CHECK-NEXT:          } do {
...
// CHECK-NEXT:            %[[VAL_24:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_14]]{{\[}}%[[VAL_21]], %[[VAL_23]]] : <5,1 x !felt.type>, !felt.type
// CHECK-NEXT:            constrain.eq %[[VAL_24]], %[[VAL_20]] : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_25:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_26:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_20]], %[[VAL_25]] : !felt.type, !felt.type
