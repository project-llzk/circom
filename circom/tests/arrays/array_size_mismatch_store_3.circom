...
// CHECK-NEXT:        %[[VAL_17:[0-9a-zA-Z_\.]+]] = arith.constant 10 : index
// CHECK-NEXT:        scf.for %[[VAL_18:[0-9a-zA-Z_\.]+]] = %[[VAL_15]] to %[[VAL_17]] step %[[VAL_16]] {
...
// CHECK-NEXT:        %[[VAL_33:[0-9a-zA-Z_\.]+]] = arith.constant 10 : index
// CHECK-NEXT:        scf.for %[[VAL_34:[0-9a-zA-Z_\.]+]] = %[[VAL_31]] to %[[VAL_33]] step %[[VAL_32]] {
...
// CHECK-NEXT:        %[[VAL_97:[0-9a-zA-Z_\.]+]] = arith.constant 10 : index
// CHECK-NEXT:        scf.for %[[VAL_98:[0-9a-zA-Z_\.]+]] = %[[VAL_95]] to %[[VAL_97]] step %[[VAL_96]] {
...
// CHECK-NEXT:        %[[VAL_113:[0-9a-zA-Z_\.]+]] = arith.constant 10 : index
// CHECK-NEXT:        scf.for %[[VAL_114:[0-9a-zA-Z_\.]+]] = %[[VAL_111]] to %[[VAL_113]] step %[[VAL_112]] {
