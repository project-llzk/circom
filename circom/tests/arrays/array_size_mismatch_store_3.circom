...
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_37]], %[[VAL_38]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_42]], %[[VAL_43]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_69:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_67]], %[[VAL_68]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_73:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_70]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_1]] : <@SmallToLarge::@SmallToLarge<[]>>, !array.type<10 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_77:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_76]][@out] : <@SmallToLarge::@SmallToLarge<[]>>, !array.type<10 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_112:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_111]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_115:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_113]], %[[VAL_114]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_120:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_118]], %[[VAL_119]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_125:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_123]], %[[VAL_124]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_130:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_128]], %[[VAL_129]]) : !felt.type, !felt.type
// CHECK-NEXT:          bool.assert %[[VAL_130]], "assertion failed"
// CHECK-NEXT:          %[[VAL_131:[0-9a-zA-Z_\.]+]] = felt.const  8
// CHECK-NEXT:          %[[VAL_132:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_131]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_135:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_133]], %[[VAL_134]]) : !felt.type, !felt.type
// CHECK-NEXT:          bool.assert %[[VAL_135]], "assertion failed"
// CHECK-NEXT:          %[[VAL_136:[0-9a-zA-Z_\.]+]] = felt.const  9
// CHECK-NEXT:          %[[VAL_137:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_136]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_140:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_138]], %[[VAL_139]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_145:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_143]], %[[VAL_144]]) : !felt.type, !felt.type
