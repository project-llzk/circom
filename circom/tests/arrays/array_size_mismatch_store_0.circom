...
// CHECK-NEXT:        scf.for %[[VAL_15:[0-9a-zA-Z_\.]+]] = %[[VAL_12]] to %[[VAL_14]] step %[[VAL_13]] {
...
// CHECK-NEXT:        %[[VAL_54:[0-9a-zA-Z_\.]+]] = arith.constant 10 : index
// CHECK-NEXT:        scf.for %[[VAL_55:[0-9a-zA-Z_\.]+]] = %[[VAL_52]] to %[[VAL_54]] step %[[VAL_53]] {
