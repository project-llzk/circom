...
// CHECK-NEXT:            %[[VAL_17:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_9]]{{\[}}%[[VAL_16]]] : <5 x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_38:[0-9a-zA-Z_\.]+]]: !struct.type<@ImplicitExtension::@ImplicitExtension<[]>>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_38]][@out] : <@ImplicitExtension::@ImplicitExtension<[]>>, !array.type<10 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_40:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_41:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_40]], %[[VAL_40]], %[[VAL_40]], %[[VAL_40]], %[[VAL_40]], %[[VAL_40]], %[[VAL_40]], %[[VAL_40]], %[[VAL_40]], %[[VAL_40]] : <10 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_47:[0-9a-zA-Z_\.]+]] = array.new %[[VAL_42]], %[[VAL_43]], %[[VAL_44]], %[[VAL_45]], %[[VAL_46]] : <5 x !felt.type<"bn128">>
...
// CHECK-NEXT:            %[[VAL_55:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_47]]{{\[}}%[[VAL_54]]] : <5 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:            array.write %[[VAL_41]]{{\[}}%[[VAL_54]]] = %[[VAL_55]] : <10 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:          }
