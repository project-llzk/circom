...
// CHECK-NEXT:        %[[VAL_16:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_1 : !array.type<1,1 x !felt.type<"bn128">>
// CHECK-NEXT:        %[[VAL_19:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_0 : !array.type<2 x !felt.type<"bn128">>
// CHECK-NEXT:        %[[VAL_22:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_2 : !array.type<2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_50:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_1 : !array.type<1,1 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_56:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_1 : !array.type<1,1 x !felt.type<"bn128">>
