...
// CHECK-NEXT:          %[[VAL_1:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<5,2 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_6:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_4]], %[[VAL_5]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_1]] : <@Array1::@Array1<[]>>, !array.type<5,2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_24]][@out] : <@Array1::@Array1<[]>>, !array.type<5,2 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_30:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_28]], %[[VAL_29]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_30]]) %[[VAL_28]] : !felt.type
// CHECK-NEXT:          } do {
...
// CHECK-NEXT:            %[[VAL_35:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_25]]{{\[}}%[[VAL_32]], %[[VAL_34]]] : <5,2 x !felt.type>, !felt.type
// CHECK-NEXT:            constrain.eq %[[VAL_35]], %[[VAL_31]] : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_36:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_37:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_31]], %[[VAL_36]] : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_42:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_40]], %[[VAL_41]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_47:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_25]]{{\[}}%[[VAL_44]], %[[VAL_46]]] : <5,2 x !felt.type>, !felt.type
// CHECK-NEXT:            constrain.eq %[[VAL_47]], %[[VAL_43]] : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_48:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            %[[VAL_49:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_43]], %[[VAL_48]] : !felt.type, !felt.type
