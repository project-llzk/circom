...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_0]][@out] = %[[VAL_1]] : <@Array1<[]>>, !array.type<5,2 x !felt.type>
...
// CHECK-NEXT:        %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_24]][@out] : <@Array1<[]>>, !array.type<5,2 x !felt.type>
