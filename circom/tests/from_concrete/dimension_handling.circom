...
// CHECK-NEXT:        %[[VAL_18:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_1 : !array.type<1,1 x !felt.type<"bn128">>
// CHECK-NEXT:        %[[VAL_25:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_2 : !array.type<2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_58:[0-9a-zA-Z_\.]+]] = function.call @myAdd_1::@myAdd_1(%[[VAL_48]], %[[VAL_51]], %[[VAL_54]], %[[VAL_57]]) : (!felt.type<"bn128">, !felt.type<"bn128">, !felt.type<"bn128">, !felt.type<"bn128">) -> !array.type<2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_5:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_1 : !array.type<1,1 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_69:[0-9a-zA-Z_\.]+]] = function.call @myFun_0::@myFun_0() : () -> !array.type<1,1 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_6:[0-9a-zA-Z_\.]+]] = global.read const @global::@array_const_1 : !array.type<1,1 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_78:[0-9a-zA-Z_\.]+]] = function.call @myFun_0::@myFun_0() : () -> !array.type<1,1 x !felt.type<"bn128">>
