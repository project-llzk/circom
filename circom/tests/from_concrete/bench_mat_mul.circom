...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !array.type<1,3 x !felt.type>, %[[VAL_1:[0-9a-zA-Z_\.]+]]: !array.type<1,3 x !felt.type>) -> !struct.type<@matElemMul_0::@matElemMul_0<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_10:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_8]], %[[VAL_9]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_16:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_14]], %[[VAL_15]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_24:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_17]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_2]][@out] = %[[VAL_3]] : <@matElemMul_0::@matElemMul_0<[]>>, !array.type<1,3 x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_2]] : !struct.type<@matElemMul_0::@matElemMul_0<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_33:[0-9a-zA-Z_\.]+]]: !struct.type<@matElemMul_0::@matElemMul_0<[]>>, %[[VAL_34:[0-9a-zA-Z_\.]+]]: !array.type<1,3 x !felt.type>, %[[VAL_35:[0-9a-zA-Z_\.]+]]: !array.type<1,3 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_36:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_33]][@out] : <@matElemMul_0::@matElemMul_0<[]>>, !array.type<1,3 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_43:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_41]], %[[VAL_42]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_49:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_47]], %[[VAL_48]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_53:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_50]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_57:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_50]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_61:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_60]] : !felt.type
// CHECK-NEXT:              %[[VAL_62:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_50]] : !felt.type
...
// CHECK-NEXT:        function.def @compute(%[[VAL_67:[0-9a-zA-Z_\.]+]]: !array.type<1,3 x !felt.type>) -> !struct.type<@matElemSum_1::@matElemSum_1<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          %[[VAL_73:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_72]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_85:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_82]], %[[VAL_84]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_93:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_91]], %[[VAL_92]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_97:[0-9a-zA-Z_\.]+]] = bool.cmp gt(%[[VAL_94]], %[[VAL_96]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_100:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_99]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_103:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_102]] : !felt.type
// CHECK-NEXT:                %[[VAL_104:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_95]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_107:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_94]] : !felt.type
...
// CHECK-NEXT:          struct.writem %[[VAL_68]][@out] = %[[VAL_115]] : <@matElemSum_1::@matElemSum_1<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_68]][@sum] = %[[VAL_69]] : <@matElemSum_1::@matElemSum_1<[]>>, !array.type<3 x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_68]] : !struct.type<@matElemSum_1::@matElemSum_1<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_116:[0-9a-zA-Z_\.]+]]: !struct.type<@matElemSum_1::@matElemSum_1<[]>>, %[[VAL_117:[0-9a-zA-Z_\.]+]]: !array.type<1,3 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_118:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_116]][@out] : <@matElemSum_1::@matElemSum_1<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_119:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_116]][@sum] : <@matElemSum_1::@matElemSum_1<[]>>, !array.type<3 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_123:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_122]] : !felt.type
// CHECK-NEXT:          %[[VAL_124:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_125:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_124]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_128:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_127]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_136:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_133]], %[[VAL_135]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_144:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_142]], %[[VAL_143]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_148:[0-9a-zA-Z_\.]+]] = bool.cmp gt(%[[VAL_145]], %[[VAL_147]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_151:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_150]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_154:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_153]] : !felt.type
// CHECK-NEXT:                %[[VAL_155:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_146]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_158:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_145]] : !felt.type
...
// CHECK-NEXT:        function.def @compute(%[[VAL_168:[0-9a-zA-Z_\.]+]]: !array.type<2,3 x !felt.type>, %[[VAL_169:[0-9a-zA-Z_\.]+]]: !array.type<3,2 x !felt.type>) -> !struct.type<@matMul_2::@matMul_2<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_201:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_197]], %[[VAL_200]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_211:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_207]], %[[VAL_210]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_220:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_217]], %[[VAL_219]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_223:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_224:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_221]] : !felt.type
// CHECK-NEXT:                %[[VAL_225:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_168]]{{\[}}%[[VAL_223]], %[[VAL_224]]] : <2,3 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_226:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_227:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_231:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_230]] : !felt.type
// CHECK-NEXT:                %[[VAL_232:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_221]] : !felt.type
// CHECK-NEXT:                array.write %[[VAL_229]]{{\[}}%[[VAL_231]], %[[VAL_232]]] = %[[VAL_225]] : <1,3 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_233:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_234:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_236:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_237:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_238:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_239:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                  %[[VAL_248:[0-9a-zA-Z_\.]+]] = function.call @matElemMul_0::@matElemMul_0::@compute(%[[VAL_246]], %[[VAL_247]]) : (!array.type<1,3 x !felt.type>, !array.type<1,3 x !felt.type>) -> !struct.type<@matElemMul_0::@matElemMul_0<[]>>
...
// CHECK-NEXT:                  %[[VAL_249:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                  %[[VAL_250:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                } else {
// CHECK-NEXT:                }
// CHECK-NEXT:                %[[VAL_251:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_221]] : !felt.type
// CHECK-NEXT:                %[[VAL_252:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
// CHECK-NEXT:                %[[VAL_253:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_169]]{{\[}}%[[VAL_251]], %[[VAL_252]]] : <3,2 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_254:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_255:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_259:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_258]] : !felt.type
// CHECK-NEXT:                %[[VAL_260:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_221]] : !felt.type
// CHECK-NEXT:                array.write %[[VAL_257]]{{\[}}%[[VAL_259]], %[[VAL_260]]] = %[[VAL_253]] : <1,3 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_261:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_262:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_264:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_265:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_266:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_267:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                  %[[VAL_276:[0-9a-zA-Z_\.]+]] = function.call @matElemMul_0::@matElemMul_0::@compute(%[[VAL_274]], %[[VAL_275]]) : (!array.type<1,3 x !felt.type>, !array.type<1,3 x !felt.type>) -> !struct.type<@matElemMul_0::@matElemMul_0<[]>>
...
// CHECK-NEXT:                  %[[VAL_277:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                  %[[VAL_278:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_286:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_283]], %[[VAL_285]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_289:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_290:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_293:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_292]][@out] : <@matElemMul_0::@matElemMul_0<[]>>, !array.type<1,3 x !felt.type>
// CHECK-NEXT:                %[[VAL_294:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:                %[[VAL_295:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_294]] : !felt.type
// CHECK-NEXT:                %[[VAL_296:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_287]] : !felt.type
// CHECK-NEXT:                %[[VAL_297:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_293]]{{\[}}%[[VAL_295]], %[[VAL_296]]] : <1,3 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_298:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_299:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_303:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_302]] : !felt.type
// CHECK-NEXT:                %[[VAL_304:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_287]] : !felt.type
// CHECK-NEXT:                array.write %[[VAL_301]]{{\[}}%[[VAL_303]], %[[VAL_304]]] = %[[VAL_297]] : <1,3 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_305:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_306:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_308:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_309:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_310:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                %[[VAL_311:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:                  %[[VAL_319:[0-9a-zA-Z_\.]+]] = function.call @matElemSum_1::@matElemSum_1::@compute(%[[VAL_318]]) : (!array.type<1,3 x !felt.type>) -> !struct.type<@matElemSum_1::@matElemSum_1<[]>>
...
// CHECK-NEXT:                  %[[VAL_320:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:                  %[[VAL_321:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:              }
// CHECK-NEXT:              %[[VAL_324:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:              %[[VAL_325:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_328:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_327]][@out] : <@matElemSum_1::@matElemSum_1<[]>>, !felt.type
// CHECK-NEXT:              %[[VAL_329:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_202]] : !felt.type
// CHECK-NEXT:              %[[VAL_330:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_212]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_170]][@matElemMulComp$inputs] = %[[VAL_196]]#1 : <@matMul_2::@matMul_2<[]>>, !array.type<2,2 x !pod.type<[@a: !array.type<1,3 x !felt.type>, @b: !array.type<1,3 x !felt.type>]>>
...
// CHECK-NEXT:          struct.writem %[[VAL_170]][@matElemSumComp$inputs] = %[[VAL_196]]#2 : <@matMul_2::@matMul_2<[]>>, !array.type<2,2 x !pod.type<[@a: !array.type<1,3 x !felt.type>]>>
...
// CHECK-NEXT:          struct.writem %[[VAL_170]][@out] = %[[VAL_171]] : <@matMul_2::@matMul_2<[]>>, !array.type<2,2 x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_170]] : !struct.type<@matMul_2::@matMul_2<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_353:[0-9a-zA-Z_\.]+]]: !struct.type<@matMul_2::@matMul_2<[]>>, %[[VAL_354:[0-9a-zA-Z_\.]+]]: !array.type<2,3 x !felt.type>, %[[VAL_355:[0-9a-zA-Z_\.]+]]: !array.type<3,2 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_356:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_353]][@out] : <@matMul_2::@matMul_2<[]>>, !array.type<2,2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_358:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_353]][@matElemMulComp$inputs] : <@matMul_2::@matMul_2<[]>>, !array.type<2,2 x !pod.type<[@a: !array.type<1,3 x !felt.type>, @b: !array.type<1,3 x !felt.type>]>>
...
// CHECK-NEXT:          %[[VAL_360:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_353]][@matElemSumComp$inputs] : <@matMul_2::@matMul_2<[]>>, !array.type<2,2 x !pod.type<[@a: !array.type<1,3 x !felt.type>]>>
...
// CHECK-NEXT:            %[[VAL_368:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_366]], %[[VAL_367]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_374:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_372]], %[[VAL_373]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_380:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_378]], %[[VAL_379]]) : !felt.type, !felt.type
// CHECK-NEXT:                scf.condition(%[[VAL_380]]) %[[VAL_378]] : !felt.type
// CHECK-NEXT:              } do {
// CHECK-NEXT:              ^bb0(%[[VAL_381:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:                %[[VAL_382:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_369]] : !felt.type
// CHECK-NEXT:                %[[VAL_383:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_381]] : !felt.type
// CHECK-NEXT:                %[[VAL_384:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_354]]{{\[}}%[[VAL_382]], %[[VAL_383]]] : <2,3 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_385:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_369]] : !felt.type
// CHECK-NEXT:                %[[VAL_386:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_375]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_390:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_389]] : !felt.type
// CHECK-NEXT:                %[[VAL_391:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_381]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_393:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_381]] : !felt.type
// CHECK-NEXT:                %[[VAL_394:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_375]] : !felt.type
// CHECK-NEXT:                %[[VAL_395:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_355]]{{\[}}%[[VAL_393]], %[[VAL_394]]] : <3,2 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_396:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_369]] : !felt.type
// CHECK-NEXT:                %[[VAL_397:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_375]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_401:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_400]] : !felt.type
// CHECK-NEXT:                %[[VAL_402:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_381]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_410:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_408]], %[[VAL_409]]) : !felt.type, !felt.type
// CHECK-NEXT:                scf.condition(%[[VAL_410]]) %[[VAL_408]] : !felt.type
// CHECK-NEXT:              } do {
// CHECK-NEXT:              ^bb0(%[[VAL_411:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:                %[[VAL_412:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_369]] : !felt.type
// CHECK-NEXT:                %[[VAL_413:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_375]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_415:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_414]][@out] : <@matElemMul_0::@matElemMul_0<[]>>, !array.type<1,3 x !felt.type>
// CHECK-NEXT:                %[[VAL_416:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:                %[[VAL_417:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_416]] : !felt.type
// CHECK-NEXT:                %[[VAL_418:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_411]] : !felt.type
// CHECK-NEXT:                %[[VAL_419:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_415]]{{\[}}%[[VAL_417]], %[[VAL_418]]] : <1,3 x !felt.type>, !felt.type
// CHECK-NEXT:                %[[VAL_420:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_369]] : !felt.type
// CHECK-NEXT:                %[[VAL_421:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_375]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_425:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_424]] : !felt.type
// CHECK-NEXT:                %[[VAL_426:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_411]] : !felt.type
...
// CHECK-NEXT:              }
// CHECK-NEXT:              %[[VAL_430:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_369]] : !felt.type
// CHECK-NEXT:              %[[VAL_431:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_375]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_433:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_432]][@out] : <@matElemSum_1::@matElemSum_1<[]>>, !felt.type
// CHECK-NEXT:              %[[VAL_434:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_369]] : !felt.type
// CHECK-NEXT:              %[[VAL_435:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_375]] : !felt.type
...
// CHECK-NEXT:              function.call @matElemMul_0::@matElemMul_0::@constrain(%[[VAL_447]], %[[VAL_449]], %[[VAL_450]]) : (!struct.type<@matElemMul_0::@matElemMul_0<[]>>, !array.type<1,3 x !felt.type>, !array.type<1,3 x !felt.type>) -> ()
// CHECK-NEXT:            }
// CHECK-NEXT:          }
...
// CHECK-NEXT:              function.call @matElemSum_1::@matElemSum_1::@constrain(%[[VAL_457]], %[[VAL_459]]) : (!struct.type<@matElemSum_1::@matElemSum_1<[]>>, !array.type<1,3 x !felt.type>) -> ()
// CHECK-NEXT:            }
// CHECK-NEXT:          }
// CHECK-NEXT:          function.return
// CHECK-NEXT:        }
