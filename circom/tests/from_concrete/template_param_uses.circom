...
// CHECK-NEXT:    function.def @f_0(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !array.type<2,2 x !felt.type<"bn128">>) -> !array.type<2,2 x !felt.type<"bn128">> attributes {function.allow_non_native_field_ops} {
...
// CHECK-NEXT:          %[[VAL_46:[0-9a-zA-Z_\.]+]] = function.call @f_0(%[[VAL_9]]) : (!array.type<2,2 x !felt.type<"bn128">>) -> !array.type<2,2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_92:[0-9a-zA-Z_\.]+]] = function.call @f_0(%[[VAL_55]]) : (!array.type<2,2 x !felt.type<"bn128">>) -> !array.type<2,2 x !felt.type<"bn128">>
