...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@ret] = %[[VAL_7]] : <@Template_0::@Template_0<[]>>, !array.type<2,2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_10]][@ret] : <@Template_0::@Template_0<[]>>, !array.type<2,2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = array.new  : <2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = arith.constant 0 : index
// CHECK-NEXT:          array.insert %[[VAL_18]]{{\[}}%[[VAL_19]]] = %[[VAL_14]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          array.insert %[[VAL_18]]{{\[}}%[[VAL_20]]] = %[[VAL_17]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          constrain.eq %[[VAL_11]], %[[VAL_18]] : !array.type<2,2 x !felt.type>, !array.type<2,2 x !felt.type>
