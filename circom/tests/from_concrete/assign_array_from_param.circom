...
// CHECK-NEXT:          %[[VAL_1:[0-9a-zA-Z_\.]+]] = global.read const @global::@vcp_array_const_0 : !array.type<2,2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_4:[0-9a-zA-Z_\.]+]] = global.read const @global::@vcp_array_const_0 : !array.type<2,2 x !felt.type<"bn128">>
