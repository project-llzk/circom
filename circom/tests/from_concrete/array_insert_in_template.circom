...
// CHECK-NEXT:      array.write %[[VAL_1]]{{\[}}%[[VAL_4]]] = %[[VAL_2]] : <2 x !felt.type<"bn128">>, !felt.type<"bn128">
...
// CHECK-NEXT:      array.write %[[VAL_1]]{{\[}}%[[VAL_7]]] = %[[VAL_5]] : <2 x !felt.type<"bn128">>, !felt.type<"bn128">
// CHECK-NEXT:      %[[VAL_8:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:      %[[VAL_9:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_8]] : !felt.type<"bn128">
// CHECK-NEXT:      array.insert %[[VAL_0]]{{\[}}%[[VAL_9]]] = %[[VAL_1]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:      %[[VAL_10:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:      %[[VAL_11:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_10]] : !felt.type<"bn128">
// CHECK-NEXT:      array.insert %[[VAL_0]]{{\[}}%[[VAL_11]]] = %[[VAL_1]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:      %[[VAL_12:[0-9a-zA-Z_\.]+]] = felt.const  2
// CHECK-NEXT:      %[[VAL_13:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_12]] : !felt.type<"bn128">
// CHECK-NEXT:      array.insert %[[VAL_0]]{{\[}}%[[VAL_13]]] = %[[VAL_1]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_15:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<3,2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          array.insert %[[VAL_15]]{{\[}}%[[VAL_24]]] = %[[VAL_16]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_25]] : !felt.type<"bn128">
// CHECK-NEXT:          array.insert %[[VAL_15]]{{\[}}%[[VAL_26]]] = %[[VAL_16]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_27:[0-9a-zA-Z_\.]+]] = felt.const  2
// CHECK-NEXT:          %[[VAL_28:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_27]] : !felt.type<"bn128">
// CHECK-NEXT:          array.insert %[[VAL_15]]{{\[}}%[[VAL_28]]] = %[[VAL_16]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_29:[0-9a-zA-Z_\.]+]] = function.call @default_init_0() : () -> !array.type<3,2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<3,2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          array.insert %[[VAL_31]]{{\[}}%[[VAL_40]]] = %[[VAL_32]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_41:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_42:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_41]] : !felt.type<"bn128">
// CHECK-NEXT:          array.insert %[[VAL_31]]{{\[}}%[[VAL_42]]] = %[[VAL_32]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_43:[0-9a-zA-Z_\.]+]] = felt.const  2
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_43]] : !felt.type<"bn128">
// CHECK-NEXT:          array.insert %[[VAL_31]]{{\[}}%[[VAL_44]]] = %[[VAL_32]] : <3,2 x !felt.type<"bn128">>, <2 x !felt.type<"bn128">>
// CHECK-NEXT:          %[[VAL_45:[0-9a-zA-Z_\.]+]] = function.call @default_init_0() : () -> !array.type<3,2 x !felt.type<"bn128">>
