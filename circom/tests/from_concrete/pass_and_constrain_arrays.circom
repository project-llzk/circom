...
// CHECK-NEXT:        %[[VAL_119:[0-9a-zA-Z_\.]+]] = function.call @add_1(%[[VAL_109]], %[[VAL_112]], %[[VAL_115]], %[[VAL_118]]) : (!felt.type<"bn128">, !felt.type<"bn128">, !felt.type<"bn128">, !felt.type<"bn128">) -> !array.type<2 x !felt.type<"bn128">>
...
// CHECK-NEXT:        %[[VAL_158:[0-9a-zA-Z_\.]+]] = function.call @add_1(%[[VAL_145]], %[[VAL_151]], %[[VAL_154]], %[[VAL_157]]) : (!felt.type<"bn128">, !felt.type<"bn128">, !felt.type<"bn128">, !felt.type<"bn128">) -> !array.type<2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_229:[0-9a-zA-Z_\.]+]] = function.call @mul_0(%[[VAL_175]], %[[VAL_228]]) : (!array.type<2 x !felt.type<"bn128">>, !felt.type<"bn128">) -> !array.type<16,2 x !felt.type<"bn128">>
...
// CHECK-NEXT:          %[[VAL_308:[0-9a-zA-Z_\.]+]] = function.call @mul_0(%[[VAL_254]], %[[VAL_307]]) : (!array.type<2 x !felt.type<"bn128">>, !felt.type<"bn128">) -> !array.type<16,2 x !felt.type<"bn128">>
