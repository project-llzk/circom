...
// CHECK-NEXT:          %[[VAL_4:[0-9a-zA-Z_\.]+]] = pod.new : <[@inp: !array.type<5 x !felt.type<"bn128">>]>
// CHECK-NEXT:          %[[VAL_5:[0-9a-zA-Z_\.]+]] = felt.const  5
// CHECK-NEXT:          pod.write %[[VAL_4]][@inp] = %[[VAL_0]] : <[@inp: !array.type<5 x !felt.type<"bn128">>]>, !array.type<5 x !felt.type<"bn128">>
...
// CHECK-NEXT:            %[[VAL_11:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_4]][@inp] : <[@inp: !array.type<5 x !felt.type<"bn128">>]>, !array.type<5 x !felt.type<"bn128">>
...
// CHECK-NEXT:          struct.writem %[[VAL_1]][@op$inputs] = %[[VAL_4]] : <@Caller_1::@Caller_1<[]>>, !pod.type<[@inp: !array.type<5 x !felt.type<"bn128">>]>
