...
// CHECK-NEXT:          %[[VAL_2:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_29]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_1]]{{\[}}%[[VAL_30]]] = %[[VAL_20]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          struct.writem %[[VAL_0]][@ret] = %[[VAL_1]] : <@Template_0::@Template_0<[]>>, !array.type<2,2 x !felt.type>
...
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_31]][@ret] : <@Template_0::@Template_0<[]>>, !array.type<2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_33:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2,2 x !felt.type>
// CHECK-NEXT:          %[[VAL_34:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
...
// CHECK-NEXT:          array.write %[[VAL_34]]{{\[}}%[[VAL_37]]] = %[[VAL_35]] : <2 x !felt.type>, !felt.type
...
// CHECK-NEXT:          array.write %[[VAL_34]]{{\[}}%[[VAL_40]]] = %[[VAL_38]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_41:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_42:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_41]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_33]]{{\[}}%[[VAL_42]]] = %[[VAL_34]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_43:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_43]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_33]]{{\[}}%[[VAL_44]]] = %[[VAL_34]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_45:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
...
// CHECK-NEXT:          array.write %[[VAL_45]]{{\[}}%[[VAL_48]]] = %[[VAL_46]] : <2 x !felt.type>, !felt.type
...
// CHECK-NEXT:          array.write %[[VAL_45]]{{\[}}%[[VAL_51]]] = %[[VAL_49]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_52:[0-9a-zA-Z_\.]+]] = llzk.nondet : !array.type<2 x !felt.type>
...
// CHECK-NEXT:          array.write %[[VAL_52]]{{\[}}%[[VAL_55]]] = %[[VAL_53]] : <2 x !felt.type>, !felt.type
...
// CHECK-NEXT:          array.write %[[VAL_52]]{{\[}}%[[VAL_58]]] = %[[VAL_56]] : <2 x !felt.type>, !felt.type
// CHECK-NEXT:          %[[VAL_59:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_60:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_59]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_33]]{{\[}}%[[VAL_60]]] = %[[VAL_45]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          %[[VAL_61:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:          %[[VAL_62:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_61]] : !felt.type
// CHECK-NEXT:          array.insert %[[VAL_33]]{{\[}}%[[VAL_62]]] = %[[VAL_52]] : <2,2 x !felt.type>, <2 x !felt.type>
// CHECK-NEXT:          constrain.eq %[[VAL_32]], %[[VAL_33]] : !array.type<2,2 x !felt.type>, !array.type<2,2 x !felt.type>
