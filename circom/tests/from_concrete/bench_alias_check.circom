...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !array.type<254 x !felt.type>) -> !struct.type<@AliasCheck_2::@AliasCheck_2<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_16:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_12]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_23:[0-9a-zA-Z_\.]+]] = function.call @CompConstant_1::@CompConstant_1::@compute(%[[VAL_22]]) : (!array.type<254 x !felt.type>) -> !struct.type<@CompConstant_1::@CompConstant_1<[]>>
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_1]][@compConstant$inputs] = %[[VAL_6]]#0 : <@AliasCheck_2::@AliasCheck_2<[]>>, !pod.type<[@in: !array.type<254 x !felt.type>]>
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_27:[0-9a-zA-Z_\.]+]]: !struct.type<@AliasCheck_2::@AliasCheck_2<[]>>, %[[VAL_28:[0-9a-zA-Z_\.]+]]: !array.type<254 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
...
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_27]][@compConstant$inputs] : <@AliasCheck_2::@AliasCheck_2<[]>>, !pod.type<[@in: !array.type<254 x !felt.type>]>
...
// CHECK-NEXT:            %[[VAL_35:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_33]], %[[VAL_34]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_35]]) %[[VAL_33]] : !felt.type
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_36:[0-9a-zA-Z_\.]+]]: !felt.type):
// CHECK-NEXT:            %[[VAL_37:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_36]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_40:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_36]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_29]][@out] : <@CompConstant_1::@CompConstant_1<[]>>, !felt.type
...
// CHECK-NEXT:          function.call @CompConstant_1::@CompConstant_1::@constrain(%[[VAL_29]], %[[VAL_46]]) : (!struct.type<@CompConstant_1::@CompConstant_1<[]>>, !array.type<254 x !felt.type>) -> ()
...
// CHECK-NEXT:        function.def @compute(%[[VAL_47:[0-9a-zA-Z_\.]+]]: !array.type<254 x !felt.type>) -> !struct.type<@CompConstant_1::@CompConstant_1<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_75:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_70]], %[[VAL_74]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_101:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_100]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_107:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_106]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_110:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_98]], %[[VAL_109]]) : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_111:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:            %[[VAL_112:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_90]], %[[VAL_111]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_121:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_81]] : !felt.type
// CHECK-NEXT:              array.write %[[VAL_49]]{{\[}}%[[VAL_121]]] = %[[VAL_120]] : <127 x !felt.type>, !felt.type
// CHECK-NEXT:            } else {
// CHECK-NEXT:              %[[VAL_122:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:              %[[VAL_123:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_98]], %[[VAL_122]]) : !felt.type, !felt.type
// CHECK-NEXT:              %[[VAL_124:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:              %[[VAL_125:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_90]], %[[VAL_124]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_136:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_81]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_139:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_90]], %[[VAL_138]]) : !felt.type, !felt.type
// CHECK-NEXT:                %[[VAL_140:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:                %[[VAL_141:[0-9a-zA-Z_\.]+]] = bool.cmp ne(%[[VAL_137]], %[[VAL_140]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                  %[[VAL_148:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_81]] : !felt.type
...
// CHECK-NEXT:                  %[[VAL_153:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_81]] : !felt.type
// CHECK-NEXT:                  array.write %[[VAL_49]]{{\[}}%[[VAL_153]]] = %[[VAL_152]] : <127 x !felt.type>, !felt.type
// CHECK-NEXT:                }
// CHECK-NEXT:              }
// CHECK-NEXT:            }
// CHECK-NEXT:            %[[VAL_154:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_81]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_48]][@sout] = %[[VAL_64]]#8 : <@CompConstant_1::@CompConstant_1<[]>>, !felt.type
...
// CHECK-NEXT:            %[[VAL_169:[0-9a-zA-Z_\.]+]] = function.call @Num2Bits_0::@Num2Bits_0::@compute(%[[VAL_168]]) : (!felt.type) -> !struct.type<@Num2Bits_0::@Num2Bits_0<[]>>
...
// CHECK-NEXT:          %[[VAL_171:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_170]][@out] : <@Num2Bits_0::@Num2Bits_0<[]>>, !array.type<135 x !felt.type>
// CHECK-NEXT:          %[[VAL_172:[0-9a-zA-Z_\.]+]] = felt.const  127
// CHECK-NEXT:          %[[VAL_173:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_172]] : !felt.type
// CHECK-NEXT:          %[[VAL_174:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_171]]{{\[}}%[[VAL_173]]] : <135 x !felt.type>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_48]][@out] = %[[VAL_174]] : <@CompConstant_1::@CompConstant_1<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_48]][@num2bits$inputs] = %[[VAL_52]] : <@CompConstant_1::@CompConstant_1<[]>>, !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:          struct.writem %[[VAL_48]][@parts] = %[[VAL_49]] : <@CompConstant_1::@CompConstant_1<[]>>, !array.type<127 x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_48]] : !struct.type<@CompConstant_1::@CompConstant_1<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_176:[0-9a-zA-Z_\.]+]]: !struct.type<@CompConstant_1::@CompConstant_1<[]>>, %[[VAL_177:[0-9a-zA-Z_\.]+]]: !array.type<254 x !felt.type>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_178:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_176]][@out] : <@CompConstant_1::@CompConstant_1<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_179:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_176]][@parts] : <@CompConstant_1::@CompConstant_1<[]>>, !array.type<127 x !felt.type>
// CHECK-NEXT:          %[[VAL_180:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_176]][@sout] : <@CompConstant_1::@CompConstant_1<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_182:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_176]][@num2bits$inputs] : <@CompConstant_1::@CompConstant_1<[]>>, !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:            %[[VAL_205:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_200]], %[[VAL_204]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_237:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_236]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_240:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_228]], %[[VAL_239]]) : !felt.type, !felt.type
// CHECK-NEXT:            %[[VAL_241:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:            %[[VAL_242:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_220]], %[[VAL_241]]) : !felt.type, !felt.type
...
// CHECK-NEXT:              %[[VAL_251:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_211]] : !felt.type
...
// CHECK-NEXT:              %[[VAL_254:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_228]], %[[VAL_253]]) : !felt.type, !felt.type
// CHECK-NEXT:              %[[VAL_255:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:              %[[VAL_256:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_220]], %[[VAL_255]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                %[[VAL_267:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_211]] : !felt.type
...
// CHECK-NEXT:                %[[VAL_271:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_220]], %[[VAL_270]]) : !felt.type, !felt.type
// CHECK-NEXT:                %[[VAL_272:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:                %[[VAL_273:[0-9a-zA-Z_\.]+]] = bool.cmp ne(%[[VAL_269]], %[[VAL_272]]) : !felt.type, !felt.type
...
// CHECK-NEXT:                  %[[VAL_280:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_211]] : !felt.type
...
// CHECK-NEXT:                  %[[VAL_286:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_211]] : !felt.type
...
// CHECK-NEXT:              }
// CHECK-NEXT:            }
// CHECK-NEXT:            %[[VAL_288:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_211]] : !felt.type
...
// CHECK-NEXT:          %[[VAL_298:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_181]][@out] : <@Num2Bits_0::@Num2Bits_0<[]>>, !array.type<135 x !felt.type>
...
// CHECK-NEXT:          function.call @Num2Bits_0::@Num2Bits_0::@constrain(%[[VAL_181]], %[[VAL_302]]) : (!struct.type<@Num2Bits_0::@Num2Bits_0<[]>>, !felt.type) -> ()
// CHECK-NEXT:          function.return
// CHECK-NEXT:        }
// CHECK-NEXT:      }
// CHECK-NEXT:    }
...
// CHECK-NEXT:        function.def @compute(%[[VAL_303:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@Num2Bits_0::@Num2Bits_0<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_315:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_312]], %[[VAL_314]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_322:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_317]] : !felt.type
// CHECK-NEXT:            array.write %[[VAL_305]]{{\[}}%[[VAL_322]]] = %[[VAL_321]] : <135 x !felt.type>, !felt.type
// CHECK-NEXT:            %[[VAL_323:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_317]] : !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_304]][@out] = %[[VAL_305]] : <@Num2Bits_0::@Num2Bits_0<[]>>, !array.type<135 x !felt.type>
// CHECK-NEXT:          function.return %[[VAL_304]] : !struct.type<@Num2Bits_0::@Num2Bits_0<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_330:[0-9a-zA-Z_\.]+]]: !struct.type<@Num2Bits_0::@Num2Bits_0<[]>>, %[[VAL_331:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_332:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_330]][@out] : <@Num2Bits_0::@Num2Bits_0<[]>>, !array.type<135 x !felt.type>
...
// CHECK-NEXT:            %[[VAL_342:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_339]], %[[VAL_341]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_346:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_344]] : !felt.type
// CHECK-NEXT:            %[[VAL_347:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_332]]{{\[}}%[[VAL_346]]] : <135 x !felt.type>, !felt.type
// CHECK-NEXT:            %[[VAL_348:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_344]] : !felt.type
...
// CHECK-NEXT:            %[[VAL_354:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_344]] : !felt.type
