...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@Fibonacci_0::@Fibonacci_0<[]>>} {
// CHECK-NEXT:    poly.template @Fibonacci_0 {
// CHECK-NEXT:      struct.def @Fibonacci_0 {
// CHECK-NEXT:        struct.member @out : !felt.type {llzk.pub}
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@Fibonacci_0::@Fibonacci_0<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_11:[0-9a-zA-Z_\.]+]] = bool.cmp gt(%[[VAL_8]], %[[VAL_10]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_0]], %[[VAL_19]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_0]], %[[VAL_24]]) : !felt.type, !felt.type
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = scf.if %[[VAL_25]] -> (!felt.type) {
// CHECK-NEXT:            %[[VAL_27:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:            struct.writem %[[VAL_1]][@out] = %[[VAL_27]] : <@Fibonacci_0::@Fibonacci_0<[]>>, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_27]] : !felt.type
// CHECK-NEXT:          } else {
// CHECK-NEXT:            struct.writem %[[VAL_1]][@out] = %[[VAL_21]] : <@Fibonacci_0::@Fibonacci_0<[]>>, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_21]] : !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          function.return %[[VAL_1]] : !struct.type<@Fibonacci_0::@Fibonacci_0<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_28:[0-9a-zA-Z_\.]+]]: !struct.type<@Fibonacci_0::@Fibonacci_0<[]>>, %[[VAL_29:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_28]][@out] : <@Fibonacci_0::@Fibonacci_0<[]>>, !felt.type
...
// CHECK-NEXT:            %[[VAL_40:[0-9a-zA-Z_\.]+]] = bool.cmp gt(%[[VAL_37]], %[[VAL_39]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_49:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_29]], %[[VAL_48]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          %[[VAL_54:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_29]], %[[VAL_53]]) : !felt.type, !felt.type
