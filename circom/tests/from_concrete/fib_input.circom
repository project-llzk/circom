...
// CHECK-NEXT:          struct.writem %[[VAL_1]][@out] = %[[VAL_27]] : <@Fibonacci_0<[]>>, !felt.type
// CHECK-NEXT:          scf.yield %[[VAL_27]] : !felt.type
// CHECK-NEXT:        } else {
// CHECK-NEXT:          struct.writem %[[VAL_1]][@out] = %[[VAL_21]] : <@Fibonacci_0<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_30:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_28]][@out] : <@Fibonacci_0<[]>>, !felt.type
