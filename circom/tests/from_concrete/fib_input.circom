...
// CHECK-LABEL: module attributes {llzk.lang = "circom", llzk.main = !struct.type<@Fibonacci_0::@Fibonacci_0<[]>>} {
...
// CHECK-NEXT:          } else {
// CHECK-NEXT:            %[[VAL_23:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_5]]#0, %[[VAL_5]]#1 : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:            scf.yield %[[VAL_23]] : !felt.type<"bn128">
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_0]], %[[VAL_24]]) : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = scf.if %[[VAL_25]] -> (!felt.type<"bn128">) {
// CHECK-NEXT:            %[[VAL_27:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:            struct.writem %[[VAL_1]][@out] = %[[VAL_27]] : <@Fibonacci_0::@Fibonacci_0<[]>>, !felt.type<"bn128">
// CHECK-NEXT:            scf.yield %[[VAL_27]] : !felt.type<"bn128">
// CHECK-NEXT:          } else {
// CHECK-NEXT:            struct.writem %[[VAL_1]][@out] = %[[VAL_21]] : <@Fibonacci_0::@Fibonacci_0<[]>>, !felt.type<"bn128">
...
// CHECK-NEXT:          %[[VAL_50:[0-9a-zA-Z_\.]+]] = scf.if %[[VAL_49]] -> (!felt.type<"bn128">) {
// CHECK-NEXT:            %[[VAL_51:[0-9a-zA-Z_\.]+]] = felt.const  1
// CHECK-NEXT:            scf.yield %[[VAL_51]] : !felt.type<"bn128">
// CHECK-NEXT:          } else {
// CHECK-NEXT:            %[[VAL_52:[0-9a-zA-Z_\.]+]] = felt.add %[[VAL_34]]#0, %[[VAL_34]]#1 : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:            scf.yield %[[VAL_52]] : !felt.type<"bn128">
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_53:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_54:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_29]], %[[VAL_53]]) : !felt.type<"bn128">, !felt.type<"bn128">
