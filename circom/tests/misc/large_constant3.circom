...
// CHECK-LABEL: module attributes {llzk.lang = "circom", llzk.main = !struct.type<@CompConstant::@CompConstant<[#felt<const 10944121435919637611123202872628637544274182200208017171849102093287904247808 : <"bn128">>]>>} {
