...
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_21:[0-9a-zA-Z_\.]+]] = %[[VAL_17]], %[[VAL_22:[0-9a-zA-Z_\.]+]] = %[[VAL_19]]) : (!array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">) -> (!array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">) {
...
// CHECK-NEXT:            scf.condition(%[[VAL_24]]) %[[VAL_21]], %[[VAL_22]] : !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">
// CHECK-NEXT:          } do {
// CHECK-NEXT:          ^bb0(%[[VAL_25:[0-9a-zA-Z_\.]+]]: !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, %[[VAL_26:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
...
// CHECK-NEXT:            %[[VAL_29:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_30:[0-9a-zA-Z_\.]+]] = %[[VAL_25]], %[[VAL_31:[0-9a-zA-Z_\.]+]] = %[[VAL_28]]) : (!array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">) -> (!array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">) {
...
// CHECK-NEXT:              scf.condition(%[[VAL_33]]) %[[VAL_30]], %[[VAL_31]] : !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">
// CHECK-NEXT:            } do {
// CHECK-NEXT:            ^bb0(%[[VAL_34:[0-9a-zA-Z_\.]+]]: !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, %[[VAL_35:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">):
...
// CHECK-NEXT:              array.write %[[VAL_9]]{{\[}}%[[VAL_41]]] = %[[VAL_38]] : <@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>
...
// CHECK-NEXT:              %[[VAL_49:[0-9a-zA-Z_\.]+]] = scf.if %[[VAL_48]] -> (!array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>) {
...
// CHECK-NEXT:                %[[VAL_61:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_9]]{{\[}}%[[VAL_60]]] : <@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>
...
// CHECK-NEXT:                  array.write %[[VAL_9]]{{\[}}%[[VAL_76]]] = %[[VAL_61]] : <@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:                }
// CHECK-NEXT:                scf.yield %[[VAL_34]] : !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>
// CHECK-NEXT:              } else {
...
// CHECK-NEXT:                %[[VAL_88:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_9]]{{\[}}%[[VAL_87]]] : <@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>
...
// CHECK-NEXT:                  array.write %[[VAL_9]]{{\[}}%[[VAL_103]]] = %[[VAL_88]] : <@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>
// CHECK-NEXT:                }
// CHECK-NEXT:                scf.yield %[[VAL_34]] : !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>
// CHECK-NEXT:              }
...
// CHECK-NEXT:              scf.yield %[[VAL_49]], %[[VAL_105]] : !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">
// CHECK-NEXT:            }
...
// CHECK-NEXT:            scf.yield %[[VAL_29]]#0, %[[VAL_107]] : !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>, !felt.type<"bn128">
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_4]][@has_prev_non_zero$inputs] = %[[VAL_20]]#0 : <@InvalidArgIndex::@InvalidArgIndex<[@n, @k]>>, !array.type<@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@a: !felt.type<"bn128">]>>
...
// CHECK-NEXT:            %[[VAL_113:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_9]]{{\[}}%[[VAL_112]]] : <@"k_Mul_n@[[OFFSET0]]" x !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>>, !pod.type<[@count: index, @comp: !struct.type<@OR::@OR<[]>>, @params: !pod.type<[]>]>
