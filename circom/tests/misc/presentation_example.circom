...
// CHECK-NEXT:          %[[VAL_6:[0-9a-zA-Z_\.]+]] = pod.new { @A = %[[VAL_5]] }  : <[@A: index]>
// CHECK-NEXT:          %[[VAL_7:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_8:[0-9a-zA-Z_\.]+]] = pod.new { @count = %[[VAL_7]], @params = %[[VAL_6]] }  : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>
...
// CHECK-NEXT:          %[[VAL_12:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_8]][@count] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>, index
// CHECK-NEXT:          %[[VAL_13:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_12]], %[[VAL_13]] : index
// CHECK-NEXT:          pod.write %[[VAL_8]][@count] = %[[VAL_14]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>, index
...
// CHECK-NEXT:            %[[VAL_17:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_8]][@params] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>, !pod.type<[@A: index]>
...
// CHECK-NEXT:            pod.write %[[VAL_8]][@comp] = %[[VAL_19]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>, !struct.type<@GetWeight::@GetWeight<[99]>>
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_8]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>, !struct.type<@GetWeight::@GetWeight<[99]>>
...
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = arith.constant 88 : index
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = pod.new { @A = %[[VAL_24]] }  : <[@A: index]>
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_27:[0-9a-zA-Z_\.]+]] = pod.new { @count = %[[VAL_26]], @params = %[[VAL_25]] }  : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>
...
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_27]][@count] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>, index
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_33:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_31]], %[[VAL_32]] : index
// CHECK-NEXT:          pod.write %[[VAL_27]][@count] = %[[VAL_33]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>, index
...
// CHECK-NEXT:            %[[VAL_36:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_27]][@params] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>, !pod.type<[@A: index]>
...
// CHECK-NEXT:            pod.write %[[VAL_27]][@comp] = %[[VAL_38]] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>, !struct.type<@GetWeight::@GetWeight<[88]>>
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_27]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>, !struct.type<@GetWeight::@GetWeight<[88]>>
...
// CHECK-NEXT:          %[[VAL_43:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_8]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>, !struct.type<@GetWeight::@GetWeight<[99]>>
...
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_27]][@comp] : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>, !struct.type<@GetWeight::@GetWeight<[88]>>
...
// CHECK-NEXT:          %[[VAL_52:[0-9a-zA-Z_\.]+]] = arith.constant 99 : index
// CHECK-NEXT:          %[[VAL_53:[0-9a-zA-Z_\.]+]] = pod.new { @A = %[[VAL_52]] }  : <[@A: index]>
// CHECK-NEXT:          %[[VAL_54:[0-9a-zA-Z_\.]+]] = pod.new : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[99]>>, @params: !pod.type<[@A: index]>]>
...
// CHECK-NEXT:          %[[VAL_63:[0-9a-zA-Z_\.]+]] = arith.constant 88 : index
// CHECK-NEXT:          %[[VAL_64:[0-9a-zA-Z_\.]+]] = pod.new { @A = %[[VAL_63]] }  : <[@A: index]>
// CHECK-NEXT:          %[[VAL_65:[0-9a-zA-Z_\.]+]] = pod.new : <[@count: index, @comp: !struct.type<@GetWeight::@GetWeight<[88]>>, @params: !pod.type<[@A: index]>]>
...
// CHECK-NEXT:          %[[VAL_78:[0-9a-zA-Z_\.]+]] = poly.read_const @A : index
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_80:[0-9a-zA-Z_\.]+]]: !struct.type<@GetWeight::@GetWeight<[@A]>>, %[[VAL_81:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128"> {function.arg_name = "inp"}) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_82:[0-9a-zA-Z_\.]+]] = poly.read_const @A : index
// CHECK-NEXT:          %[[VAL_83:[0-9a-zA-Z_\.]+]] = cast.tofelt %[[VAL_82]] : index, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_84:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_80]][@out] : <@GetWeight::@GetWeight<[@A]>>, !felt.type<"bn128">
// CHECK-NEXT:          function.return
// CHECK-NEXT:        }
// CHECK-NEXT:      }
// CHECK-NEXT:    }
