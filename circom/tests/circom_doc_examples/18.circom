...
// CHECK-NEXT:        struct.writem %[[VAL_2]][@c] = %[[VAL_4]] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_9:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_5]][@c] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:      struct.member @temp_a : !struct.type<@A<[@n]>>
...
// CHECK-NEXT:        %[[VAL_40:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_39]][@c] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        struct.writem %[[VAL_12]][@out] = %[[VAL_40]] : <@B<[@n]>>, !felt.type
// CHECK-NEXT:        struct.writem %[[VAL_12]][@temp_a$inputs] = %[[VAL_16]] : <@B<[@n]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
// CHECK-NEXT:        %[[VAL_41:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_15]][@comp] : <[@count: index, @comp: !struct.type<@A<[@n]>>, @params: !pod.type<[]>]>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        struct.writem %[[VAL_12]][@temp_a] = %[[VAL_41]] : <@B<[@n]>>, !struct.type<@A<[@n]>>
...
// CHECK-NEXT:        %[[VAL_45:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_42]][@out] : <@B<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_46:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_42]][@temp_a] : <@B<[@n]>>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        %[[VAL_47:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_42]][@temp_a$inputs] : <@B<[@n]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
...
// CHECK-NEXT:        %[[VAL_56:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_46]][@c] : <@A<[@n]>>, !felt.type
