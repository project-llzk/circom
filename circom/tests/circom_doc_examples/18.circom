...
// CHECK-NEXT:        struct.member @temp_a$inputs : !pod.type<[@a: !felt.type, @b: !felt.type]>
...
// CHECK-NEXT:          struct.writem %[[VAL_12]][@temp_a$inputs] = %[[VAL_16]] : <@B::@B<[@n]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_47:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_42]][@temp_a$inputs] : <@B::@B<[@n]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
