...
// CHECK-NEXT:          struct.writem %[[VAL_12]][@temp_a$inputs] = %[[VAL_15]] : <@B::@B<[@n]>>, !pod.type<[@a: !felt.type<"bn128">, @b: !felt.type<"bn128">]>
...
// CHECK-NEXT:          struct.writem %[[VAL_12]][@temp_a] = %[[VAL_47]] : <@B::@B<[@n]>>, !struct.type<@A::@A<[@n]>>
...
// CHECK-NEXT:          %[[VAL_53:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_48]][@temp_a] : <@B::@B<[@n]>>, !struct.type<@A::@A<[@n]>>
// CHECK-NEXT:          %[[VAL_54:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_48]][@temp_a$inputs] : <@B::@B<[@n]>>, !pod.type<[@a: !felt.type<"bn128">, @b: !felt.type<"bn128">]>
