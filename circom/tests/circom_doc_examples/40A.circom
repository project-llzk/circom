...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@check_bits<[10]>>} {
...
// CHECK-NEXT:        struct.writem %[[VAL_57]][@check] = %[[VAL_69]] : <@check_bits<[@n]>>, !struct.type<@Num2Bits<[@n]>>
...
// CHECK-NEXT:        %[[VAL_73:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_70]][@check] : <@check_bits<[@n]>>, !struct.type<@Num2Bits<[@n]>>
// CHECK-NEXT:        %[[VAL_74:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_70]][@check$inputs] : <@check_bits<[@n]>>, !pod.type<[@in: !felt.type]>
