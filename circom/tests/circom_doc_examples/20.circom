...
// CHECK-NEXT:      struct.member @[[ANON]]$inputs : !pod.type<[@a: !felt.type, @b: !felt.type]>
...
// CHECK-NEXT:        struct.writem %[[VAL_12]][@[[ANON]]$inputs] = %[[VAL_16]] : <@B<[@n]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
// CHECK-NEXT:        %[[VAL_41:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_15]][@comp] : <[@count: index, @comp: !struct.type<@A<[@n]>>, @params: !pod.type<[]>]>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        struct.writem %[[VAL_12]][@[[ANON]]] = %[[VAL_41]] : <@B<[@n]>>, !struct.type<@A<[@n]>>
...
// CHECK-NEXT:        %[[VAL_46:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_42]][@[[ANON]]] : <@B<[@n]>>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        %[[VAL_47:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_42]][@[[ANON]]$inputs] : <@B<[@n]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
