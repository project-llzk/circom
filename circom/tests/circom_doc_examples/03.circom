...
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = scf.if %[[VAL_13]] -> (!pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>) {
...
// CHECK-NEXT:            %[[VAL_20:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_19]] : (!pod.type<[@count: index, @comp: !struct.type<@A::@A<[@N, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>
// CHECK-NEXT:            scf.yield %[[VAL_20]] : !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>
// CHECK-NEXT:          } else {
...
// CHECK-NEXT:            %[[VAL_26:[0-9a-zA-Z_\.]+]] = poly.unifiable_cast %[[VAL_25]] : (!pod.type<[@count: index, @comp: !struct.type<@A::@A<[0, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>) -> !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>
// CHECK-NEXT:            scf.yield %[[VAL_26]] : !pod.type<[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_27:[0-9a-zA-Z_\.]+]] = felt.const  1 : <"bn128">
// CHECK-NEXT:          pod.write %[[VAL_11]][@in] = %[[VAL_27]] : <[@in: !felt.type<"bn128">]>, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_28:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_14]][@count] : <[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>, index
// CHECK-NEXT:          %[[VAL_29:[0-9a-zA-Z_\.]+]] = arith.constant 1 : index
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = arith.subi %[[VAL_28]], %[[VAL_29]] : index
// CHECK-NEXT:          pod.write %[[VAL_14]][@count] = %[[VAL_30]] : <[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>, index
...
// CHECK-NEXT:            %[[VAL_33:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_14]][@params] : <[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>, !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>
...
// CHECK-NEXT:            %[[VAL_37:[0-9a-zA-Z_\.]+]] = function.call @A::@A::@compute(%[[VAL_34]]) {(%[[VAL_36]])} : (!felt.type<"bn128">) -> !struct.type<@A::@A<[#map, 1]>>
// CHECK-NEXT:            pod.write %[[VAL_14]][@comp] = %[[VAL_37]] : <[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map, 1]>>
// CHECK-NEXT:          }
// CHECK-NEXT:          %[[VAL_38:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_14]][@comp] : <[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map, 1]>>
// CHECK-NEXT:          %[[VAL_39:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_38]][@out] : <@A::@A<[#map, 1]>>, !felt.type<"bn128">
...
// CHECK-NEXT:          %[[VAL_40:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_14]][@comp] : <[@count: index, @comp: !struct.type<@A::@A<[#map, 1]>>, @params: !pod.type<[@N: !felt.type<"bn128">, @M: !felt.type<"bn128">]>]>, !struct.type<@A::@A<[#map, 1]>>
// CHECK-NEXT:          struct.writem %[[VAL_9]][@a] = %[[VAL_40]] : <@B::@B<[@N]>>, !struct.type<@A::@A<[#map, 1]>>
...
// CHECK-NEXT:          %[[VAL_44:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_41]][@a] : <@B::@B<[@N]>>, !struct.type<@A::@A<[#map, 1]>>
...
// CHECK-NEXT:          %[[VAL_58:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_44]][@out] : <@A::@A<[#map, 1]>>, !felt.type<"bn128">
...
// CHECK-NEXT:          function.call @A::@A::@constrain(%[[VAL_44]], %[[VAL_59]]) : (!struct.type<@A::@A<[#map, 1]>>, !felt.type<"bn128">) -> ()
// CHECK-NEXT:          function.return
// CHECK-NEXT:        }
// CHECK-NEXT:      }
// CHECK-NEXT:    }
