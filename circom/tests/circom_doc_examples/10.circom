...
// CHECK-NEXT:          %[[VAL_4:[0-9a-zA-Z_\.]+]] = bool.cmp ge(%[[VAL_1]], %[[VAL_3]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_10]] : <@T14::@T14<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_12:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_11]][@out] : <@T14::@T14<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_16:[0-9a-zA-Z_\.]+]] = bool.cmp ge(%[[VAL_13]], %[[VAL_15]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          constrain.eq %[[VAL_12]], %[[VAL_22]] : !felt.type, !felt.type
