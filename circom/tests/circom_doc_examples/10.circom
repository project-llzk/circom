...
// CHECK-NEXT:      function.def @compute() -> !struct.type<@T14<[]>> attributes {function.allow_witness} {
...
// CHECK-NEXT:      }
// CHECK-NEXT:      function.def @constrain(%[[VAL_12:[0-9a-zA-Z_\.]+]]: !struct.type<@T14<[]>>) attributes {function.allow_constraint} {
