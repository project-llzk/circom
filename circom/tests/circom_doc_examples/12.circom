...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@T16<[]>>} {
...
// CHECK-NEXT:            %[[VAL_7:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_4]], %[[VAL_6]]) : !felt.type, !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_3]]#1 : <@T16::@T16<[]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_14:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_13]][@out] : <@T16::@T16<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_15:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_16:[0-9a-zA-Z_\.]+]] = felt.const  0
// CHECK-NEXT:          %[[VAL_17:[0-9a-zA-Z_\.]+]]:2 = scf.while (%[[VAL_18:[0-9a-zA-Z_\.]+]] = %[[VAL_16]], %[[VAL_19:[0-9a-zA-Z_\.]+]] = %[[VAL_15]]) : (!felt.type, !felt.type) -> (!felt.type, !felt.type) {
// CHECK-NEXT:            %[[VAL_20:[0-9a-zA-Z_\.]+]] = felt.const  100
// CHECK-NEXT:            %[[VAL_21:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_18]], %[[VAL_20]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_21]]) %[[VAL_18]], %[[VAL_19]] : !felt.type, !felt.type
// CHECK-NEXT:          } do {
...
// CHECK-NEXT:          }
// CHECK-NEXT:          constrain.eq %[[VAL_14]], %[[VAL_17]]#1 : !felt.type, !felt.type
