...
// CHECK-NEXT:        struct.member @Num2Bits_25_562$inputs : !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:          struct.writem %[[VAL_57]][@Num2Bits_25_562$inputs] = %[[VAL_61]] : <@check_bits::@check_bits<[@n]>>, !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_76:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_72]][@Num2Bits_25_562$inputs] : <@check_bits::@check_bits<[@n]>>, !pod.type<[@in: !felt.type]>
