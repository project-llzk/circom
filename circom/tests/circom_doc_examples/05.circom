...
// CHECK-NEXT:      struct.member @example : !struct.type<@Example<[]>>
...
// CHECK-NEXT:        struct.writem %[[VAL_2]][@example$inputs] = %[[VAL_6]] : <@UsingExample<[]>>, !pod.type<[]>
// CHECK-NEXT:        %[[VAL_7:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_5]][@comp] : <[@count: index, @comp: !struct.type<@Example<[]>>, @params: !pod.type<[]>]>, !struct.type<@Example<[]>>
// CHECK-NEXT:        struct.writem %[[VAL_2]][@example] = %[[VAL_7]] : <@UsingExample<[]>>, !struct.type<@Example<[]>>
...
// CHECK-NEXT:        %[[VAL_9:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_8]][@example] : <@UsingExample<[]>>, !struct.type<@Example<[]>>
// CHECK-NEXT:        %[[VAL_10:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_8]][@example$inputs] : <@UsingExample<[]>>, !pod.type<[]>
