...
// CHECK-NEXT:      struct.member @[[ANON:[0-9a-zA-Z_\.]+]] : !struct.type<@B<[]>>
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@aux] = %[[VAL_8]] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_17:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_16]][@out] : <@B<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_17]] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@aux] = %[[VAL_18]] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:          %[[VAL_19:[0-9a-zA-Z_\.]+]] = felt.const  5
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_19]] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:          scf.yield %[[VAL_4]], %[[VAL_18]], %[[VAL_19]] : !pod.type<[@in: !felt.type]>, !felt.type, !felt.type
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_0]][@[[ANON]]$inputs] = %[[VAL_7]]#0 : <@A<[@n]>>, !pod.type<[@in: !felt.type]>
// CHECK-NEXT:        %[[VAL_20:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_3]][@comp] : <[@count: index, @comp: !struct.type<@B<[]>>, @params: !pod.type<[]>]>, !struct.type<@B<[]>>
// CHECK-NEXT:        struct.writem %[[VAL_0]][@[[ANON]]] = %[[VAL_20]] : <@A<[@n]>>, !struct.type<@B<[]>>
...
// CHECK-NEXT:        %[[VAL_23:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@aux] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_24:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@out] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_25:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@[[ANON]]] : <@A<[@n]>>, !struct.type<@B<[]>>
// CHECK-NEXT:        %[[VAL_26:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@[[ANON]]$inputs] : <@A<[@n]>>, !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_25]][@out] : <@B<[]>>, !felt.type
...
// CHECK-NEXT:        struct.writem %[[VAL_36]][@out] = %[[VAL_38]] : <@B<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_41:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_39]][@out] : <@B<[]>>, !felt.type
