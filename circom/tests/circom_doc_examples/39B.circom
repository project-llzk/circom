...
// CHECK-NEXT:        struct.member @[[ANON]]$inputs : !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_6:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_1]], %[[VAL_5]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            struct.writem %[[VAL_0]][@aux] = %[[VAL_8]] : <@A::@A<[@n]>>, !felt.type
...
// CHECK-NEXT:              %[[VAL_15:[0-9a-zA-Z_\.]+]] = function.call @B::@B::@compute(%[[VAL_14]]) : (!felt.type) -> !struct.type<@B::@B<[]>>
...
// CHECK-NEXT:            %[[VAL_17:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_16]][@out] : <@B::@B<[]>>, !felt.type
// CHECK-NEXT:            struct.writem %[[VAL_0]][@out] = %[[VAL_17]] : <@A::@A<[@n]>>, !felt.type
...
// CHECK-NEXT:            struct.writem %[[VAL_0]][@aux] = %[[VAL_18]] : <@A::@A<[@n]>>, !felt.type
// CHECK-NEXT:            %[[VAL_19:[0-9a-zA-Z_\.]+]] = felt.const  5
// CHECK-NEXT:            struct.writem %[[VAL_0]][@out] = %[[VAL_19]] : <@A::@A<[@n]>>, !felt.type
// CHECK-NEXT:            scf.yield %[[VAL_4]], %[[VAL_18]], %[[VAL_19]] : !pod.type<[@in: !felt.type]>, !felt.type, !felt.type
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@[[ANON]]$inputs] = %[[VAL_7]]#0 : <@A::@A<[@n]>>, !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_23:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@aux] : <@A::@A<[@n]>>, !felt.type
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@out] : <@A::@A<[@n]>>, !felt.type
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@[[ANON]]] : <@A::@A<[@n]>>, !struct.type<@B::@B<[]>>
// CHECK-NEXT:          %[[VAL_26:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_21]][@[[ANON]]$inputs] : <@A::@A<[@n]>>, !pod.type<[@in: !felt.type]>
// CHECK-NEXT:          %[[VAL_27:[0-9a-zA-Z_\.]+]] = felt.const  2
// CHECK-NEXT:          %[[VAL_28:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_22]], %[[VAL_27]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_25]][@out] : <@B::@B<[]>>, !felt.type
...
// CHECK-NEXT:          function.call @B::@B::@constrain(%[[VAL_25]], %[[VAL_34]]) : (!struct.type<@B::@B<[]>>, !felt.type) -> ()
...
// CHECK-NEXT:        function.def @compute(%[[VAL_35:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@B::@B<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          struct.writem %[[VAL_36]][@out] = %[[VAL_38]] : <@B::@B<[]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_36]] : !struct.type<@B::@B<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_39:[0-9a-zA-Z_\.]+]]: !struct.type<@B::@B<[]>>, %[[VAL_40:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_41:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_39]][@out] : <@B::@B<[]>>, !felt.type
