...
// CHECK-NEXT:          %[[VAL_7:[0-9a-zA-Z_\.]+]] = bool.cmp eq(%[[VAL_1]], %[[VAL_6]]) : !felt.type, !felt.type
...
// CHECK-NEXT:            struct.writem %[[VAL_0]][@aux] = %[[VAL_9]] : <@A::@A<[@n]>>, !felt.type
...
// CHECK-NEXT:              %[[VAL_16:[0-9a-zA-Z_\.]+]] = function.call @B::@B::@compute(%[[VAL_15]]) : (!felt.type) -> !struct.type<@B::@B<[]>>
...
// CHECK-NEXT:            %[[VAL_18:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_17]][@out] : <@B::@B<[]>>, !felt.type
// CHECK-NEXT:            struct.writem %[[VAL_0]][@out] = %[[VAL_18]] : <@A::@A<[@n]>>, !felt.type
...
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@[[ANON]]$inputs] = %[[VAL_8]]#0 : <@A::@A<[@n]>>, !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:          function.call @B::@B::@constrain(%[[VAL_25]], %[[VAL_33]]) : (!struct.type<@B::@B<[]>>, !felt.type) -> ()
...
// CHECK-NEXT:        function.def @compute(%[[VAL_34:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@B::@B<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          struct.writem %[[VAL_35]][@out] = %[[VAL_37]] : <@B::@B<[]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_35]] : !struct.type<@B::@B<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_38:[0-9a-zA-Z_\.]+]]: !struct.type<@B::@B<[]>>, %[[VAL_39:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_40:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_38]][@out] : <@B::@B<[]>>, !felt.type
