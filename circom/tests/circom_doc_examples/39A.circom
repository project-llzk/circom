...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@aux] = %[[VAL_9]] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:          %[[VAL_18:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_17]][@out] : <@B<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_0]][@out] = %[[VAL_18]] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:        }
// CHECK-NEXT:        struct.writem %[[VAL_0]][@[[ANON]]$inputs] = %[[VAL_8]]#0 : <@A<[@n]>>, !pod.type<[@in: !felt.type]>
...
// CHECK-NEXT:        struct.writem %[[VAL_35]][@out] = %[[VAL_37]] : <@B<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_40:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_38]][@out] : <@B<[]>>, !felt.type
