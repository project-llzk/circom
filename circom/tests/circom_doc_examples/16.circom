...
// CHECK-NEXT:          %[[VAL_3:[0-9a-zA-Z_\.]+]] = array.new  : <@N x !pod.type<[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>>
...
// CHECK-NEXT:            %[[VAL_15:[0-9a-zA-Z_\.]+]] = function.call @fun::@fun::@compute() {(%[[VAL_14]])} : () -> !struct.type<@fun::@fun<[#map]>>
// CHECK-NEXT:            %[[VAL_16:[0-9a-zA-Z_\.]+]] = pod.new { @comp = %[[VAL_15]] } (%[[VAL_10]]) : <[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>
// CHECK-NEXT:            %[[VAL_17:[0-9a-zA-Z_\.]+]] = cast.toindex %[[VAL_9]] : !felt.type<"bn128">
// CHECK-NEXT:            array.write %[[VAL_3]]{{\[}}%[[VAL_17]]] = %[[VAL_16]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:          %[[VAL_20:[0-9a-zA-Z_\.]+]] = array.new  : <@N x !struct.type<@fun::@fun<[#map]>>>
...
// CHECK-NEXT:            %[[VAL_25:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_3]]{{\[}}%[[VAL_24]]] : <@N x !pod.type<[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>>, !pod.type<[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>
// CHECK-NEXT:            %[[VAL_26:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_25]][@comp] : <[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>, !struct.type<@fun::@fun<[#map]>>
// CHECK-NEXT:            array.write %[[VAL_20]]{{\[}}%[[VAL_24]]] = %[[VAL_26]] : <@N x !struct.type<@fun::@fun<[#map]>>>, !struct.type<@fun::@fun<[#map]>>
// CHECK-NEXT:          }
// CHECK-NEXT:          struct.writem %[[VAL_0]][@c] = %[[VAL_20]] : <@all::@all<[@N]>>, !array.type<@N x !struct.type<@fun::@fun<[#map]>>>
...
// CHECK-NEXT:          %[[VAL_30:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_27]][@c] : <@all::@all<[@N]>>, !array.type<@N x !struct.type<@fun::@fun<[#map]>>>
...
// CHECK-NEXT:            %[[VAL_39:[0-9a-zA-Z_\.]+]] = pod.new(%[[VAL_37]]) : <[@count: index, @comp: !struct.type<@fun::@fun<[#map]>>, @params: !pod.type<[@N: !felt.type<"bn128">]>]>
...
// CHECK-NEXT:            %[[VAL_46:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_30]]{{\[}}%[[VAL_45]]] : <@N x !struct.type<@fun::@fun<[#map]>>>, !struct.type<@fun::@fun<[#map]>>
// CHECK-NEXT:            %[[VAL_47:[0-9a-zA-Z_\.]+]] = array.read %[[VAL_31]]{{\[}}%[[VAL_45]]] : <@N x !pod.type<[]>>, !pod.type<[]>
// CHECK-NEXT:            function.call @fun::@fun::@constrain(%[[VAL_46]]) : (!struct.type<@fun::@fun<[#map]>>) -> ()
// CHECK-NEXT:          }
