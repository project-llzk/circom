...
// CHECK-NEXT:          struct.writem %[[VAL_14]][@A_14_363$inputs] = %[[VAL_17]] : <@B::@B<[@n]>>, !pod.type<[@a: !felt.type<"bn128">, @b: !felt.type<"bn128">]>
...
// CHECK-NEXT:          struct.writem %[[VAL_14]][@A_14_363] = %[[VAL_48]] : <@B::@B<[@n]>>, !struct.type<@A::@A<[@n]>>
...
// CHECK-NEXT:          %[[VAL_54:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_49]][@A_14_363] : <@B::@B<[@n]>>, !struct.type<@A::@A<[@n]>>
// CHECK-NEXT:          %[[VAL_55:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_49]][@A_14_363$inputs] : <@B::@B<[@n]>>, !pod.type<[@a: !felt.type<"bn128">, @b: !felt.type<"bn128">]>
