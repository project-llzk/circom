...
// CHECK-NEXT:        struct.writem %[[VAL_1]][@d] = %[[VAL_8]] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_12:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_9]][@b] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_13:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_9]][@c] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_14:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_9]][@d] : <@A<[@n]>>, !felt.type
...
// CHECK-NEXT:      struct.member @[[ANON]]$inputs : !pod.type<[@a: !felt.type]>
...
// CHECK-NEXT:        %[[VAL_35:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_34]][@b] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_36:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_25]][@comp] : <[@count: index, @comp: !struct.type<@A<[@n]>>, @params: !pod.type<[]>]>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        %[[VAL_37:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_36]][@c] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        struct.writem %[[VAL_22]][@out1] = %[[VAL_37]] : <@B<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_38:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_25]][@comp] : <[@count: index, @comp: !struct.type<@A<[@n]>>, @params: !pod.type<[]>]>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        %[[VAL_39:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_38]][@d] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        struct.writem %[[VAL_22]][@[[ANON]]$inputs] = %[[VAL_26]] : <@B<[@n]>>, !pod.type<[@a: !felt.type]>
// CHECK-NEXT:        %[[VAL_40:[0-9a-zA-Z_\.]+]] = pod.read %[[VAL_25]][@comp] : <[@count: index, @comp: !struct.type<@A<[@n]>>, @params: !pod.type<[]>]>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        struct.writem %[[VAL_22]][@[[ANON]]] = %[[VAL_40]] : <@B<[@n]>>, !struct.type<@A<[@n]>>
...
// CHECK-NEXT:        %[[VAL_44:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_41]][@out1] : <@B<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_45:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_41]][@[[ANON]]] : <@B<[@n]>>, !struct.type<@A<[@n]>>
// CHECK-NEXT:        %[[VAL_46:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_41]][@[[ANON]]$inputs] : <@B<[@n]>>, !pod.type<[@a: !felt.type]>
...
// CHECK-NEXT:        %[[VAL_48:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_45]][@b] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        %[[VAL_49:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_45]][@c] : <@A<[@n]>>, !felt.type
// CHECK-NEXT:        constrain.eq %[[VAL_44]], %[[VAL_49]] : !felt.type, !felt.type
// CHECK-NEXT:        %[[VAL_50:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_45]][@d] : <@A<[@n]>>, !felt.type
