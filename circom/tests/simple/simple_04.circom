...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type {llzk.pub}, %[[VAL_1:[0-9a-zA-Z_\.]+]]: !felt.type {llzk.pub}, %[[VAL_2:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@A::@A<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:            %[[VAL_14:[0-9a-zA-Z_\.]+]] = function.call @B::@B::@compute(%[[VAL_12]], %[[VAL_13]]) : (!felt.type, !felt.type) -> !struct.type<@B::@B<[]>>
...
// CHECK-NEXT:          %[[VAL_24:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_23]][@c] : <@B::@B<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_3]][@x] = %[[VAL_24]] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_25:[0-9a-zA-Z_\.]+]] = felt.mul %[[VAL_24]], %[[VAL_2]] : !felt.type, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_3]][@c] = %[[VAL_25]] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          struct.writem %[[VAL_3]][@cb$inputs] = %[[VAL_6]] : <@A::@A<[]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
...
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_27:[0-9a-zA-Z_\.]+]]: !struct.type<@A::@A<[]>>, %[[VAL_28:[0-9a-zA-Z_\.]+]]: !felt.type {llzk.pub}, %[[VAL_29:[0-9a-zA-Z_\.]+]]: !felt.type {llzk.pub}, %[[VAL_30:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_31:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_27]][@c] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_32:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_27]][@x] : <@A::@A<[]>>, !felt.type
// CHECK-NEXT:          %[[VAL_33:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_27]][@cb] : <@A::@A<[]>>, !struct.type<@B::@B<[]>>
// CHECK-NEXT:          %[[VAL_34:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_27]][@cb$inputs] : <@A::@A<[]>>, !pod.type<[@a: !felt.type, @b: !felt.type]>
...
// CHECK-NEXT:          %[[VAL_37:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_33]][@c] : <@B::@B<[]>>, !felt.type
...
// CHECK-NEXT:          function.call @B::@B::@constrain(%[[VAL_33]], %[[VAL_39]], %[[VAL_40]]) : (!struct.type<@B::@B<[]>>, !felt.type, !felt.type) -> ()
