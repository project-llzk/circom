...
// CHECK-NEXT:        struct.writem %[[VAL_1]][@b] = %[[VAL_0]] : <@Simple3<[]>>, !felt.type
// CHECK-NEXT:        struct.writem %[[VAL_1]][@c] = %[[VAL_0]] : <@Simple3<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_4:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_2]][@b] : <@Simple3<[]>>, !felt.type
// CHECK-NEXT:        %[[VAL_5:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_2]][@c] : <@Simple3<[]>>, !felt.type
