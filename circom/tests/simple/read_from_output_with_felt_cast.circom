...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">) -> !struct.type<@ReadFromOutputWithFeltCast::@ReadFromOutputWithFeltCast<[]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          struct.writem %[[VAL_1]][@intermediate] = %[[VAL_4]] : <@ReadFromOutputWithFeltCast::@ReadFromOutputWithFeltCast<[]>>, !felt.type<"bn128">
// CHECK-NEXT:          function.return %[[VAL_1]] : !struct.type<@ReadFromOutputWithFeltCast::@ReadFromOutputWithFeltCast<[]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_5:[0-9a-zA-Z_\.]+]]: !struct.type<@ReadFromOutputWithFeltCast::@ReadFromOutputWithFeltCast<[]>>, %[[VAL_6:[0-9a-zA-Z_\.]+]]: !felt.type<"bn128">) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
...
// CHECK-NEXT:          constrain.eq %[[VAL_8]], %[[VAL_7]] : !felt.type<"bn128">, !felt.type<"bn128">
