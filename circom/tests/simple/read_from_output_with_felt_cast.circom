...
// CHECK-NEXT:        struct.writem %[[VAL_1]][@outp] = %[[VAL_4]] : <@ReadFromOutputWithFeltCast<[]>>, !felt.type
// CHECK-NEXT:        struct.writem %[[VAL_1]][@intermediate] = %[[VAL_4]] : <@ReadFromOutputWithFeltCast<[]>>, !felt.type
...
// CHECK-NEXT:        %[[VAL_9:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_5]][@outp] : <@ReadFromOutputWithFeltCast<[]>>, !felt.type
// CHECK-NEXT:        %[[VAL_11:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_5]][@intermediate] : <@ReadFromOutputWithFeltCast<[]>>, !felt.type
