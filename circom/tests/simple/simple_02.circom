...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@Simple4<[10]>>} {
...
// CHECK-NEXT:        function.def @compute(%[[VAL_0:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_1:[0-9a-zA-Z_\.]+]]: !felt.type) -> !struct.type<@Simple4::@Simple4<[@a]>> attributes {function.allow_non_native_field_ops, function.allow_witness} {
...
// CHECK-NEXT:          struct.writem %[[VAL_2]][@b] = %[[VAL_3]] : <@Simple4::@Simple4<[@a]>>, !felt.type
// CHECK-NEXT:          function.return %[[VAL_2]] : !struct.type<@Simple4::@Simple4<[@a]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_7:[0-9a-zA-Z_\.]+]]: !struct.type<@Simple4::@Simple4<[@a]>>, %[[VAL_8:[0-9a-zA-Z_\.]+]]: !felt.type, %[[VAL_9:[0-9a-zA-Z_\.]+]]: !felt.type) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_10:[0-9a-zA-Z_\.]+]] = poly.read_const @a : !felt.type
// CHECK-NEXT:          %[[VAL_11:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_7]][@b] : <@Simple4::@Simple4<[@a]>>, !felt.type
