...
// CHECK-NEXT:          %[[VAL_3:[0-9a-zA-Z_\.]+]] = felt.uintdiv %[[VAL_1]], %[[VAL_2]] : !felt.type<"bn128">, !felt.type<"bn128">
// CHECK-NEXT:          struct.writem %[[VAL_0]][@c] = %[[VAL_3]] : <@A::@A<[@n]>>, !felt.type<"bn128">
...
// CHECK-NEXT:          %[[VAL_6:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_4]][@c] : <@A::@A<[@n]>>, !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_7:[0-9a-zA-Z_\.]+]] = felt.const  4
// CHECK-NEXT:          %[[VAL_8:[0-9a-zA-Z_\.]+]] = felt.uintdiv %[[VAL_5]], %[[VAL_7]] : !felt.type<"bn128">, !felt.type<"bn128">
