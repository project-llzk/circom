...
// CHECK-LABEL: module attributes {llzk.lang, llzk.main = !struct.type<@Simple2::@Simple2<[10]>>} {
...
// CHECK-NEXT:          struct.writem %[[VAL_0]][@b] = %[[VAL_1]] : <@Simple2::@Simple2<[@a]>>, !felt.type<"bn128">
// CHECK-NEXT:          function.return %[[VAL_0]] : !struct.type<@Simple2::@Simple2<[@a]>>
// CHECK-NEXT:        }
// CHECK-NEXT:        function.def @constrain(%[[VAL_2:[0-9a-zA-Z_\.]+]]: !struct.type<@Simple2::@Simple2<[@a]>>) attributes {function.allow_constraint, function.allow_non_native_field_ops} {
// CHECK-NEXT:          %[[VAL_3:[0-9a-zA-Z_\.]+]] = poly.read_const @a : !felt.type<"bn128">
// CHECK-NEXT:          %[[VAL_4:[0-9a-zA-Z_\.]+]] = struct.readm %[[VAL_2]][@b] : <@Simple2::@Simple2<[@a]>>, !felt.type<"bn128">
