...
// CHECK-NEXT:      function.def @compute() -> !struct.type<@Simple2<[@a]>> attributes {function.allow_witness} {
...
// CHECK-NEXT:      }
// CHECK-NEXT:      function.def @constrain(%[[VAL_2:[0-9a-zA-Z_\.]+]]: !struct.type<@Simple2<[@a]>>) attributes {function.allow_constraint} {
