...
// CHECK-NEXT:          %[[VAL_2:[0-9a-zA-Z_\.]+]] = scf.while (%[[VAL_3:[0-9a-zA-Z_\.]+]] = %[[VAL_1]]) : (!felt.type) -> !felt.type {
// CHECK-NEXT:            %[[VAL_4:[0-9a-zA-Z_\.]+]] = felt.const  100
// CHECK-NEXT:            %[[VAL_5:[0-9a-zA-Z_\.]+]] = bool.cmp lt(%[[VAL_3]], %[[VAL_4]]) : !felt.type, !felt.type
// CHECK-NEXT:            scf.condition(%[[VAL_5]]) %[[VAL_3]] : !felt.type
// CHECK-NEXT:          } do {
