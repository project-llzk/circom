...
// CHECK-LABEL: module attributes {llzk.lang = "circom", llzk.main = !struct.type<@UCO::@UCO<[]>>} {
...
// CHECK-NEXT:            %[[VAL_4:[0-9a-zA-Z_\.]+]] = felt.const  100 : <"bn128">
...
// CHECK-NEXT:            %[[VAL_13:[0-9a-zA-Z_\.]+]] = felt.const  100 : <"bn128">
